Module Module1
    ...
    Function DB_INIT() As String
        On Error GoTo TAG_Err
        Dim sr As System.io.StreamReader
        sr = New System.IO.StreamReader("MrMax.ini")
...
TAG_Err:
    ...
    Public Function DB_OPEN() As Boolean
        ...
        '*****  接続文字列を作成して接続を開始する  *****
        'cnsqlclient.ConnectionString = "Data Source=localhost\sqlexpress;Initial Catalog=Soniya_DB;Integrated Security=True"

Module Module_Sub
    ...
    '2014/05/12 消費税対策 start
    '********************************************************************
    '**  税抜金額から税込金額を算出
    '********************************************************************
    Public Function GetTaxPrice(ByVal prmNoTaxPrice As Decimal, ByVal targetDate As String) As Decimal

        Dim taxRate As Decimal
        Dim newTaxStartDate As String = "20191001"
        ...
        Return prmNoTaxPrice + RoundDOWN(prmNoTaxPrice * taxRate, 0)

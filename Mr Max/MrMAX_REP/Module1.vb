Module Module1
    ...
    Public Function DB_INIT()
        Dim sr As System.io.StreamReader = New System.IO.StreamReader("MrMAX.ini")
        Dim line As String
    ...
    Public Function DB_OPEN() As Boolean
        DB_OPEN = False
        '*****  接続文字列を作成して接続を開始する  *****
        'cnsqlclient.ConnectionString = "Data source = LAPTOP - MDJOG6G8;Initial Catalog=MrMAX_Wrn;Integrated Security=True"
        'cnsqlclient.ConnectionString = "Data Source=localhost\SQLEXPRESS;Initial Catalog=MrMAX_Wrn;Integrated Security=True"

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Panel1.Size = New System.Drawing.Size(872, 456)
        ...
        Me.Button12.Location = New System.Drawing.Point(832, 512)
        ...
        Me.PictureBox1.Location = New System.Drawing.Point(8, 496)
...
#End Region
    ...
    Private Sub w_dsp()
        ...
        SqlSelectCommand.CommandText = "SELECT ICDT_DATA.*, ICDT_DTL.RCV_DATE, ICDT_DTL.END_DATE, ICDT_DTL.ICDT_NO, ICDT_DTL.RPLY, EMPL.EMPL_NAME, CLS_CODE.CLS_CODE_NAME FROM ICDT_DTL RIGHT OUTER JOIN ICDT_DATA ON ICDT_DTL.ICDT_NO = ICDT_DATA.ICDT_NO LEFT OUTER JOIN CLS_CODE ON ICDT_DTL.STATUS = CLS_CODE.CLS_CODE LEFT OUTER JOIN EMPL ON ICDT_DTL.EMPL_CODE = EMPL.EMPL_CODE WHERE CLS_CODE.CLS_NO = '001' AND ICDT_DATA.WRN_NO = '" & pWrn_no & "' ORDER BY ICDT_DTL.ICDT_NO, ICDT_DTL.RCV_DATE"
        ...
        If Dttbl1.Rows.Count <> 0 Then
            For i = 0 To Dttbl1.Rows.Count - 1
                If i = 0 Then
                    ...
                    End If
                Else
                    If Format(Dttbl1.Rows(i)("ICDT_NO")) <> Format(Dttbl1.Rows(i - 1)("ICDT_NO")) Then
                        line_no = line_no + 1
                        en = 0
                        txtbox(i, en) = New TextBox
                        txtbox(i, en).AutoSize = False

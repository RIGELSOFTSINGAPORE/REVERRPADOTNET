...
Public Class SalesControl
    ...
    Function SelectTargetSales(TARGET_YEAR As String, TARGET_MONTH As String) As DataTable
        ...
        'sqlStr = sqlStr & "TARGET_CALLLOAD_COUNT, "
        'sqlStr = sqlStr & "TARGET_DAY_COUNT "
    ...
    End Function
    Function SelectTargetSalesCallLoad(TARGET_YEAR As String, TARGET_MONTH As String) As DataTable
        Log4NetControl.ComInfoLogWrite(Log4NetControl.UserID)
        Dim dbConn As DBUtility = New DBUtility()
        Dim dt As DataTable = New DataTable()
        Dim sqlStr As String = "SELECT "
    ...
    Function SonyPlTracking(strYear As String, strMonth As String) As DataTable
        ...
        For i = 1 To strMaxDay
            ...
            Row1.Item("SalesAmount") = "" & Math.Floor(TOT_RevenuewithoutTax)
    ...
    End Function
    Function SonyPlTrackingCallLoad(strYear As String, strMonth As String) As DataTable 'Added for CallLoad
        ...
        For i = 1 To strMaxDay
            ...
            Row1.Item("SalesDate") = strDate
            ' Row1.Item("SalesAmount") = "" & Math.Floor(TOT_RevenuewithoutTax) 'comment for CallLoad
            Row1.Item("SalesAmount") = "" & Math.Floor(TOT_WarrantyNumber)
            tblSIDSales.Rows.Add(Row1)
            '***********************************************

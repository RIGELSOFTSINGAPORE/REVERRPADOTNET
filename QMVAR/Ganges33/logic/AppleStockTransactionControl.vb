...
Public Class AppleStockTransactionControl

    Public Function GetStockTransaction(ByVal queryParams As AppleStockTransactionModel) As DataTable
        Log4NetControl.ComInfoLogWrite(Log4NetControl.UserID)
        Dim dbConn As DBUtility = New DBUtility()
        Dim sqlStr As String = "SELECT "
        sqlStr = sqlStr & "ROW_NUMBER() OVER(ORDER BY UNQ_NO) As RowNumber,FORMAT(CRTDT, 'yyyy/MM/dd') as CRTDT, "
        sqlStr = sqlStr & "FORMAT(UPDDT, 'yyyy/MM/dd') as UPDDT,PART_NO,DESCRIPTION,QUANTITY,TRAN_TYPE,TRAN_REF "
    ...
    Public Function GetParts_StockTransaction(queryParams As AppleStockTransactionModel) As DataTable
        ...
        sqlStr = sqlStr & "QUANTITY,Case WHEN TRAN_TYPE = 1 THEN 'In' WHEN TRAN_TYPE = 2 THEN 'Out' END AS TRAN_TYPE,TRAN_REF "
        sqlStr = sqlStr & "FROM "
        sqlStr = sqlStr & "AC_STOCK_TRAN "
        sqlStr = sqlStr & "WHERE "
        sqlStr = sqlStr & "DELFG=0 "

...
Public Class SonyActivityReportControl
    Public Function AddModifySonyActivityReport(ByVal csvData()() As String, queryParams As SonyActivityReportModel) As Boolean
        ...
        '1st check PARTS_NO
        sqlStr = "SELECT TOP 1 unq FROM SONY_ACTIVITY_REPORT "
        ...
        Else 'The records is already exist, need to update DELFg=0
            ' isExist = 1
            sqlStr = "UPDATE SONY_ACTIVITY_REPORT SET DELFG=1  "
        ...
        For i = 2 To csvData.Length - 1
            If i > 0 Then '0  Header
                'If isExist = 1 Then
                sqlStr = "Insert into SONY_ACTIVITY_REPORT ("
                sqlStr = sqlStr & "CRTDT, "
                sqlStr = sqlStr & "CRTCD, "
                ' sqlStr = sqlStr & "UPDDT, "
                sqlStr = sqlStr & "UPDCD, "
                ...
                sqlStr = sqlStr & "Customer_Visit_S, "
                sqlStr = sqlStr & "Call_Registerd_S, "
                sqlStr = sqlStr & "Repair_Completed_S, "
                sqlStr = sqlStr & "Goods_Delivered_S, "
                sqlStr = sqlStr & "Pending_Calls_S, "
                sqlStr = sqlStr & "Cancelled_Calls_S, "
                sqlStr = sqlStr & "Reservation_S, "

                sqlStr = sqlStr & "Customer_Visit_D, "
                sqlStr = sqlStr & "Call_Registerd_D, "
                sqlStr = sqlStr & "Repair_Completed_D, "
                sqlStr = sqlStr & "Goods_Delivered_D, "
                sqlStr = sqlStr & "Pending_Calls_D, "
                sqlStr = sqlStr & "Cancelled_Calls_D, "
                sqlStr = sqlStr & "Reservation_D, "

                sqlStr = sqlStr & "Customer_Visit_T, "
                sqlStr = sqlStr & "Call_Registerd_T, "
                sqlStr = sqlStr & "Repair_Completed_T, "
                sqlStr = sqlStr & "Goods_Delivered_T, "
                sqlStr = sqlStr & "Pending_Calls_T, "
                sqlStr = sqlStr & "Cancelled_Calls_T, "
                sqlStr = sqlStr & "Reservation_T, "
                ...
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@note", csvData(i)(24)))



                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Customer_Visit_S", csvData(i)(3)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Call_Registerd_S", csvData(i)(4)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Repair_Completed_S", csvData(i)(5)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Goods_Delivered_S", csvData(i)(6)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Pending_Calls_S", csvData(i)(7)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Cancelled_Calls_S", csvData(i)(8)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Reservation_S", csvData(i)(9)))


                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Customer_Visit_D", csvData(i)(10)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Call_Registerd_D", csvData(i)(11)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Repair_Completed_D", csvData(i)(12)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Goods_Delivered_D", csvData(i)(13)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Pending_Calls_D", csvData(i)(14)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Cancelled_Calls_D", csvData(i)(15)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Reservation_D", csvData(i)(16)))


                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Customer_Visit_T", csvData(i)(17)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Call_Registerd_T", csvData(i)(18)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Repair_Completed_T", csvData(i)(19)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Goods_Delivered_T", csvData(i)(20)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Pending_Calls_T", csvData(i)(21)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Cancelled_Calls_T", csvData(i)(22)))
                dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@Reservation_T", csvData(i)(23)))
    ...
    Public Function SelectSonyActivityReport(ByVal queryParams As SonyActivityReportModel) As DataTable
        Log4NetControl.ComInfoLogWrite(Log4NetControl.UserID)
        Dim dbConn As DBUtility = New DBUtility()
        Dim dt As DataTable = New DataTable()
        ...
        sqlStr = sqlStr & "FROM "
        sqlStr = sqlStr & "SONY_ACTIVITY_REPORT "
        sqlStr = sqlStr & "WHERE "
    ...
    Public Function GetSonyAnalysis_ReportDate(queryParams As SonyActivityReportModel) As DataTable

        Dim SonyAnalysis_ReportModel As SonyActivityReportModel = New SonyActivityReportModel()
        Log4NetControl.ComInfoLogWrite(Log4NetControl.UserID)
        Dim dbConn As DBUtility = New DBUtility()
        Dim dt As DataTable = New DataTable()

        Dim sqlStr As String = "SELECT @ServiceCentre as ServiceCentre,month,day,location,Customer_Visit_S,Call_Registerd_S,Repair_Completed_S,Goods_Delivered_S,Pending_Calls_S,Cancelled_Calls_S,Reservation_S,  "
        sqlStr = sqlStr & "Customer_Visit_D,Call_Registerd_D,Repair_Completed_D,Goods_Delivered_D,Pending_Calls_D,Cancelled_Calls_D,Reservation_D, "
        sqlStr = sqlStr & "Customer_Visit_T,Call_Registerd_T,Repair_Completed_T,Goods_Delivered_T,Pending_Calls_T,Cancelled_Calls_T,Reservation_T, "
        sqlStr = sqlStr & "note,@SRCFIlE as SRC_FILE_NAME FROM SONY_ACTIVITY_REPORT "
        sqlStr = sqlStr & "WHERE DELFG='0' "

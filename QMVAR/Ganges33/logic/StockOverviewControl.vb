...
Public Class StockOverviewControl
        ...
        If flagAll Then
            For i = 0 To csvData.Length - 1
                If i > 0 Then '0  Header
                    ...
                    strCommaRepl = Trim(csvData(i)(2))
                    strCommaRepl = Replace(strCommaRepl, ",", " ")
                    dbConn.sqlCmd.Parameters.Add(CommonControl.GetNullableParameter("@DESCRIPTION", strCommaRepl))
    ...
    Public Function SelectStockOverview(ByVal queryParams As StockOverviewModel) As DataTable
        ...
        sqlStr = sqlStr & "SHIP_TO_BRANCH_CODE as 'Branch',PARTS_NO as 'Parts No',DESCRIPTION as 'Description',WAREHOUSE_STOCK_QTY as 'Warehouse Stock Qty',ENGINEER_STOCK_QTY as 'Engineer Stock Qty',LOCATION1 as 'Location1',LOCATION2 as 'Location2',LOCATION3 as 'Location3',STATUS,MONTH,MAP,TOTAL_STOCK_QTY as 'Total Stock Qty',TOTAL_STOCK_VALUE as 'Total Stock Value'  "
        sqlStr = sqlStr & "FROM "
        sqlStr = sqlStr & "STOCK_OVERVIEW "
        sqlStr = sqlStr & "WHERE "
        sqlStr = sqlStr & "DELFG=0 "
        sqlStr = sqlStr & "AND rtrim(ltrim(SHIP_TO_BRANCH)) not in ('Grand Total') "
        'Comment on 2022-01-21

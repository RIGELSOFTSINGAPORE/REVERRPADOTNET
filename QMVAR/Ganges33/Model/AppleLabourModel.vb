...
Namespace Ganges33.model
    <Serializable>
    Public Class AppleLabourModel
        Public Sub AppleLabourModel()
            CRTDT = String.Empty
            CRTCD = String.Empty
            UPDDT = String.Empty
            UPDCD = String.Empty
        ...
        Public Property AMOUNT_150 As Decimal
        Public Property AMOUNT_170 As Decimal
        Public Property AMOUNT_180 As Decimal

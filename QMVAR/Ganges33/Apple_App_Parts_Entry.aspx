            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h3 class="card-title ">APP Parts Entry</h3>
                   ...
                   <div class="card-body scrollbar" id="style-10" >
                    ...
                    <div class="col-sm-4" >
                     <div >
                         ...
                         <asp:TextBox ID="txtDate" runat="server" class="form-file-upload date serverlbl" style="width: 120px;margin-left:26px" > </asp:TextBox>
                        </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <label id="lblStockType" class="fontFamily bmd-label-floating">Stock Type :     </label>
                            ...
                            <div>
                          <asp:DropDownList ID="drpStockType" CssClass="form-control serverlbl" style="height: 33px;width: 125px;"  runat="server">
        ...
        <asp:gridview ID="Gridview1" Width="100%" runat="server" 
           ...
           Class="form-group">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Parts No">
...
<ControlStyle></ControlStyle>
                ...
                <asp:TemplateField HeaderText="Parts Name">
                     ...
                     <ItemTemplate>
                       <div class="row" style="margin-left:0px"> 
                             <div style="width:80%">
                        <asp:TextBox ID="TextBox2" CssClass="form-control" BackColor="#e6ffff" Enabled="false" runat="server" Text='<%# Eval("PARTS_NAME") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
                                 <asp:RequiredFieldValidator ID="DESCRIPTION" ControlToValidate="TextBox2" runat="server"
                    ErrorMessage="*" Font-Size="Smaller"  ForeColor="Red"
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField HeaderText="Parts Description">
                     ...
                     <ItemTemplate>
                        <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox3"  CssClass="form-control" BackColor="#e6ffff"  Enabled="false" runat="server" Text='<%# Eval("PARTS_DESCRIPTION") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField HeaderText="Parts Type">
                      

                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:83%">
                        <asp:TextBox ID="TextBox4" CssClass="form-control" BackColor="#e6ffff" Enabled="false"  runat="server" Text='<%# Eval("PARTS_TYPE") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
...
<ControlStyle ></ControlStyle>
                 ...
                 <asp:TemplateField HeaderText="Purchase Cost">
                     ...
                     <ItemTemplate>
                          <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox5" CssClass="form-control" BackColor="#e6ffff" Enabled="false" runat="server" Text='<%# Eval("PURCHASE_COST") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
                         <%--<asp:RequiredFieldValidator ID="PURCHASE_COST" ControlToValidate="TextBox5" runat="server"
                    ErrorMessage="*" Font-Size="Smaller" ForeColor="Red"
                    ></asp:RequiredFieldValidator>--%></div>  </div>  
                        <ItemStyle Width="50px"></ItemStyle>
                    </ItemTemplate>
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField  HeaderText="Tier">
                    ...
                    <ItemTemplate>                        
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:76%">
                        <asp:TextBox ID="TextBox6" CssClass="form-control" BackColor="#e6ffff" Enabled="false"  runat="server" Text='<%# Eval("TIER") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
...
<ControlStyle></ControlStyle>
                ...
                <asp:TemplateField HeaderText="Eee Eeee">                   
                       
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:77%">
                       <asp:TextBox ID="TextBox7" CssClass="form-control" BackColor="#e6ffff" Enabled="false" runat="server" Text='<%# Eval("EEE_EEEE") %>'></asp:TextBox>
                        </div>
                             <div style="width:5%">
...
<ControlStyle ></ControlStyle>                    
                ...
                <asp:TemplateField HeaderText="Serial Type">                   
                       
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:70%">
                       <%--<asp:TextBox ID="TextBox8" CssClass="form-control dropdown-toggle" style="width: 100%; height:33px" CssClass="form-control" Enabled="false" runat="server" Text='<%# Eval("SERIAL_TYPE") %>'></asp:TextBox>--%>
                                 <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" style="width: 100%; height:33px" AppendDataBoundItems="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="true">  
                    <asp:ListItem Text="Select" Value="0"></asp:ListItem>    
                             ...
                             <div style="width:5%">
                                       <asp:RequiredFieldValidator ID="SERIAL" CssClass="" ControlToValidate="DropDownList1" runat="server"
                    ErrorMessage="*" InitialValue="0" Font-Size="Smaller" ForeColor="Red"
                    ></asp:RequiredFieldValidator>   </div>  </div>       
                        <ItemStyle Width="20%"></ItemStyle>
...
<ControlStyle ></ControlStyle>                    
                ...
                <asp:TemplateField HeaderText="Serial No">                   
                    ...
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:79%">
                       <asp:TextBox ID="TextBox9" CssClass="form-control" runat="server" Text='<%# Eval("SERIAL_NO") %>'></asp:TextBox>
                        </div>
                             <div style="width:5%">
...
<ControlStyle ></ControlStyle>                    
                  ...
                  <asp:TemplateField HeaderText="In Stock">                   
                    ...
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:78%">
                       <asp:TextBox ID="TextBox10" CssClass="form-control" runat="server" Text='<%# Eval("IN_STOCK") %>'></asp:TextBox>
                        </div>
                             <div style="width:5%">

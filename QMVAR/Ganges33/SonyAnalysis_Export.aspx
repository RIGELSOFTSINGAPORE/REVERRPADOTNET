                        ...
                        <div class="col-sm-9">
                         ...
                         <asp:DropDownList ID="drpTaskExport" CssClass="form-control dropdown-toggle" runat="server" style="width: 100%; height:33px;" AutoPostBack="true"  >
                               <asp:ListItem Text="Select..." Value="-1"></asp:ListItem>
                                ...
                                <asp:ListItem Text="100   PL_Tracking_Sheet " Value="100"></asp:ListItem>
                            ...
                            <%--  <asp:ListItem Text="136.Monthly Abandon" Value="136"></asp:ListItem>--%>
                             ...
                             <asp:ListItem Text="129.Delivered Set" Value="129"></asp:ListItem>
                             <asp:ListItem Text="130.SonyActivity_Report" Value="130"></asp:ListItem>

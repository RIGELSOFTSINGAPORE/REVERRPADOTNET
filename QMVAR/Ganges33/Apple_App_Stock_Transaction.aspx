    ...
    <asp:Button ID="btnback" Width="139px" margin-left="23px" height="30px" margin-top="0px" runat="server"  Text="Back to inventry" OnClick="btnback_Click" class="btn btn-primary text" />
      ...
      <div  class="col-sm-2">
           ...
           <asp:DropDownList ID="DropDownList2" runat="server"  Class="form-control" Width="160px" Style="height: 33px;">
                                            ...
                                            <asp:ListItem Text="Tran Type" Value="04"></asp:ListItem>
                                             <asp:ListItem Text="Tran Ref" Value="05"></asp:ListItem>
               <asp:ListItem Text="Stock Type" Value="06"></asp:ListItem>
                                </asp:DropDownList>
          ...
          <br /><br />--%>
                       ...
                       <div class="row col-sm-12" style="height:40px" runat="server">
                           ...
                           <p style="font-size: small">
                               Search Item (Stock Type: 1=Consigenment, 2=Stock) 
                           </p>
                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                          <p style="font-size:small">
                         (Tran Type: 1=InStock, 2=OutStock)
                   </p>
...
<ControlStyle ></ControlStyle>
                 ...
                 <asp:TemplateField HeaderText="Part No" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Center" SortExpression="PART_NO" >
...
<ControlStyle ></ControlStyle>
                 ...
                 <asp:TemplateField   HeaderText="DESCRIPTION" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Center" SortExpression="DESCRIPTION" >
                   <ItemTemplate >
                        <asp:Label ID="lblDESCRIPTION" runat="server"  Text='<%# Eval("DESCRIPTION") %>'></asp:Label>
                    </ItemTemplate>
                  
                </asp:TemplateField>
                <asp:TemplateField  HeaderText="QUANTITY" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Center" SortExpression="QUANTITY" >
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField HeaderText="TRAN TYPE" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Center" SortExpression="TRAN_TYPE" >
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField   HeaderText="TRAN REF" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Center" SortExpression="TRAN_REF" >
                   <ItemTemplate>
                ...
                <asp:TemplateField   HeaderText="Stock Type" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Center" SortExpression="STOCK_TYPE" >
                   <ItemTemplate>
                        <asp:Label ID="lblSTOCKTYPE" runat="server"  Text='<%# Eval("STOCK_TYPE") %>'></asp:Label>
                    </ItemTemplate>

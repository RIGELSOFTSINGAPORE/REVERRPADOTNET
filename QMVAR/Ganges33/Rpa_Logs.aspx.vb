...
Public Class Rpa_Logs
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            txtDateFrom.Text = dDate.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)

            txtDateTo.Text = dDate.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture)
    ...
    Protected Sub BindGridview(strDateFrom As String, strDateTo As String)
        ...
        strDateTo = CDate(strDateTo).ToString("yyyy/MM/dd")

              ...
              <div class="card">
                <div class="card-header  card-header-primary">
                  <h3 class="card-title">
                      ...
                      <asp:label id="lblAppleInventry" Text="APP Inventry" runat="server"> </asp:label>
                  </h3>
                ...
                <div class="card-body scrollbar" id="style-10">           
                    ...
                    <div class="col-sm-7">
                                    <asp:Button ID="btnnewparts" margin-left="120px" Width="144px" height="32px" margin-top="0px" runat="server" Text="APP Parts Entry" OnClick="btnnewparts_Click" class="btn btn-primary text" />
                                           <asp:Button ID="btnPartsStock"   runat="server" class="btn btn-primary text " OnClick="btnPartsStock_Click" Width="196px" height="32px" Text="APP Parts Management " />  
            ...
            <Columns>
               ...
               <%--<asp:BoundField  DataField="INVENTORY_DATE" Convert.ToDateTime(Eval("INVENTORY_DATE")).ToString("yyyy/MM/dd")  HeaderText="Inventery Date" />--%>
                ...
                <asp:TemplateField HeaderText="Parts Type">
                        <ItemTemplate>
                            <asp:Label ID="PARTSTYPE" runat="server"  Text='<%# Eval("PARTS_TYPE") %>'></asp:Label>
                        </ItemTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Part No" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Right" SortExpression="PARTS_NO">
                        <ItemTemplate>
                            <asp:Label ID="partno" runat="server" Text='<%# Eval("PARTS_NO") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle ></ItemStyle>
                        </asp:TemplateField>
                    <asp:TemplateField HeaderText="PARTSNAME" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Right" SortExpression="PARTS_NAME">
                        <ItemTemplate>
                            <asp:Label ID="PARTS_NAME" runat="server" Text='<%# Eval("PARTS_NAME") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle ></ItemStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Description" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Right" SortExpression="PARTS_DESCRIPTION" >
                        
                        <ItemTemplate>
                            <asp:Label ID="lblDESCRIPTION" runat="server" Text='<%# Eval("PARTS_DESCRIPTION") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle ></ItemStyle>
                       
                    </asp:TemplateField>

                   <asp:TemplateField HeaderText="PURCHASECOST" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Right" SortExpression="PURCHASE_COST">
                       
                        <ItemTemplate>
                            <asp:Label ID="PURCHASE_COST" runat="server"  Text='<%# Eval("PURCHASE_COST") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle ></ItemStyle>
                    </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="SALESCOST" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Right" SortExpression="SALES_COST" >
                       
                        <ItemTemplate>
                            <asp:Label ID="SALES_COST" runat="server"   Text='<%# Eval("SALES_COST") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle ></ItemStyle>
                    </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="PARTSTYPE" HeaderStyle-CssClass="sort" ItemStyle-HorizontalAlign="Right" SortExpression="PARTS_TYPE" >
                       
                        <ItemTemplate>
                            <asp:Label ID="PARTS_TYPE" runat="server"   Text='<%# Eval("PARTS_TYPE") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle></ItemStyle>
                    </asp:TemplateField>

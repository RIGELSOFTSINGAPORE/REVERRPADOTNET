<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AppleAnalysis.Master" CodeBehind="Apple_Dashboard.aspx.vb" Inherits="Ganges33.Apple_Dashboard" %>
...
<table id="table1">	
  ...
  <tr>
   ...
   <td class="td2"><asp:Label ID="lblLabourIWCash" runat="server">0.00</asp:Label></td>
    <td class="td2"><asp:Label ID="lblLabourIWCard" runat="server">0.00</asp:Label></td>
  ...
  <tr>
   ...
   <td class="td2"><asp:Label ID="lblPartsIWCash" runat="server">0.00</asp:Label></td>
    <td class="td2"><asp:Label ID="lblPartsIWCard" runat="server">0.00</asp:Label></td>
  ...
  <tr>
   ...
   <td class="td2"><asp:Label ID="lblTotalIWCash" runat="server">0.00</asp:Label></td>
    <td class="td2"><asp:Label ID="lblTotalIWCard" runat="server">0.00</asp:Label></td>
	<td class="td2"><asp:Label ID="lblTotalOOWCash" runat="server">0.00</asp:Label></td>
	 <td class="td2"><asp:Label ID="lblTotalOOWCard" runat="server">0.00</asp:Label></td>
	  ...
	  <td class="td2"><asp:Label ID="lblTotalNet" runat="server">0.00</asp:Label></td>
  </tr>
  ...
  <tr>
   ...
   <td colspan="2" class="td2"><asp:Label ID="lblNetOOW" runat="server">0.00</asp:Label></td>
	<td colspan="2" class="td2"><asp:Label ID="lblNetAC" runat="server">0.00</asp:Label></td>
	  <td colspan="2" class="td2"><asp:Label ID="lblNetTotal" runat="server">0.00</asp:Label></td>
	  <td class="td2"><asp:Label ID="lblNet" runat="server">0.00</asp:Label></td>
  </tr>

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AppleAnalysis.Master" CodeBehind="Apple_Parts_Entry.aspx.vb" Inherits="Ganges33.Apple_Parts_Entry" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Part Number">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:TextBox ID="TextBox1" ViewStateMode="Enabled" AutoPostBack="true" CssClass="form-control" OnTextChanged="TextBox1_TextChanged" Text='<%# Eval("PART_NO") %>'  runat="server"></asp:TextBox>
                        </div>
                             <div style="width:5%">
...
<ControlStyle></ControlStyle>
                ...
                <asp:TemplateField HeaderText="UPC/EAN">
                    
                     <ItemTemplate>
                       <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox2" CssClass="form-control" Enabled="false" runat="server" Text='<%# Eval("UPC_EAN") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
                                 <br />
                                 </div>  </div>  
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField HeaderText="Description">
                     ...
                     <ItemTemplate>
                        <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox3"  CssClass="form-control"  Enabled="false" runat="server" Text='<%# Eval("DESCRIPTION") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField HeaderText="IN STOCK">
                    ...
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox4" CssClass="form-control"  runat="server" Text='<%# Eval("IN_STOCK") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
...
<ControlStyle ></ControlStyle>
                 ...
                 <asp:TemplateField HeaderText="BALANCE">
                     ...
                     <ItemTemplate>
                          <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox5" CssClass="form-control" Enabled="false" runat="server" Text='<%# Eval("BALANCE") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
                         <asp:RequiredFieldValidator ID="IN_STOCK" ControlToValidate="TextBox5" runat="server"
                    ErrorMessage="*" Font-Size="Smaller" ForeColor="Red"
                    ></asp:RequiredFieldValidator></div>  </div>  
                        <ItemStyle Width="50px"></ItemStyle>
                    </ItemTemplate>
...
<ControlStyle ></ControlStyle>
                ...
                <asp:TemplateField  HeaderText="Cost Price">
                    ...
                    <ItemTemplate>
                         ...
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                        <asp:TextBox ID="TextBox6" CssClass="form-control" Enabled="false"  runat="server" Text='<%# Eval("PURCHASE_PRICE") %>'></asp:TextBox>
                                 </div>
                             <div style="width:5%">
                        <asp:RequiredFieldValidator ID="PURCHASE_PRICE" ControlToValidate="TextBox6" runat="server"
                    ErrorMessage="*" Font-Size="Smaller" ForeColor="Red"
                    ></asp:RequiredFieldValidator> </div>  </div> 
                        <ItemStyle Width="50px"></ItemStyle>
                    </ItemTemplate>
...
<ControlStyle></ControlStyle>
                ...
                <asp:TemplateField HeaderText="Sales Price">                   
                    ...
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                       <asp:TextBox ID="TextBox7" CssClass="form-control" Enabled="false" runat="server" Text='<%# Eval("SALES_PRICE") %>'></asp:TextBox>
                        </div>
                             <div style="width:5%">
                                       <asp:RequiredFieldValidator ID="SALES_PRICE" CssClass="" ControlToValidate="TextBox7" runat="server"
                    ErrorMessage="*" Font-Size="Smaller" ForeColor="Red"
                    ></asp:RequiredFieldValidator>   </div>  </div>       
...
<ControlStyle ></ControlStyle>                    
                ...
                <asp:TemplateField HeaderText="Part Tax (%)">                   
                       
                    <ItemTemplate>
                         <div class="row" style="margin-left:0px"> 
                             <div style="width:85%">
                       <asp:TextBox ID="TextBox8" CssClass="form-control" Enabled="false" runat="server" Text='<%# Eval("PART_TAX") %>'></asp:TextBox>
                        </div>
                             <div style="width:5%">
                                       <asp:RequiredFieldValidator ID="PART_TAX" CssClass="" ControlToValidate="TextBox8" runat="server"
                    ErrorMessage="*" Font-Size="Smaller" ForeColor="Red"
                    ></asp:RequiredFieldValidator>   </div>  </div>       
                        <ItemStyle Width="20%"></ItemStyle>

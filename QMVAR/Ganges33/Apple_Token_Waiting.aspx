<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AppleAnalysis.Master" CodeBehind="Apple_Token_Waiting.aspx.vb" Inherits="Ganges33.Apple_Token_Waiting" %>
        ...
        <ItemTemplate>
             <%#Container.DataItemIndex+1 %>
                    ...
                    <asp:TemplateField HeaderText="Model">
                     ...
                     <asp:TemplateField ShowHeader="False" >
                        <ItemTemplate>
                        <asp:ImageButton Text="Select" id="btnPause" Width="30px" runat="server"  ToolTip="Pause Token" CommandName="Pause" CommandArgument="<%# Container.DataItemIndex %>"  ImageUrl="icon/pause.png"/>
                        <asp:ImageButton Text="Select" id="btnClose" Width="30px" runat="server"  ToolTip="Close Token"  CommandName="Close" CommandArgument="<%# Container.DataItemIndex %>"  ImageUrl="icon/close.jpg"  OnClientClick="return confirm('Are you sure you want to delete ?');"  />

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/RpaDemo.Master" CodeBehind="Rpa_OnOff_Demo.aspx.vb" Inherits="Ganges33.Rpa_OnOff_Demo" %>
        ...
        <div class="container-fluid">
          <div class="row">
           ...
           <asp:Label ID="lblInfo" CssClass="bmd-label-floating serverlbl" runat="server"></asp:Label>
                         ...
                         <div>
           <div >
                <asp:Button ID="btnSuspendScheduler" runat="server"  Width="190px" height="36px" Text="Suspend Scheduler" class="btn btn-primary btn-lbl text"  />
                                </div> <div>
                <asp:Button ID="btnSuspendTask" runat="server"  Width="190px" height="36px" Text="Suspend Tasks" class="btn btn-primary btn-lbl text"  />
            </div>

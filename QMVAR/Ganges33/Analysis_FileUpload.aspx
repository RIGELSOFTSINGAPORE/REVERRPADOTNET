...
<br /><br />
  <div class="row col-sm-12">
          ...
          <div class="col-sm-6 row">
              ...
              <div  class="col-sm-8">
                   <div  class="col-sm-12" style="padding-left:0px"><%--<br />--%>
                           <label id="" class="fontFamily bmd-label-floating">Parts Invoice No</label>
                                </div>
                                </div>
                            <div class="col-sm-4"><%--<br />--%>
                                  
                                 <asp:TextBox ID="TextPartsInvoiceNo" runat="server" value="" Height="33px" Width="107%" class="form-file-upload  serverlbl" />
                    </div>
      </div>
      </div>
</div>
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:ListItem Text="Select..." Value="0"></asp:ListItem>
                             ...
                             <asp:ListItem Text="15.Return Credit" Value="15"></asp:ListItem>
                              ...
                              <asp:ListItem Text="23.PODC" Value="23"></asp:ListItem>
                               ...
                               <asp:ListItem Text="26.Service Order Cancelled" Value="26"></asp:ListItem>
                             <asp:ListItem Text="27.Service Order Pending" Value="27"></asp:ListItem>
                                <asp:ListItem Text="3A-1.PDF-Sales Register from GSPN Samsung_C IW" Value="3a1"></asp:ListItem>
                              <asp:ListItem Text="3B-1,PDF-Sales Register from GSPN Samsung_EXC IW" Value="3b1"></asp:ListItem>
                              <asp:ListItem Text="4A,PDF-Sales Register from GSPN OOW" Value="4a"></asp:ListItem>
                         ...
                         <div class="col-sm-6 row">
                          ...
                          <label id="" class="fontFamily bmd-label-floating">Labor Invoice No</label>
                            ...
                            <div class="col-sm-4">
                                 <br />
                                <asp:TextBox ID="TextLaborInvoiceNo" runat="server" Height="33px" Width="107%"  value="" class="form-file-upload serverlbl" />  
              </div>
                          </div>
                          </div>
                   </div>
    ...
    <div  class="col-sm-4">
         <br />
                      ...
                      <asp:RadioButton type="radio"  value="RadioBtnMM" AutoPostBack="true"  ID="RadioBtnMM" runat="server" />&nbsp;&nbsp;<asp:label runat="server" CssClass="serverlbl"  Style="Font-Size:13px; font-weight:500" Text="MM/DD/YYYY"></asp:label>
                                  ...
                                  <div class="" style="margin-left:15px;"><br />
                    ...
                    <label id="" class="fontFamily bmd-label-floating" >Invoice Date(DD/MM/YYYY)</label>
                      ...
                      <div class="col-sm-4">
                            <br />
                          <asp:TextBox value="" ID="TextInvoiceDate" runat="server" Height="33px" Width="107%" AutoCompleteType="Disabled" class="form-file-upload serverlbl date  " />
                   <%--   <ajaxToolkit:CalendarExtender ID="TextInvoiceDate_CalendarExtender" runat="server"  CssClass="date" BehaviorID="TextInvoiceDate_CalendarExtender" TargetControlID="TextInvoiceDate" PopupPosition="right">
                    ...
                    <label id="" class="fontFamily bmd-label-floating">Date</label>
                      ...
                      <div class="col-sm-4">
                           <br />
                    <asp:TextBox value="" ID="txtDate" runat="server" Height="33px" Width="107%" AutoCompleteType="Disabled"  class="form-file-upload serverlbl date  calender"  />&nbsp;&nbsp;&nbsp;
               <%--       <ajaxToolkit:CalendarExtender ID="txtDate_CalendarExtender" runat="server" Format="MM/dd/yyyy" BehaviorID="txtDate_CalendarExtender" TargetControlID="txtDate" PopupPosition="Left">
                  ...
                  <label id="" class="  bmd-label-floating">Amount</label>
                    ...
                    <div class="col-sm-4">
                         <br />
                        <asp:TextBox ID="txtAmount" runat="server" value="" Height="33px"   Width="107%"   class="form-file-upload serverlbl" />
                   </div>
                              </div>
                              </div>
                    ...
                    <label class="bmd-label-floating">Advice Reference No</label>
                      ...
                      <div class="col-sm-4">
                           <br />
                          <asp:TextBox ID="txtArNo" runat="server" value="" Height="33px" Width="107%" class="form-control serverlbl" />
               </div>
                  ...
                  <div class="col-sm-12">
                      ...
                      <%--<asp:Button ID="btnUpload" runat="server"  Text="Import" Width="90px" height="36px"  class="btn btn-primary pull-right text" />--%>
                  </div>


                    <%-- SERVICE_ORDER_PENDING start --%>
                                  ...
                                  <div class="col-sm-6 row">
                                      <div class="col-sm-12" style="padding-left:0px">
                                        <div  class="col-sm-8">
                                             <br />
                                            <div class="col-sm-12" style="padding-left:0px">
                    <label class="bmd-label-floating" id="lblstatus" runat="server" visible="false">Status</label>
                  </div></div>
                      <div class="col-sm-4">
                           <br />
                          <asp:TextBox ID="txtstatus" runat="server" autocomplete="off" visible="false" value="" Height="33px" Width="107%" class="form-control serverlbl" />
               </div>
                                  ...
                                  <div class="col-sm-6 row">
                                      <div class="col-sm-12" style="padding-left:0px">
                                        <div  class="col-sm-8">
                                             <br />
                                            <div class="col-sm-12" style="padding-left:0px">
                    <label class="bmd-label-floating" id="lblReason" runat="server" visible="false">Reason</label>
                  </div></div>
                      <div class="col-sm-4">
                           <br />
                          <asp:TextBox ID="txtReason" runat="server" visible="false" autocomplete="off" value="" Height="33px" Width="107%" class="form-control serverlbl" />
               </div>
                                  ...
                                  <div class="col-sm-6 row">
                                      <div class="col-sm-12" style="padding-left:0px">
                                        <div  class="col-sm-8">
                                             <br />
                                            <div class="col-sm-12" style="padding-left:0px">
                    <label class="bmd-label-floating" runat="server" id="lblAgingday" visible="false">Aging Day</label>
                  </div></div>
                      <div class="col-sm-4">
                           <br />
                          <asp:TextBox ID="txtAgingDay" runat="server" visible="false" autocomplete="off" value="" Height="33px" Width="107%" class="form-control serverlbl" />
               </div>

                ...
                <div class="card-body scrollbar" id="style-10">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                  <br />
                            <asp:DropDownList ID="Status" runat="server"   width="100%" Height="33px" class="form-control  serverlbl">
               ...
               <div class="row" runat="server" id="data">
                    ...
                    <div class="col-sm-12">
                       ...
                       <label style="margin-top: 3px;"> Task name : </label>
                            ...
                            <div style="width: 178px;" class="search1">
                                                                <br />
<asp:TextBox ID="txtSearch" runat="server" CssClass="form-control"  AutoPostBack="true"></asp:TextBox>
    ...
    <asp:Button ID="Create" runat="server" Width="90px" Text="Create" class="btn btn-primary text" />
                            </div>

        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="row col-sm-12" style="vertical-align:top">
                ...
                <asp:Button ID="btnUser" runat="server"  Width="236px" height="36px"  class="btn btn-primary btn-lbl text" Text="Update GSPN Credentials" />
                &nbsp;&nbsp;&nbsp;&nbsp;
               </div>
                   <div>
                <asp:Button ID="btnMailManagement" Width="179px" height="36px"  runat="server" class="btn btn-primary btn-lbl text" Text="     Mail Management       "  />
            </div>
            </div>
                       
                <br />      
            <div > 
                <div class="GridviewDiv " id="divGspn" style="margin-top:25px" runat="server" visible="false">
                <br />
...
<asp:BoundField DataField="RpaClientPwd" HeaderText="Password" />
  ...
  <asp:TemplateField HeaderText="New GSPN Usernmae"  Visible="true">
                ...
                <asp:Button id="btnUpDateGspnPwd" runat="server" Width="243px" height="36px"  class="btn btn-primary btn-lbl pull-right text" Text="Update GSPN password"/>
            <br />     
            </div>
                <br />

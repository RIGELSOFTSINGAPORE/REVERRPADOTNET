...
Public Class Apple_parts_Stock
    ...
    Private Sub Display(Optional ByVal sortExpression As String = Nothing, Optional strText As Object = Nothing)
        ...
        Dim _Datatble As DataTable = _ApplePartsStockcontrol.GetParts_Stock(_ApplePartsStock)
    ...
    Protected Sub txtSearchGrid_Click(sender As Object, e As EventArgs, Optional ByVal sortExpression As String = Nothing)
        ...
        Dim _ApplePartsStockModel As New ApplePartsStockModel
        Dim _ApplePartsStockcontrol As New ApplePartsStockControl
        _ApplePartsStockModel.DropdownSearch_1 = DropDownList1.SelectedItem.Value
        _ApplePartsStockModel.DropdownSearch_2 = DropDownList2.SelectedItem.Value
        _ApplePartsStockModel.DropdownSearch_3 = DropDownList3.SelectedItem.Value
        ...
        _ApplePartsStockModel.Search_From_Date = strDateFrom
        _ApplePartsStockModel.Search_To_Date = strDateTo
        _ApplePartsStockModel.GetValue = txtSearch.Text
        Dim _Datatble As DataTable = _ApplePartsStockcontrol.GetPartsStock(_ApplePartsStockModel)
        Dim _dataview As New DataView(_Datatble)
        If (Not (sortExpression) Is Nothing) Then
            Dim dv As DataView = _Datatble.AsDataView
            Me.SortDirection = IIf(Me.SortDirection = "ASC", "DESC", "ASC")
    ...
    Protected Function ExportDatatableToHtmlPartsStock(ByVal dt As DataTable) As String
        ...
        strHTMLBuilder.Append("<td>Row</td><td>PART_NO</td><td>UPC_EAN</td><td>DESCRIPTION</td><td>SAP_PART_DESCRIPTION</td>")
        strHTMLBuilder.Append("<td>PURCHASE_PRICE</td><td>SALES_PRICE</td><td>CURRENT_IN_STOCK</td><td>LAST_OUT_DATE</td><td>LAST_IN_DATE</td><td>Part_Tax</td><td>NUMBER_PURCHASED_SO_FAR</td><td>NUMBER_SOLD_SO_FAR</td>")
        strHTMLBuilder.Append("</tr>")
    ...
    Protected Sub ExportExcel(ByVal dt As DataTable, ByVal strReportitle As String)
        ...
        Dim attachment As String = "attachment; filename=PartsStock.xls"

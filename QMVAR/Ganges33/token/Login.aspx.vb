...
Public Class Login1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            'セッション情報クリア
            Session.Clear()
            lblServer.Text = ConfigurationManager.AppSettings("SeverLoc")
        End If
    ...
    Protected Sub BtnSubmit_Click(sender As Object, e As EventArgs) Handles BtnSubmit.Click
        ...
        sqlStr = "SELECT top 1 ship_1, user_level, admin_flg FROM dbo.M_USER WHERE user_id = '" & userid & "'  AND DELFG = 0;"
        ...
        Session("admin_Flg") = adminFlg 'VJ 2019/10/30 Admin flag not assigned Session variable. that is reason
        'assign value in the session variable 
        ...
        If (Session("user_id") Is Nothing) Then
            If (userid = "") Then
                Call showMsg("Please Enter ID.")
                Exit Sub
            End If
        End If

        Dim BranchName As String = DropListLocation.SelectedValue.ToString()
        ...
        If BranchName.Length = 0 Then
            Call showMsg("Please Select Your Branch After Login.")
            Exit Sub
        Else
            Session("ship_Name") = BranchName

            'Added code forApple
            Dim shipService As String = ""

            clsSetCommon.setShipCodes(BranchName, shipCode, errMsg, shipMark, shipService)

            If UCase(shipService) = "AP" Then
                If errMsg <> "" Then
                    Call showMsg(errMsg)
                    Exit Sub
                End If
                ...
                If errMsg <> "" Then
                    ...
                    Exit Sub
                End If
                Session("shipService") = shipService
                Session("ship_code") = shipCode
                Session("user_Name") = userName
                Session("ship_mark") = shipMark
                '********************
                Response.Redirect("../Apple_Token_Dashboard.aspx")
    ...
    Protected Sub BtnLogin_Click(sender As Object, e As EventArgs) Handles BtnLogin.Click
        ...
        Else
            ...
            clsSetCommon.setShipCodes(shipName, shipCode, errMsg, shipMark, shipService)
            ...
            Else
                ...
                ElseIf userLevel = "6" Then 'VJ 2019/10/29 Add new user level 6 for display only Analysis  Export Start
                    ...
                    Session("user_Name") = userName
                    Session("ship_mark") = shipMark
                    Response.Redirect("Analysis_Export.aspx") 'VJ 2019/10/29 Add new user level 6 for display only Analysis  Export End
                ElseIf userLevel = "8" Then 'VJ 2020/03/03 Add new user level 8 for display only Analysis  Export Start
                    ...
                    Session("user_Name") = userName
                    Session("ship_mark") = shipMark
                    Response.Redirect("Analysis_Export.aspx") 'VJ 2020/03/03 Add new user level 8 for display only Analysis  Export End

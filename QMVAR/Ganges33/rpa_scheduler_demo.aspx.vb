...
Public Class rpa_scheduler_demo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Dim dtScheduler As DataTable = _RpaSchedulerControl.SelectRpaSchedulerDemo(_RpaSchedulerModel)
    ...
    Protected Sub BindData()
        Dim _RpaSchedulerModel As RpaSchedulerModel = New RpaSchedulerModel()
        Dim _RpaSchedulerControl As RpaSchedulerControl = New RpaSchedulerControl()
        Dim FromTable As DataTable = _RpaSchedulerControl.SelectRpaSchedulerDemo(_RpaSchedulerModel)
    ...
    Protected Sub gvRPADetails_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs)
        ...
        If e.CommandName.Equals("ADD") Then
            ...
            If UCase(Right(Trim(txtAddSCHEDULER_NAME.Text), 4)) <> "DEMO" Then
                Call showMsg("Scheduler Name Should Be End With Demo !!! ", "")
                Exit Sub
            End If

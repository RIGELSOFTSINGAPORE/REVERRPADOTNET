Public Class Class_common
    ...
    Public Sub setShipCodes(ByVal setShipName As String, ByRef shipCode As String, ByRef errMsg As String, ByRef shipMark As String, ByRef shipService As String)
        ...
        If DT_M_ship_base IsNot Nothing Then
            If DT_M_ship_base.Rows(0)("ship_code") IsNot DBNull.Value Then
                shipCode = DT_M_ship_base.Rows(0)("ship_code")
            End If
            If DT_M_ship_base.Rows(0)("ship_mark") IsNot DBNull.Value Then
                shipMark = DT_M_ship_base.Rows(0)("ship_mark")
            End If
            If DT_M_ship_base.Rows(0)("ship_service") IsNot DBNull.Value Then
                shipService = DT_M_ship_base.Rows(0)("ship_service")
            End If

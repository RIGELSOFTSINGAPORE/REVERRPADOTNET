...
Public Class Apple_App_Stock_Transaction
    ...
    Protected Sub GridViewBind(Optional ByVal sortExpression As String = Nothing, Optional strText As Object = Nothing)
        Dim _ApPartsConsignmentStockTranModel As New ApPartsConsignmentStockTranModel
        Dim _ApPartsConsignmentStockTranControl As New ApPartsConsignmentStockTranControl
        ...
        Dim dtAppleTrans As DataTable = _ApPartsConsignmentStockTranControl.GetParts_StockTransaction(_ApPartsConsignmentStockTranModel)
    ...
    Protected Sub txtSearchGrid_Click(sender As Object, e As EventArgs, Optional ByVal sortExpression As String = Nothing)
        If DropDownList1.SelectedItem.Text = "Select Date" And DropDownList2.SelectedItem.Text = "Select Item" Then
            ...
            Exit Sub
        End If
        If Not DropDownList1.SelectedItem.Text = "Select Date" Then
        ...
        Dim _ApPartsConsignmentStockTranModel As New ApPartsConsignmentStockTranModel
        Dim _ApPartsConsignmentStockTranControl As New ApPartsConsignmentStockTranControl
        _ApPartsConsignmentStockTranModel.DropdownSearch_1 = DropDownList1.SelectedItem.Value
        _ApPartsConsignmentStockTranModel.DropdownSearch_2 = DropDownList2.SelectedItem.Value
        _ApPartsConsignmentStockTranModel.DropdownSearch_3 = DropDownList3.SelectedItem.Value
        ...
        _ApPartsConsignmentStockTranModel.Search_From_Date = strDateFrom
        _ApPartsConsignmentStockTranModel.Search_To_Date = strDateTo
        _ApPartsConsignmentStockTranModel.GetValue = txtSearch.Text
        Dim _Datatble As DataTable = _ApPartsConsignmentStockTranControl.GetStockTransaction(_ApPartsConsignmentStockTranModel)
    ...
    Protected Function ExportDatatableToHtmlPartsStockTransaction(ByVal dt As DataTable) As String
        ...
        strHTMLBuilder.Append("<td>QUANTITY</td><td>TRAN_TYPE</td><td>TRAN_REF</td><td>Stock Type</td><td>Serial NO</td>")
        strHTMLBuilder.Append("</tr>")
    ...
    Protected Sub ExportExcel(ByVal dt As DataTable, ByVal strReportitle As String)
        ...
        Dim attachment As String = "attachment; filename=AppleAppPartsConsignmentStockTran.xls"
    ...
    Protected Sub btnnewparts_Click(sender As Object, e As EventArgs)
        Response.Redirect("Apple_App_Parts_Create.aspx")
    End Sub

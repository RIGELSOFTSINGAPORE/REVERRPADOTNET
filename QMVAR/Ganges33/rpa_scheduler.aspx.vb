                        ...
                        Case "10DAYS"
                            ...
                            If Not File.Exists(strPath) Then
                                Using swXml As StreamWriter = File.CreateText(strPath)
                                    ...
                                    swXml.WriteLine("<Day>02</Day>")
                                    swXml.WriteLine("<Day>03</Day>")
                                    swXml.WriteLine("<Day>11</Day>")
                                    swXml.WriteLine("<Day>12</Day>")
                                    swXml.WriteLine("<Day>13</Day>")
                                    swXml.WriteLine("<Day>21</Day>")
                                    swXml.WriteLine("<Day>22</Day>")
                                    swXml.WriteLine("<Day>23</Day>")
                                    swXml.WriteLine("</DaysOfMonth>")
                        ...
                        Case "MONTHLY"
                            ...
                            If Not File.Exists(strPath) Then
                                Using swXml As StreamWriter = File.CreateText(strPath)
                                    ...
                                    'Added on 20210702
                                    swXml.WriteLine("<Day>1</Day>")
                                    swXml.WriteLine("<Day>2</Day>")
                                    swXml.WriteLine("<Day>3</Day>")

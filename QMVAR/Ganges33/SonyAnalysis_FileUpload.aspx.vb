...
Public Class SonyAnalysis_FileUpload
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs) Handles btnUpload.Click
        ...
        Else
            ...
            ElseIf drpTask.SelectedValue = "128" Then
                ...
                'Added for Delivered Set
            ElseIf drpTask.SelectedValue = "129" Then

                'Item129. Delivered Set
                '*********************************
                'Verify FileName Rules Followed
                Dim strFileName As String = System.IO.Path.GetFileNameWithoutExtension(FileUploadAnalysis.FileName)
                Dim strSrcFileName As String = System.IO.Path.GetFileName(FileUploadAnalysis.FileName)
                ...
                FileUploadAnalysis.SaveAs(filenameFullPath)
                'Update to Database
                Item129(filenameFullPath, fileName, userid, userName, strSrcFileName)
    ...
    Private Sub Item129(filenameFullPath As String, fileName As String, userid As String, userName As String, strSrcFileName As String)
        'Read the content from stored file
        Dim cReader
        Dim textLines As New List(Of String())
        Dim strArr()() As String
        ...
        _SonyDeliveredSetModel.UPDPG = "Class.Analysis.vb"
        _SonyDeliveredSetModel.FILE_NAME = fileName
        _SonyDeliveredSetModel.SRC_FILE_NAME = strSrcFileName
        _SonyDeliveredSetModel.UserId = userid
        _SonyDeliveredSetModel.UPLOAD_USER = userName
        ...
        'Upload to csv file to database for Other Update (GSPN to MultiVendor)
        Dim blStatus As Boolean = _SonyDeliveredSetControl.AddModifyDeliveredSet(strArr, _SonyDeliveredSetModel)
        'If Error Raised then show the errors
        If Not blStatus Then
            Call showMsg("Status: Upload Failed <br /><br />  Please check the content of file ", "")
            Exit Sub

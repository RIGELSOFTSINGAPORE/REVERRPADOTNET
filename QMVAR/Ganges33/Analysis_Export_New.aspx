    ...
    <div>
       ...
       <div class="row  ">
					...
					<div class="row">
                        <div class="col-sm-5">
                           ...
                           <br />
                                <div class="col-sm-8" style="padding-left:0px">
                                    <br />
              <label runat="server" ID="Label8" class="bmd-label-floating "> Date:</label>
              </div>

                                <div style="padding-left:0px"> 
                                   <br />
                                <label runat="server" ID="Label9" class="bmd-label-floating ">
                                    From
                                </label>
                            </div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <asp:Button ID="btnSearch" runat="server" Width="90px" height="36px"  Text="Search" class="btn btn-primary pull-right text" />
                  
                      <asp:Button runat="server" ID="btnExport" Width="90px" height="36px"  class="btn btn-primary pull-right text" Visible="false" Text="Export" />

...
Public Class Login
    ...
    Protected Sub BtnSubmit_Click(sender As Object, e As EventArgs) Handles BtnSubmit.Click
        ...
        If (userid = "") Or (password = "") Then
            Call showMsg("Please Enter User ID and Password.")
            Exit Sub
        End If
    ...
    Protected Sub BtnLogin_Click(sender As Object, e As EventArgs) Handles BtnLogin.Click
        ...
        If shipName.Length = 0 Then
            Call showMsg("Please select branch after Submit.")
            Exit Sub
        Else
            ...
            Else
                ...
                ElseIf userLevel = "0" Or userLevel = "1" Or userLevel = "2" Or adminFlg = True Then
                    ...
                    Else
                        'Comment on 2021-06-14
                        'Response.Redirect("Dashboard_view.aspx")
                        'prabu comment 2021-06-11
                        'Response.Redirect("Analysis_FileUpload.aspx")
                        'Modified on 20210609 - RPA Process
                        If (userid = "umekita4") Then
                            Response.Redirect("Analysis_FileUpload.aspx")
                        Else
                            Response.Redirect("Dashboard_view.aspx")
                        End If

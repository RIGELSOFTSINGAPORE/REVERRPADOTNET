...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <<div class="wrapper  col-sm-12 sidebar-wrapper position-fixed scrolbar contain" >
    ...
    <div class="content" >
      ...
      <div class="row  ">
				  ...
				  <asp:DropDownList ID="DropDownMonth" runat="server" CssClass="form-control dropdown-toggle" style="width: 100%; height:33px" >
                             ...
                             <asp:ListItem Text="July" Value="07"></asp:ListItem>
                              ...
                              <asp:ListItem Text="December" Value="12"></asp:ListItem>
                                 ...
                                 <div id="cancel" runat="server">
                                <br />
                                <label id="cancellation" runat="server" Class="bmd-label-floating">Cancellation: &nbsp;&nbsp;</label>
                                <asp:CheckBox ID="chkCancellation" runat="server"  AutoPostBack="true" />  
                                </div>
                            <div class="col-sm-2">
                                <br />
                           <%-- <asp:CheckBox ID="chkCancellation" runat="server"  AutoPostBack="true"   />  --%>
                          ...
                          <div class="col-sm-2" style="padding-left:0px">
                                 <br />  
					<asp:DropDownList ID="DropDownYear" runat="server" CssClass="form-control dropdown-toggle"   style="width: 100%; height:33px" >
              ...
              <label  class="bmd-label-floating "> Date:
                        ...
                        <div class="col-sm-7 row" style="padding-left:0px">
                           ...
                           <div class="col-sm-5 " style="margin-left:0px">
                                  <br />
                 <asp:TextBox ID="TextDateFrom" runat="server" class="form-file-upload  date serverlbl" AutoCompleteType="Disabled" style="width: 100%;"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                     </div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             ...
                             <div  class="col-sm-5 " style="margin-left:0px">
                                <br />
                                <asp:TextBox ID="TextDateTo" runat="server" class="form-file-upload date serverlbl" AutoCompleteType="Disabled" style="width: 100%;"></asp:TextBox>
                     ...
                     <asp:GridView ID="gvFiles" runat="server" AutoGenerateColumns="False" Width="100%"  
                            OnRowCommand="gvFiles_RowCommand" Visible="false">  
                            <Columns>  
                                <asp:TemplateField HeaderText="Invoice Download Here">  
                                    <ItemTemplate>  
                                        <asp:LinkButton ID="lnkDownload" runat="server" CausesValidation="False" CommandArgument='<%# Container.DataItemIndex %>'  
                                            CommandName="Download" Text='<%# Eval("SRC_FILE_NAME") %>' />  
                                    </ItemTemplate>  
                                </asp:TemplateField>  
                               
                                <asp:TemplateField HeaderText="SRC_FILE_NAME" ItemStyle-Width="150" Visible="false" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblSrcFileName" runat="server" Text='<%# Eval("SRC_FILE_NAME") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                               <asp:TemplateField HeaderText="FILE_NAME" ItemStyle-Width="150" Visible="false" >
                                    <ItemTemplate>
    ...
    <div style="visibility:hidden">
     ...
     <div id="dialog" title="File Export" style="display:none;">

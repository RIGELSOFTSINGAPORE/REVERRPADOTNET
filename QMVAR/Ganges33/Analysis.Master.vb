Public Class Analysis
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            If setShipname IsNot Nothing Then
                ...
                LblShipName1.Text = setShipname
            End If

            If userid IsNot Nothing Then
                lblUser.Text = userid & " " & userName
                lblUser1.Text = userid & " " & userName
            End If

            If userLevel = "8" Or userLevel = "6" Then
                fileupload.Visible = False
                dashboard.Visible = False
                Analysis_Refresh.Visible = False
                Analysis_Recovery.Visible = False
                drp1.Visible = False
                drp2.Visible = False
                drp3.Visible = False
            ...
            ElseIf activepage.Contains("SetupNewServiceCenter.aspx") Then
                admin.Attributes.Add("class", "btn_active")
                drp3.Attributes.Add("class", "liactive collapsed nav-link collapsed text-truncate")
                'prabu added 2021-06-11
            ElseIf activepage.Contains("Holidays.aspx") Then
                admin.Attributes.Add("class", "btn_active")
                drp3.Attributes.Add("class", "liactive collapsed nav-link collapsed text-truncate")
            Else
                'dashboard.Attributes.Add("class", "active")
    ...
    Private Sub A1_ServerClick(sender As Object, e As EventArgs) Handles A1.ServerClick

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Login.aspx.vb" Inherits="Ganges33.Login2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="workSpace">
            ...
            <div class="right">
                    <h1>RPA Demo <asp:Label ID="lblServer" runat="server" Text=" " ></asp:Label> </h1>

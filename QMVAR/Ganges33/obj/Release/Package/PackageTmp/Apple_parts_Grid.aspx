<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AppleAnalysis.Master" CodeBehind="Apple_parts_Grid.aspx.vb" Inherits="Ganges33.Apple_parts_Grid" %>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body scrollbar" id="style-10">           
                    ...
                    <div class="col-sm-6">
                                    <asp:Button ID="btnnewparts" margin-left="120px" Width="120px" height="32px" margin-top="0px" runat="server" Text="Parts Entry" OnClick="btnnewparts_Click" class="btn btn-primary text" />
                                           <asp:Button ID="btnPartsStock"  runat="server" class="btn btn-primary text " OnClick="btnPartsStock_Click" Width="155px" height="32px" Text="Parts Management" />  
                        <asp:Button ID="btnTransView" Width="188px" class="btn btn-primary text" OnClick="btnTransView_Click"   margin-left="23px" height="30px" margin-top="0px" runat="server" Text="Stock Transaction View" /> 

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/RpaDemo.Master" CodeBehind="rpa_scheduler_demo.aspx.vb" Inherits="Ganges33.rpa_scheduler_demo" %>
                ...
                <Columns>            
                    ...
                    <asp:TemplateField HeaderText="Start DateTime">
                        ...
                        <EditItemTemplate>            
                            ...
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" Format="yyyy/MM/dd" runat="server" BehaviorID="txtEditSTART_DATETIME" TargetControlID="txtEditSTART_DATETIME" PopupPosition="TopRight">
                      </ajaxToolkit:CalendarExtender>
                <%--    </ajax:CalendarExtender>--%>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtAddSTART_DATETIME"    runat="server" ></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="yyyy/MM/dd" runat="server" BehaviorID="txtAddSTART_DATETIME" TargetControlID="txtAddSTART_DATETIME" PopupPosition="TopRight">
                      </ajaxToolkit:CalendarExtender>
                    <%--</ajax:CalendarExtender>--%>
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="End DateTime">
                        ...
                        <EditItemTemplate>            
                            ...
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender3" Format="yyyy/MM/dd" runat="server" BehaviorID="txtEditEND_DATETIME" TargetControlID="txtEditEND_DATETIME" PopupPosition="TopRight">
                      </ajaxToolkit:CalendarExtender>
                    </ajax:CalendarExtender>
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtAddEND_DATETIME"    runat="server" ></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender4" Format="yyyy/MM/dd" runat="server" BehaviorID="txtAddEND_DATETIME" TargetControlID="txtAddEND_DATETIME" PopupPosition="TopRight">
                      </ajaxToolkit:CalendarExtender>
                    </ajax:CalendarExtender>
                        </FooterTemplate>
                    </asp:TemplateField>

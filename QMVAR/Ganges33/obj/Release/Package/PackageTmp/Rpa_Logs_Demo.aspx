<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/RpaDemo.Master" CodeBehind="Rpa_Logs_Demo.aspx.vb" Inherits="Ganges33.Rpa_Logs_Demo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="yyyy/MM/dd" runat="server" BehaviorID="txtDateTo" TargetControlID="txtDateTo" PopupPosition="TopRight"/>--%>
                                       ...
                                       <asp:Button  ID="btnSearch" runat="server" Width="90px" height="36px" class="btn pull-right btn-primary text" Text="Search"/>
           </div>
                               <div class="">
                        <div class="form-group">

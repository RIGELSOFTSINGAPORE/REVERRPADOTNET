                  ...
                  <div class="row " style="margin-left: 20px;margin-top: 10px;">
                         <div class="col-sm-1">
                            <%--<asp:Label id="Label1" runat="server"  CssClass="bmd-label-floating serverlbl"  style=" margin-top:4px" Text="From"></asp:Label>--%>
                             <label class="bmd-label-floating " runat="server" id="servicecenter"  style="font-size:medium; margin-top:4px">
                                 From:
                             </label>
                         </div>
                 ...
                 <%-- <ajaxToolkit:CalendarExtender ID="CalendarExtender1" Format="yyyy/MM/dd" runat="server" BehaviorID="txtDateFrom" TargetControlID="txtDateFrom" PopupPosition="TopRight">
                       ...
                       <div  class="col-sm-1">
                          ...
                          <%-- <asp:Label id="lblTo" runat="server" class="serverlbl  "  style=" margin-top:4px" Text="To"></asp:Label>&nbsp;&nbsp;&nbsp;--%>
                            <label class="bmd-label-floating " runat="server" id="lbl"  style="font-size:medium;margin-top:4px">
                                 To:
                             </label>
                        </div>
                            <div class="col-sm-2">

                                 <asp:TextBox ID="txtDateTo" runat="server"   class="form-file-upload date serverlbl" style="width: 120px;"></asp:TextBox>
...
<asp:Button  ID="btnSearch" runat="server" Width="80px" height="33px" class="btn pull-right btn-primary text" Text="Search"/>
                         </div>

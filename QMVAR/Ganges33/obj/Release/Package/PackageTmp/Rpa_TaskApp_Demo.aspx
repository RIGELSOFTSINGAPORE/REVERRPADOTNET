<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/RpaDemo.Master" CodeBehind="Rpa_TaskApp_Demo.aspx.vb" Inherits="Ganges33.Rpa_TaskApp_Demo" %>
          ...
          <div class="row">
            ...
            <div class="row col-sm-12" style="vertical-align:top">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <div>
                <asp:Button ID="btnMailManagement" runat="server" Width="179px" height="36px" class="btn btn-primary btn-lbl text" Text="     Mail Management       "  />
            </div>
            </div>

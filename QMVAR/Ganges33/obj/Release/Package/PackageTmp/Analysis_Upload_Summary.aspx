			 ...
			 <div class="row">
              ...
              <br />
                   ...
                   <asp:CheckBox  ID="chkIndividual" runat="server" Text="Current User" Visible="false"/>
                     ...
                     <asp:Button ID="btnExport" runat="server" text="Export" Width="90px" height="36px"   class="btn btn-primary pull-right text" Visible="false"/>&nbsp
                     <asp:Button ID="btnSearch" runat="server" text="Search" Width="90px" height="36px"  class="btn btn-primary pull-right text" />

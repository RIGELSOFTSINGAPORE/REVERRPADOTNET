<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AppleAnalysis.Master" CodeBehind="Apple_Model.aspx.vb" Inherits="Ganges33.Apple_Model" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div class="wrapper  col-sm-12 sidebar-wrapper position-fixed scrolbar contain" id="style-10">
    ...
    <div class="content" >
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h3 class="card-title ">Apple Model</h3>
      ...
      <div>
              <asp:TextBox ID="txtModel" CssClass="form-file-upload serverlbl"  runat="server"></asp:TextBox>
...
<label>Type
      ...
      <div>
           <asp:TextBox ID="txtType" CssClass="form-file-upload serverlbl"  runat="server"></asp:TextBox>
          
                <div class="col-sm-12"><br />
                        <asp:Button ID="btnSearch"  Width="90px" height="36px" runat="server" Text="Search" class="btn btn-primary text" />
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnNew"  Width="140px" height="36px" runat="server" Text="Add New Model" class="btn btn-primary  text" />
                    </div>      
      </div>
      </div>
                ...
                <Columns>
                     ...
                     <asp:TemplateField HeaderText="Model">
                        <ItemTemplate>
                             ...
                             <asp:Label ID="lblPartNo" Text='<%# Eval("Model")  %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        ...
                        <ItemTemplate>
                             ...
                             <asp:Label ID="lblProductName" Text='<%# Eval("Type")  %>' runat="server"></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" />
                    ...
                    <asp:TemplateField HeaderText="Delete&nbsp;Flag">
                     ...
                     <asp:HyperLinkField  Text="Edit"  DataTextField="" DataNavigateUrlFields="UNQ_NO" DataNavigateUrlFormatString="~/Apple_Model_Create.aspx?UNQ_NO={0}"

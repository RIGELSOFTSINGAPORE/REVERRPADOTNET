            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body scrollbar" id="style-10">
                  ...
                  <div class="col-sm-12">
                     ...
                     <%-- <div class="col-md-12">--%>
                      ...
                      <asp:DropDownList ID="DropListLocation" runat="server" CssClass="form-control " style="width: 100%; height:33px;">
                          ...
                          <Label  runat="server"  CssClass="bmd-label-floating">Month</Label>
                                    ...
                                    <div class="col-sm-4">
                                 <br />
                     <asp:DropDownList ID="DropDownMonth" runat="server" CssClass="form-control " style="width: 100%; height:33px;">
                      </asp:DropDownList>
                   ...
                   <%--</div>--%>
                    ...
                    <div class="col-sm-8" style="padding-right:0px">
                        <br />
                             <asp:DropDownList ID="DropDownTargetData" runat="server" class="form-control " style="width: 100%; height:33px">
                      </asp:DropDownList>
                  ...
                  <div class="col-sm-2" >
                      <br />
                        <Label ID="Label7" runat="server" CssClass="bmd-label-floating">Date:</Label>
                      </div>
                                  <div class="col-sm-2"> 
                                       <br />
                                  ...
                                  <div class="col-sm-3"  style="padding-right:0px">
                                       <br />
                      <asp:TextBox ID="TextDateFrom" runat="server" class="form-file-upload serverlbl  date" AutoCompleteType="Disabled" style="width: 100%; height:33px;"></asp:TextBox>
                      ...
                      <asp:Label ID="Label8" runat="server" class="bmd-label-floating serverlbl" Text="To"></asp:Label>
                                  ...
                                  <div class="col-sm-3"  style="padding-right:0px">
                                       <br />
                      <asp:TextBox ID="TextDateTo" runat="server" class="form-file-upload serverlbl date" AutoCompleteType="Disabled" style="width: 100%; height:33px"></asp:TextBox>
                    ...
                    <div>
                       <asp:Button ID="btnSend" runat="server" Width="90px" height="36px" class="btn btn-primary pull-right text" text="Delete"/>
                      </div> 

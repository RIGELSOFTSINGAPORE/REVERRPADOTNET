<%@ Page Title="QMVAR - RPA-Logs" Language="vb" AutoEventWireup="true" MasterPageFile="~/Analysis.Master" CodeBehind="rpa_Logs_1.aspx.vb" Inherits="Ganges33.rpa_Logs_1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="wrapper  col-sm-12 sidebar-wrapper position-fixed scrolbar contain" id="style-10">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div  class="card-body scrollbar"  id="style-10" style="height:240px" >
     ...
     <div class="col-sm-12">
         ...
         <asp:TextBox ID="txtDateFrom1" runat="server" class="form-file-upload serverlbl" style="width: 120px;" > </asp:TextBox> &nbsp;&nbsp;&nbsp;
 <ajaxToolkit:CalendarExtender ID="CalendarExtender1" Format="yyyy/MM/dd" runat="server" BehaviorID="txtDateFrom1" TargetControlID="txtDateFrom1" PopupPosition="Right">
   </ajaxToolkit:CalendarExtender>
          
             <asp:Label id="lblTo" runat="server" class="serverlbl  " Text="To"></asp:Label>&nbsp;&nbsp;&nbsp;
         <asp:TextBox ID="txtDateTo1" runat="server"   class="form-file-upload serverlbl" style="width: 146px;"></asp:TextBox>
   ...
   <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="yyyy/MM/dd" runat="server" BehaviorID="txtDateTo" TargetControlID="txtDateTo" PopupPosition="Left"/>
       --%>   
                           <ajaxToolkit:CalendarExtender ID="CalendarExtender2" Format="yyyy/MM/dd" runat="server" BehaviorID="txtDateTo1" TargetControlID="txtDateTo1" PopupPosition="Right">
           </ajaxToolkit:CalendarExtender>
    ...
    <div class="">
                        <div class="form-group">
                               ...
                               <asp:GridView runat="server" ID="gvDetails1" AllowPaging="true" PageSize="10" AutoGenerateColumns="false"  OnPageIndexChanging="gvDetails_PageIndexChanging">

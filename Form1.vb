...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label4.Size = New System.Drawing.Size(256, 32)
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        objMutex = New System.Threading.Mutex(False, "best_ivc_close")
    ...
    Sub DsSet()
        ...
        If DtView1.Count <> 0 Then
            Label1.Text = DateAdd(DateInterval.Month, +1, DtView1(0)("CLS_CODE_NAME"))
        ...
        If DtView1.Count <> 0 Then
            Label2.Text = DateAdd(DateInterval.Month, +1, DtView1(0)("CLS_CODE_NAME"))
            Label4.Text = Format(CDate(Label2.Text), "yyyy年MM月度")
        End If

        '請求データ
        SqlCmd1 = New SqlClient.SqlCommand("sp_best_ivc_close_01", cnsqlclient)
        ...
        SqlCmd1 = New SqlClient.SqlCommand("sp_best_ivc_close_02", cnsqlclient)
        SqlCmd1.CommandType = CommandType.StoredProcedure
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        str_ANS = MsgBox("受信データの締め処理を行います。よろしいですか？", MsgBoxStyle.OkCancel, "確認")
        If str_ANS = "1" Then   'OK
            ''input log
            'WKDsList.Clear()
            'strSQL = "SELECT close_date"
            'strSQL = strSQL & " FROM inp_log"
            'strSQL = strSQL & " WHERE (close_date = CONVERT(DATETIME, '" & Label1.Text & "', 102))"
            'SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            'DaList1.SelectCommand = SqlCmd1
            'DB_OPEN("best_wrn")
            'SqlCmd1.CommandTimeout = 3600
            'DaList1.Fill(WKDsList, "inp_log")
            'DB_CLOSE()
            'DtView1 = New DataView(WKDsList.Tables("inp_log"), "", "", DataViewRowState.CurrentRows)
            'If DtView1.Count < 3 Then
            '    str_ANS = MsgBox("受信を3回行っていません。" & Chr(13) & "処理を続けますか？", MsgBoxStyle.OKCancel, "確認")
            '    If str_ANS <> "1" Then
            '        Me.Cursor = System.Windows.Forms.Cursors.Default
            '        Exit Sub
            '    End If
            ...
            strSQL = strSQL & " SET close_flg = '1'"
            strSQL = strSQL & " WHERE (close_flg = '0') AND (inp_seq IS NULL)"
            ...
            strSQL = strSQL & " SET Fixed_flg_sime = Fixed_flg"
            strSQL = strSQL & " WHERE (close_date = CONVERT(DATETIME, '" & Label1.Text & "', 102))"
            DB_OPEN("best_wrn")
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            SqlCmd1.CommandTimeout = 3600
            ...
            strSQL = strSQL & " SET CLS_CODE_NAME = '" & Label1.Text & "'"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        str_ANS = MsgBox("手入力データの締め処理を行います。よろしいですか？", MsgBoxStyle.OKCancel, "確認")
        If str_ANS = "1" Then   'OK
            strSQL = "UPDATE Wrn_ivc"
            strSQL = strSQL & " SET close_flg = '1'"
            strSQL = strSQL & " WHERE (close_flg = '0') AND (inp_seq IS NOT NULL)"

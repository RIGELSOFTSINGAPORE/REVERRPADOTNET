...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(KANA_input))
...
#End Region
    ...
    Private Sub TextBox1_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBox1.LostFocus
        TextBox1.Text = Trim(StrConv(TextBox1.Text, VbStrConv.Narrow))
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Trim(TextBox1.Text) = Nothing Then
            ...
            TextBox1.Focus()
        Else
            If Len(TextBox1.Text) <> LenB(TextBox1.Text) Then
                MsgBox("フリガナに全角が含まれています。", MsgBoxStyle.Critical, "Error")
                TextBox1.Focus()
            Else
                If Trim(TextBox1.Text) <> pKANA Then
                    strSQL = "UPDATE WRN_DATA"
                    strSQL += " SET CUST_NAME_KANA = '" & TextBox1.Text & "'"

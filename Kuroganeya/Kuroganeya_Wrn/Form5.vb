    ...
    Private Sub Form5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For i = 0 To Dttbl1.Rows.Count - 1
            ...
            If Dttbl1.Rows(i)("CLS_CODE") = "008" Then
                ...
                strSQL += " FROM STTS_F_UPD LEFT OUTER JOIN"
                strSQL += " EMPL ON STTS_F_UPD.EMPL_CODE = EMPL.EMPL_CODE LEFT OUTER JOIN"
                strSQL += " (SELECT CLS_CODE, CLS_CODE_NAME"
                strSQL += " FROM CLS_CODE"
                strSQL += " WHERE (CLS_NO = '010')) xa ON"
                strSQL += " STTS_F_UPD.RSN_CODE = xa.CLS_CODE COLLATE Japanese_CI_AS"
                strSQL += " WHERE (STTS_F_UPD.WRN_NO = '" & pWrn_no & "')"

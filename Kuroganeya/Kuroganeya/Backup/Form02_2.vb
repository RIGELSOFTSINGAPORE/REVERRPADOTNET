...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Form02_2))
        ...
        Me.Edit001.Size = New System.Drawing.Size(56, 24)
...
#End Region
    ...
    Sub CHK_Edit001()   '店舗ｺｰﾄﾞ
        ...
        Else
            WK_DsList1.Clear()
            strSQL = "SELECT * FROM SHOP"
            strSQL +=  " WHERE (SHOP_CODE = '" & Edit001.Text & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            If P_PRAM1 = Nothing Then   '新規
                ...
                strSQL += " (SHOP_CODE, SHOP_CODE_int, SHOP_NAME, SHOP_ADRS, TEL_NO, FAX_NO, reg_date, delt_flg)"
                strSQL +=  " VALUES ('" & Edit001.Text & "'"
                strSQL += ", " & CInt(Edit001.Text)
                strSQL += ", '" & Edit002.Text & "'"
                strSQL +=  ", '" & Edit003.Text & "'"
                strSQL +=  ", '" & Edit004.Text & "'"
                strSQL +=  ", '" & Edit005.Text & "'"
            ...
            Else                        '修正
                ...
                strSQL = "UPDATE SHOP"
                strSQL +=  " SET SHOP_NAME = '" & Edit002.Text & "'"
                strSQL +=  ", SHOP_ADRS = '" & Edit003.Text & "'"
                strSQL +=  ", TEL_NO = '" & Edit004.Text & "'"
                strSQL +=  ", FAX_NO = '" & Edit005.Text & "'"

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Form05))
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridBoolColumn2})
        Me.DataGridTableStyle1.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridTableStyle1.MappingName = "M_maker"
        ...
        Me.DataGridEx1.Location = New System.Drawing.Point(17, 9)
        ...
        Me.DataGridTextBoxColumn1.MappingName = "MKR_CODE"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "ﾒｰｶｰ名"
        Me.DataGridTextBoxColumn2.MappingName = "MKR_NAME"
        ...
        Me.Button98.Location = New System.Drawing.Point(421, 481)
        ...
        Me.Button1.Location = New System.Drawing.Point(17, 481)
...
#End Region
    ...
    '**  起動時
    '********************************************************************
    Private Sub Form05_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inz()       '**  初期処理
        DspSet()    '**  画面セット
    End Sub
    ...
    Private Sub DataGridEx1_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGridEx1.MouseUp
        ...
        Try
            ...
            If hitinfo.Row >= 0 Then
                ...
                Dim Form05_2 As New Form05_2
                Form05_2.ShowDialog()

                If P_RTN = "1" Then '**  画面セット
                    WK_DsList1.Clear()
                    strSQL = "SELECT * FROM M_maker WHERE (MKR_CODE = '" & P_PRAM1 & "')"
                    SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                    DaList1.SelectCommand = SqlCmd1
                    DB_OPEN()
                    DaList1.Fill(WK_DsList1, "M_maker")
                    DB_CLOSE()
                    DtView1 = New DataView(WK_DsList1.Tables("M_maker"), "", "", DataViewRowState.CurrentRows)

                    DtView2 = New DataView(DsList1.Tables("M_maker"), "MKR_CODE = '" & P_PRAM1 & "'", "", DataViewRowState.CurrentRows)
                    DtView2(0)("MKR_NAME") = DtView1(0)("MKR_NAME")

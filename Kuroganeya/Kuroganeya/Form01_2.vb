...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(Form01_2))
...
#End Region
    ...
    Sub CHK_Edit001()   'ﾕｰｻﾞｰID
        ...
        Else
            WK_DsList1.Clear()
            strSQL = "SELECT * FROM EMPL"
            strSQL +=  " WHERE (EMPL_CODE = '" & Edit001.Text & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            If P_PRAM1 = Nothing Then   '新規
                ...
                strSQL +=  " (EMPL_CODE, EMPL_NAME, PSWD, EMPL_CLS, reg_date, delt_flg)"
            ...
            Else                        '修正
                ...
                strSQL = "UPDATE EMPL"
                strSQL +=  " SET EMPL_NAME = '" & Edit002.Text & "'"
                strSQL +=  ", PSWD = '" & Edit003.Text & "'"
                If CheckBox002.Checked = True Then strSQL +=  ", EMPL_CLS = 1" Else strSQL +=  ", EMPL_CLS = 0"

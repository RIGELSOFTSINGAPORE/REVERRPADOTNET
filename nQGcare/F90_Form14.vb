...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.msg.Location = New System.Drawing.Point(20, 80)
        Me.msg.Name = "msg"
        Me.msg.Size = New System.Drawing.Size(316, 20)
        Me.msg.TabIndex = 1488
        Me.msg.Text = "msg"
        ...
        Me.Button3.Location = New System.Drawing.Point(84, 112)
        ...
        Me.Button99.Location = New System.Drawing.Point(236, 112)
...
#End Region
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If Err_F = "0" Then
            ...
            sfd.FileName = "加入データ" & Format(Now, "yyyyMMddHHmmss") & ".CSV" 'はじめのファイル名を指定する
            ...
            If sfd.ShowDialog() = DialogResult.OK Then     'ダイアログを表示する
                ...
                strData = strData & ",メーカー,モデル名,S/N,購入金額,保証期間,メーカー保証開始"
                strData = strData & ",保証範囲,販売店,保険料,加入日,登録日付,Coop"
                '↓↓↓↓↓↓ 2021/10/15 修正
                strData = strData & ",PCサポートパック加入有無"
                '↑↑↑↑↑↑ 2021/10/15 修正
                ...
                For i = 0 To DtView1.Count - 1
                    ...
                    strData = strData & "," & DtView1(i)("wrn_range_name")  '保証範囲
                    ...
                    '↓↓↓↓↓↓ 2021/10/15 修正
                    If Not IsDBNull(DtView1(i)("pc_pack")) Then
                        If DtView1(i)("pc_pack") = "True" Then strData = strData & ",1" Else strData = strData & ",0" 'pc_pack
                    Else
                        strData = strData & ",0"                        'pc_pack
                    End If
                    '↑↑↑↑↑↑ 2021/10/15 修正

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'CheckBox05
        '
        Me.CheckBox05.Location = New System.Drawing.Point(692, 240)
        ...
        'CheckBox06
        '
        Me.CheckBox06.Location = New System.Drawing.Point(692, 192)
        ...
        If P_RTN = "1" Then
            ...
            If DtView1.Count <> 0 Then
                ...
                If Not IsDBNull(DtView1(0)("pc_pack")) Then
                    If DtView1(0)("pc_pack") = "True" Then
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If Err_F = "0" Then
            ...
            Else                            '更新
                ...
                If CheckBox06.Checked = True Then strSQL += ", pc_pack = 1" Else strSQL += ", pc_pack = 0" 'PCパック

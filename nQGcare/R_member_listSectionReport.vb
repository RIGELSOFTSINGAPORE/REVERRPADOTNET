...
Public Class R_member_listSectionReport
    ...
    Private Sub R_member_listSectionReport_ReportStart(sender As Object, e As EventArgs) Handles MyBase.ReportStart
    ...
    Private Sub GroupFooter2_Format(sender As Object, e As EventArgs) Handles GroupFooter2.Format
        ...
        WK_int3 = RoundDOWN(WK_int2 / WK_int1, 0)
        GF2.Text = TextBox18.Text & "( " & Format(WK_int1, "##,##0") & "件、　保証料単価:" & Format(WK_int3, "##,##0") & "円、　保証金額:" & Format(WK_int2, "##,##0") & "円)"

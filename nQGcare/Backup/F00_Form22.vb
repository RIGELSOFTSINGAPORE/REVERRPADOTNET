...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn5})
        ...
        Me.DataGridTextBoxColumn4.HeaderText = "件数"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "取込み№"
        Me.DataGridTextBoxColumn3.MappingName = "imp_seq"
        ...
        Me.msg.Name = "msg"
        Me.msg.Size = New System.Drawing.Size(880, 28)
        Me.msg.TabIndex = 1461
        Me.msg.Text = "msg"
...
#End Region
    ...
    '** 起動時
    '******************************************************************
    Private Sub F00_Form22_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call inz()      '** 初期処理
    ...
    Sub sql()
        ...
        DsList1.Clear()
        strSQL = "SELECT T01_member.shop_code, M04_shop.shop_name, T01_member.Part_date, T01_member.imp_seq, COUNT(*) AS cnt, 0 AS ID"
        strSQL += " FROM T01_member INNER JOIN"
        strSQL += " M04_shop ON T01_member.shop_code = M04_shop.shop_code"
        strSQL += " WHERE (T01_member.delt_flg = 0) AND (T01_member.imp_seq <> 0)"
    ...
    Private Sub DataGrid1_MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGrid1.MouseUp
        ...
        Try
            ...
            If hitinfo.Row >= 0 Then
                ...
                P_PRAM3 = DataGrid1(DataGrid1.CurrentRowIndex, 3)

                Dim F00_Form22_01 As New F00_Form22_01
                F00_Form22_01.ShowDialog()

                Select Case P_RTN
                    Case Is = "1"   '更新
                        DataGrid1(DataGrid1.CurrentRowIndex, 0) = P_PRAM1
                    Case Is = "4"   '削除

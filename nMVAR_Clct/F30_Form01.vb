...
#End Region
    ...
    Sub sql()
        ...
        strSQL = "SELECT T20_INVC_MTR.iｎvc_no, T20_INVC_MTR.invc_date, T20_INVC_MTR.invc_code, M08_STORE.name AS invc_name"
        ...
        End If
        strSQL = strSQL & " GROUP BY T20_INVC_MTR.iｎvc_no, T20_INVC_MTR.invc_date, T20_INVC_MTR.invc_code, M08_STORE.name"

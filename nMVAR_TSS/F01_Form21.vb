...
#End Region
    ...
    Sub sql()
        ...
        If CheckBox1.Checked = True Then '見積
            strSQL = "SELECT CASE WHEN tss_etmt_stts = '1' THEN N'見積新規' ELSE N'見積更新' END AS cls_name, T01_REP_MTR.*"
        ...
        If CheckBox2.Checked = True Then '完了
            strSQL = "SELECT CASE WHEN tss_comp_stts = '1' THEN N'完了新規' ELSE N'完了更新' END AS cls_name, T01_REP_MTR.*"
            strSQL = strSQL & " FROM T01_REP_MTR"
            ...
            strSQL = "SELECT CASE WHEN tss_aka_stts = '1' THEN N'赤伝新規' ELSE N'赤伝更新' END AS cls_name, T01_REP_MTR.*"
            strSQL = strSQL & " FROM T01_REP_MTR"

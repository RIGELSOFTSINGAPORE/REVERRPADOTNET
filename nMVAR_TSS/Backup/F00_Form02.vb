...
#End Region
    ...
    Sub CmbSet()
        ...
        If P_PRAM2 = "一般" Then
            strSQL = strSQL & " WHERE (M08_STORE.idvd_flg = 1)"
        Else
            strSQL = strSQL & " WHERE (M08_STORE.idvd_flg = 0)"
        End If
        ...
        If P_PRAM2 = "一般" Then
            strSQL = strSQL & " AND (idvd_flg = 1)"
        Else
            strSQL = strSQL & " AND (idvd_flg = 0)"
        End If
            ...
            If DtView1.Count <> 0 Then
                ...
                If DtView2.Count <> 0 Then
                    ...
                    Else
                        strSQL = strSQL & " AND (idvd_flg = 0)"
                    End If
                    strSQL = strSQL & " AND (grup_code = '" & DtView2(0)("grup_code") & "')"
                    strSQL = strSQL & " ORDER BY grup_code, name_kana"
                    SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                    DaList1.SelectCommand = SqlCmd1
                    DB_OPEN("nMVAR")
            ...
            If Combo001.Text <> Nothing Then
                ...
                If DtView1.Count <> 0 Then
                    ...
                    Else
                        strSQL = strSQL & " AND (idvd_flg = 0)"
                    End If
                    strSQL = strSQL & " AND (grup_code = '" & DtView1(0)("grup_code") & "')"
                    strSQL = strSQL & " ORDER BY grup_code, name_kana"
                Else
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            ...
            strSQL = strSQL & " M08_STORE M08_STORE_1 ON M08_STORE.dlvr_code = M08_STORE_1.store_code"
            strSQL = strSQL & " WHERE (M08_STORE.store_code + ':' + M08_STORE.name = '" & Trim(Combo002.Text) & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN("nMVAR")

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Button12.Location = New System.Drawing.Point(10, 127)
        Me.Button12.Name = "Button12"
        Me.Button12.Size = New System.Drawing.Size(201, 50)
        ...
        Me.Button11.Location = New System.Drawing.Point(10, 61)
        Me.Button11.Name = "Button11"
        Me.Button11.Size = New System.Drawing.Size(201, 50)
        Me.Button11.TabIndex = 0
        Me.Button11.Text = "修理情報取込み"
        ...
        Me.Button21.Location = New System.Drawing.Point(221, 61)
        Me.Button21.Name = "Button21"
        Me.Button21.Size = New System.Drawing.Size(201, 50)
        Me.Button21.TabIndex = 4
        Me.Button21.Text = "見積/完了出力"
        ...
        Me.Button98.Location = New System.Drawing.Point(432, 253)
        Me.Button98.Name = "Button98"
        Me.Button98.Size = New System.Drawing.Size(201, 51)
        ...
        Me.Button22.Location = New System.Drawing.Point(432, 61)
        Me.Button22.Name = "Button22"
        Me.Button22.Size = New System.Drawing.Size(201, 50)
        Me.Button22.TabIndex = 5
        Me.Button22.Text = "見積回答取り込み"
        ...
        Me.Button23.Location = New System.Drawing.Point(432, 127)
        Me.Button23.Name = "Button23"
        Me.Button23.Size = New System.Drawing.Size(201, 50)
        Me.Button23.TabIndex = 6
        Me.Button23.Text = "見積回答反映"
        ...
        Me.Button14.Location = New System.Drawing.Point(10, 253)
        Me.Button14.Name = "Button14"
        Me.Button14.Size = New System.Drawing.Size(201, 51)
        Me.Button14.TabIndex = 3
        Me.Button14.Text = "取込みデータ削除"
        ...
        Me.ClientSize = New System.Drawing.Size(714, 247)
...
#End Region
    ...
    Sub inz()
        ...
        If P_EMPL = "Lenovo" Then P_EMPL = "administrator" '大槻テスト用
    ...
    Sub ACES()
        ...
        DtView1 = New DataView(DsList1.Tables("ACES_CHK"), "exe_code ='T11'", "", DataViewRowState.CurrentRows)
        If DtView1.Count <> 0 Then
        ...
        DtView1 = New DataView(DsList1.Tables("ACES_CHK"), "exe_code ='T12'", "", DataViewRowState.CurrentRows)
        If DtView1.Count <> 0 Then
            Select Case DtView1(0)("access_cls")
                Case Is = "2", "3", "4"
        ...
        DtView1 = New DataView(DsList1.Tables("ACES_CHK"), "exe_code ='T14'", "", DataViewRowState.CurrentRows)
        If DtView1.Count <> 0 Then
            Select Case DtView1(0)("access_cls")
                Case Is = "2", "3", "4"
        ...
        DtView1 = New DataView(DsList1.Tables("ACES_CHK"), "exe_code ='T21'", "", DataViewRowState.CurrentRows)
        If DtView1.Count <> 0 Then
            Select Case DtView1(0)("access_cls")
                Case Is = "2", "3", "4"
        ...
        DtView1 = New DataView(DsList1.Tables("ACES_CHK"), "exe_code ='T22'", "", DataViewRowState.CurrentRows)
        If DtView1.Count <> 0 Then
            Select Case DtView1(0)("access_cls")
                Case Is = "2", "3", "4"
        ...
        DtView1 = New DataView(DsList1.Tables("ACES_CHK"), "exe_code ='T23'", "", DataViewRowState.CurrentRows)
        If DtView1.Count <> 0 Then
            Select Case DtView1(0)("access_cls")
                Case Is = "2", "3", "4"
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        ...
        Dim F01_Form11 As New F01_Form11
        F01_Form11.ShowDialog()
    ...
    Private Sub Button14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button14.Click
        Cursor = System.Windows.Forms.Cursors.WaitCursor
        P_F01_PRAM1 = Nothing
        Dim F02_Form81 As New F02_Form81
        F02_Form81.ShowDialog()
        Cursor = System.Windows.Forms.Cursors.Default
    End Sub
    ...
    Private Sub Button21_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button21.Click
        Cursor = System.Windows.Forms.Cursors.WaitCursor
        Dim F01_Form21 As New F01_Form21
        F01_Form21.ShowDialog()
        Cursor = System.Windows.Forms.Cursors.Default
    End Sub
    ...
    Private Sub Button22_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.Click
        Cursor = System.Windows.Forms.Cursors.WaitCursor
        Dim F01_Form22 As New F01_Form22
        F01_Form22.ShowDialog()
        Cursor = System.Windows.Forms.Cursors.Default
    End Sub
    ...
    Private Sub Button23_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button23.Click
        Cursor = System.Windows.Forms.Cursors.WaitCursor
        Dim F01_Form23 As New F01_Form23
        F01_Form23.ShowDialog()
        Cursor = System.Windows.Forms.Cursors.Default
    End Sub
    ...
    '**  GotFocus 
    '********************************************************************
    Private Sub Button11_GotFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.GotFocus
        Button11.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
    End Sub
    ...
    End Sub
    Private Sub Button21_GotFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button21.GotFocus
        Button21.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
    End Sub
    Private Sub Button22_GotFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.GotFocus
        Button22.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
    End Sub
    Private Sub Button23_GotFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button23.GotFocus
        Button23.BackColor = System.Drawing.Color.FromArgb(CType(192, Byte), CType(255, Byte), CType(192, Byte))
    End Sub
    ...
    '**  LostFocus
    '********************************************************************
    Private Sub Button11_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.LostFocus
    ...
    End Sub
    Private Sub Button21_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button21.LostFocus
        Button21.BackColor = System.Drawing.SystemColors.Control
    End Sub
    Private Sub Button22_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button22.LostFocus
        Button22.BackColor = System.Drawing.SystemColors.Control
    End Sub
    Private Sub Button23_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button23.LostFocus

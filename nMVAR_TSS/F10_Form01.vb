...
Public Class F10_Form01
    ...
    Dim strSQL, Err_F, Err_CX As String
    Dim i, r, en, Line_No, Line_No2, chg_itm, seq As Integer
    Dim cmb_reset, WK_str As String
    ...
    '故障内容
    Private cmbBo_2(99, 2) As GrapeCity.Win.Input.Interop.Combo
...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F10_Form01))
        ...
        Me.Date003.DisplayFormat = New GrapeCity.Win.Input.Interop.DateDisplayFormat("yyyy/MM/dd", "", "")
        Me.Date003.DropDownCalendar.Size = New System.Drawing.Size(158, 165)
        Me.Date003.Format = New GrapeCity.Win.Input.Interop.DateFormat("yyyy/MM/dd", "", "")
        ...
        Me.CL001.Location = New System.Drawing.Point(936, 96)
        Me.CL001.Name = "CL001"
        ...
        Me.CL002.Location = New System.Drawing.Point(936, 116)
        Me.CL002.Name = "CL002"
        ...
        Me.CL003.Location = New System.Drawing.Point(936, 136)
        Me.CL003.Name = "CL003"
        ...
        Me.CL004.Location = New System.Drawing.Point(936, 156)
        Me.CL004.Name = "CL004"
        ...
        Me.CLU002.Location = New System.Drawing.Point(936, 236)
        ...
        Me.CLU001.Location = New System.Drawing.Point(936, 216)
        ...
        Me.CL002_2.Location = New System.Drawing.Point(884, 116)
        ...
        Me.brk03.Location = New System.Drawing.Point(652, 84)
        Me.brk03.Name = "brk03"
        ...
        Me.Number001.Location = New System.Drawing.Point(828, 32)
        ...
        Me.CL005.Location = New System.Drawing.Point(936, 176)
        Me.CL005.Name = "CL005"
        ...
        Me.prch_amnt.Location = New System.Drawing.Point(780, 84)
        ...
        Me.CL006.Location = New System.Drawing.Point(936, 196)
        Me.CL006.Name = "CL006"
        ...
        Me.CK_own_flg.Location = New System.Drawing.Point(840, 240)
        Me.CK_own_flg.Name = "CK_own_flg"
        Me.CK_own_flg.Size = New System.Drawing.Size(84, 16)
        Me.CK_own_flg.TabIndex = 1859
...
#End Region
    ...
    Sub CmbSet()
        ...
        strSQL = strSQL & " FROM (SELECT empl_code, name, name_kana FROM M01_EMPL WHERE (delt_flg = 0) AND (brch_code = '" & P_EMPL_BRCH & "')"
        strSQL = strSQL & " UNION"
        strSQL = strSQL & " SELECT empl_code, name, name_kana FROM M01_EMPL WHERE (empl_code = " & P_EMPL_NO & ")) M01_EMPL"
    ...
    Sub DspSet()
        ...
        If WK_DtView11.Count <> 0 Then
            ...
            Combo001.Text = Nothing : CL001.Text = Nothing '受付種別
            Edit011.Text = Nothing : brk01.Text = Nothing 'QG Care No
            Combo002.Text = Nothing : CL002.Text = Nothing '入荷区分
            Combo003.Text = Nothing : CL003.Text = Nothing '入荷担当
            ...
            WK_str = Trim(WK_DtView11(0)("user_l_name_kana")) & " " & Trim(WK_DtView11(0)("user_f_name_kana"))
            ...
            Combo005.Text = Nothing : CL005.Text = Nothing '事故状況
            Combo006.Text = Nothing : CL006.Text = Nothing '不良種別
            Edit012.Text = Nothing                          'ｵﾘｼﾞﾅﾙﾒｰｶｰｺｰﾄﾞ
            Number002.Value = 0                             '預かり金
            ...
            Edit_U001.Text = Nothing                            'モデル
            Edit_U002.Text = Trim(WK_DtView11(0)("model_name")) '機種
            Edit_U003.Text = Nothing : brk02.Text = Edit_U003.Text 'S/N
            Combo_U002.Text = Nothing : CLU002.Text = Nothing '修理拠点
...
tab:
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            ...
            strSQL = strSQL & " (rcpt_no, rcpt_ent_empl_code, rcpt_brch_code, rcpt_cls, qg_care_no, wrn_limt_amnt, menseki_amnt"
            strSQL = strSQL & ", acdt_stts, acdt_date, recv_amnt, arvl_cls, arvl_empl, store_code, store_prsn, store_repr_no, store_accp_date"
            strSQL = strSQL & ", store_wrn_info, tech_rate1, tech_rate2, part_rate2, user_name, user_name_kana, zip, adrs1, adrs2"
            strSQL = strSQL & ", tel1, tel2, rpar_cls, defe_cls, prch_date, vndr_wrn_date, vndr_wrn_date_chk, vndr_code, model_1, model_2, note_kbn, note_kbn2"
            strSQL = strSQL & ", s_n, rpar_comp_code, user_trbl, rcpt_comn, orgnl_vndr_code, accp_date, part_ordr_date, part_rcpt_date, tax_rate, aka_flg, rpt_ex_flg)"
            strSQL = strSQL & " VALUES ('" & Edit000.Text & "'"
            strSQL = strSQL & ", " & P_EMPL_NO
            strSQL = strSQL & ", '" & P_EMPL_BRCH & "'"
            strSQL = strSQL & ", '" & CL001.Text & "'"
            If Edit011.Visible = True Then  'QG Care
                strSQL = strSQL & ", '" & Edit011.Text & "'"
                strSQL = strSQL & ", " & Number001.Value
                strSQL = strSQL & ", " & Number003.Value
            Else
                strSQL = strSQL & ", ''"
                strSQL = strSQL & ", 0"
                strSQL = strSQL & ", 0"
            End If
            strSQL = strSQL & ", '" & CL005.Text & "'"
            If Date_U003.Number <> 0 Then strSQL = strSQL & ", '" & Date_U003.Text & "'" Else strSQL = strSQL & ", NULL"
            strSQL = strSQL & ", " & Number002.Value
            strSQL = strSQL & ", '" & CL002.Text & "'"
            strSQL = strSQL & ", " & CL003.Text
            strSQL = strSQL & ", '" & Edit001.Text & "'"
            ...
            If Date001.Number <> 0 Then strSQL = strSQL & ", '" & Date001.Text & "'" Else strSQL = strSQL & ", NULL"
            strSQL = strSQL & ", '" & Edit013.Text & "'"
            strSQL = strSQL & ", " & NumberN003.Value
            strSQL = strSQL & ", " & NumberN007.Value
            strSQL = strSQL & ", " & NumberN008.Value
            strSQL = strSQL & ", '" & Edit005.Text & "'"
            strSQL = strSQL & ", '" & Edit006.Text & "'"
            strSQL = strSQL & ", '" & Mask1.Value & "'"
            strSQL = strSQL & ", '" & Edit009.Text & "'"
            strSQL = strSQL & ", '" & Edit010.Text & "'"
            strSQL = strSQL & ", '" & Edit007.Text & "'"
            strSQL = strSQL & ", '" & Edit008.Text & "'"
            strSQL = strSQL & ", '" & CL004.Text & "'"
            strSQL = strSQL & ", '" & CL006.Text & "'"
            If Date_U001.Number <> 0 Then strSQL = strSQL & ", '" & Date_U001.Text & "'" Else strSQL = strSQL & ", NULL"
            If Date_U002.Number <> 0 Then strSQL = strSQL & ", '" & Date_U002.Text & "'" Else strSQL = strSQL & ", NULL"
            If CheckBox_U002.Checked = True Then strSQL = strSQL & ", 1" Else strSQL = strSQL & ", 0"
            strSQL = strSQL & ", '" & CLU001.Text & "'"
            strSQL = strSQL & ", '" & Edit_U002.Text & "'"
            strSQL = strSQL & ", '" & Edit_U001.Text & "'"
            If CheckBox_U001.Checked = True Then strSQL = strSQL & ", '01'" Else strSQL = strSQL & ", '02'"
            If CheckBox_U003.Checked = True Then strSQL = strSQL & ", '01'" Else strSQL = strSQL & ", '02'"
            strSQL = strSQL & ", '" & Edit_U003.Text & "'"
            strSQL = strSQL & ", '" & CLU002.Text & "'"
            strSQL = strSQL & ", '" & Edit_U004.Text & "'"
            strSQL = strSQL & ", '" & Edit_U005.Text & "'"
            strSQL = strSQL & ", '" & Edit012.Text & "'"
            If Date003.Number <> 0 Then strSQL = strSQL & ", '" & Date003.Text & "'" Else strSQL = strSQL & ", NULL"
            If Date007.Number <> 0 Then strSQL = strSQL & ", '" & Date007.Text & "'" Else strSQL = strSQL & ", NULL"
            If Date008.Number <> 0 Then strSQL = strSQL & ", '" & Date008.Text & "'" Else strSQL = strSQL & ", NULL"
            strSQL = strSQL & ", " & Wk_TAX & ""
            strSQL = strSQL & ", 0, 0)"
            ...
            For i = 0 To Line_No2
                If cmbBo_2(i, 1).Text <> Nothing Then
                    ...
                    strSQL = strSQL & ", " & seq
                    strSQL = strSQL & ", '01'"
                    strSQL = strSQL & ", '" & label_2(i, 1).Text & "')"
                    SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                    SqlCmd1.CommandTimeout = 600
                    SqlCmd1.ExecuteNonQuery()
                End If

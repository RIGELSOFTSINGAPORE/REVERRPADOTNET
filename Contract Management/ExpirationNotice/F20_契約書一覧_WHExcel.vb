...
Public Class F20_契約書一覧_WHExcel
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            ...
            If sfd.ShowDialog() = DialogResult.OK Then     'ダイアログを表示する
                ...
                Cursor = System.Windows.Forms.Cursors.WaitCursor
                'ds.Clear()
                'If (ds.Tables("T20_契約書管理").Rows.Count < 0) Then
                If ds.Tables("T20_契約書管理") IsNot Nothing AndAlso ds.Tables("T20_契約書管理").Rows.Count > 0 Then
                    ...
                    For i = 0 To DtView1.Count - 1
                        ...
                        If Not IsDBNull(DtView1(i)("契約終了予定日")) Then
                            ...
                            _dr("契約期間終了予定日") = Convert.ToString(DtView1(i)("契約終了予定日")).ToString()
                        Else
                        ...
                        If Not IsDBNull(DtView1(i)("終了日")) Then
                            ...
                            _dr("終了日") = Convert.ToString(DtView1(i)("終了日")).ToString()
                        Else
                        ...
                        If Not IsDBNull(DtView1(i)("調査日")) Then
                            '   _dr("調査日") = Convert.ToDateTime(DtView1(i)("調査日")).ToString("yyyy/MM/dd")
                            _dr("調査日") = Convert.ToString(DtView1(i)("調査日")).ToString()
                        Else
                            _dr("調査日") = DBNull.Value
                        End If
                        ...
                        If Not IsDBNull(DtView1(i)("削除_1")) Then
                            _dr("削除") = Convert.ToBoolean(DtView1(i)("削除_1"))
                        Else
                            _dr("削除") = DBNull.Value
                        End If
                        If Not IsDBNull(DtView1(i)("インド")) Then
                            _dr("インド") = Convert.ToBoolean(DtView1(i)("インド"))
                        Else
                            _dr("インド") = DBNull.Value
                        End If
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If sfd.ShowDialog() = DialogResult.OK Then
            ...
            Try
                ...
                sql += "t20_contract_management.Old_number, DATE_FORMAT(t20_contract_management.Contract_date, '%Y/%m/%d') as Contract_date,  DATE_FORMAT(t20_contract_management.Contract_period_starts, '%Y/%m/%d') as Contract_period_starts,  DATE_FORMAT(t20_contract_management.Scheduled_end_date_of_contract_period, '%Y/%m/%d') as Scheduled_end_date_of_contract_period,  DATE_FORMAT(t20_contract_management.End_date, '%Y/%m/%d') as End_date, "
                sql += "t20_contract_management.Update_code,  DATE_FORMAT(t20_contract_management.Survey_Date, '%Y/%m/%d') as Survey_Date, t20_contract_management.Automatic_update_interval, t20_contract_management.Account_number_all,t20_contract_management.Account_name_all, "
                    ...
                    For i = 0 To DtView1.Count - 1
                        ...
                        If Not IsDBNull(DtView1(i)("Contract_period_starts")) Then
                            If DtView1(i)("Contract_period_starts") <> "" Then
                                ...
                                _dr("契約期間開始") = Convert.ToString(DtView1(i)("Contract_period_starts")).ToString()
                            Else
                                _dr("契約期間開始") = DBNull.Value
                            End If
                        ...
                        If Not IsDBNull(DtView1(i)("Scheduled_end_date_of_contract_period")) Then
                            If DtView1(i)("Scheduled_end_date_of_contract_period") <> "" Then
                                ...
                                _dr("契約期間終了予定日") = Convert.ToString(DtView1(i)("Scheduled_end_date_of_contract_period")).ToString()
                        ...
                        If Not IsDBNull(DtView1(i)("End_date")) Then
                            If DtView1(i)("End_date") <> "" Then
                                ...
                                _dr("終了日") = Convert.ToString(DtView1(i)("End_date")).ToString()
                            Else
                                _dr("終了日") = DBNull.Value
                            End If
                        Else
                        ...
                        If Not IsDBNull(DtView1(i)("Survey_Date")) Then
                            '_dr("調査日") = Convert.ToDateTime(DtView1(i)("Survey_Date")).ToString("yyyy/MM/dd")


                            _dr("調査日") = Convert.ToString(DtView1(i)("Survey_Date")).ToString()
                        ...
                        '_dr("削除") = Convert.ToBoolean(DtView1(i)("Delete"))
                        '_dr("インド") = Convert.ToBoolean(DtView1(i)("India"))
                        ...
                        Else
                            _dr("削除") = DBNull.Value
                        End If
                        If Not IsDBNull(DtView1(i)("India")) Then
                            _dr("インド") = Convert.ToBoolean(DtView1(i)("India"))
                        Else
                            _dr("インド") = DBNull.Value
                        End If
    ...
    Private Function Import_Excel_DT(ByVal FilePath As String, ByVal FileName As String, ByVal Extension As String, ByVal isHDR As String) As DataTable
        ...
        'Dim fs As New FileStream(FilePath, FileMode.Open, FileAccess.Read, FileShare.None)
        'fs.Close()
        ...
        Try
            ...
            Using workBook As New XLWorkbook(FilePath)
                ...
                For Each row As IXLRow In workSheet.Rows(1, lastrow)
        ...
        Return dt
    End Function
    Private Function Import_To_DataTable(ByVal FilePath As String, ByVal Extension As String, ByVal isHDR As String) As DataTable
        ...
        Select Case Extension
            ...
            Case ".xlsx"
                conStr = String.Format("Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties='Excel 8.0;HDR=YES'", FilePath)
        End Select
        ...
        '        If dt.Columns(1).ColumnName.ToUpper = "ID".ToUpper() Then
        '            j += 1
        '        End If
        '        If dt.Columns(2).ColumnName.ToUpper() = "管理番号".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(3).ColumnName.ToUpper() = "仮番号".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(4).ColumnName.ToUpper() = "枝番".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(5).ColumnName.ToUpper() = "旧番号".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(6).ColumnName.ToUpper() = "契約日".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(7).ColumnName.ToUpper() = "契約期間開始".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(8).ColumnName.ToUpper() = "契約期間終了予定日".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(9).ColumnName.ToUpper() = "終了日".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(10).ColumnName.ToUpper() = "更新コード".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(11).ColumnName.ToUpper() = "自動更新間隔".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(12).ColumnName.ToUpper() = "取引先番号_全".ToUpper() Then
        '            j += 1
        '        End If
        '        If dt.Columns(13).ColumnName.ToUpper() = "取引先名_全".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(14).ColumnName.ToUpper() = "ヨミガナ_全".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(15).ColumnName.ToUpper() = "契約書名".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(16).ColumnName.ToUpper() = "部署番号".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(17).ColumnName.ToUpper() = "管理部署".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(18).ColumnName.ToUpper() = "契約担当".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(19).ColumnName.ToUpper() = "備考".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(20).ColumnName.ToUpper() = "削除".ToUpper() Then
        '            j += 1
        '        End If

        '        If dt.Columns(21).ColumnName.ToUpper() = "インド".ToUpper() Then
        '            j += 1
        '        End If
    ...
    Sub BindGrid()
        ...
        End If
        Dim strdatetimepicker2 As String
        If DateTimePicker2.Text = " " Then
            strdatetimepicker2 = ""
        Else
            strdatetimepicker2 = Convert.ToDateTime(DateTimePicker2.Text).ToString("yyyy-MM-dd")
        End If
        ...
        Try
            ...
            sql += "WHERE t20_contract_management.id like'%' "
            ...
            End If
            If Not String.IsNullOrEmpty(strdatetimepicker2) Then
                sql += "AND t20_contract_management.Survey_Date like '%" & strdatetimepicker2 & "%' "
            End If
            If strChckbox Then
    ...
    Private Sub DateTimePicker2_MouseUp(sender As Object, e As MouseEventArgs) Handles DateTimePicker2.MouseUp
        DateTimePicker2.Format = DateTimePickerFormat.Custom

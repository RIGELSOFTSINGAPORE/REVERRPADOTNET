...
Partial Public Class SectionReport_R_Inquiry_Doukonbutu_Inq
    ...
    "; text-align: center; vertical-align: middle; ddo-char-set: 128"
        ...
        Me.Label2.Text = "ÅúÅ@Ç®óaÇ©ÇËÇ¢ÇΩÇµÇ‹ÇµÇΩ"
        Me.Label2.Top = 6.0625!
        ...
        Me.Label26.Text = "Å@Å@Å@ïKóvÇ∆Ç»ÇËÇ‹Ç∑ÅB"
        Me.Label26.Top = 6.6875!
        ...
        Me.Label28.Text = "Å@Å@Å@êªïiï€èÿèëÅiïtëÆïiópÅjÇ…îÃîÑìXàÛÇ∆ïtëÆïiî†Ç…ãLç⁄Ç≥ÇÍÇƒÇ¢ÇÈêªïiNoÇ"
        Me.Label28.Top = 7.0!
        ...
        Me.Label29.Text = "Å@Å@Å@É{Å[ÉãÉyÉìÇ≈Ç≤ãLì¸å„ÅAéäã}ïæé–Ç÷óXëóÇ≈Ç®ëóÇËâ∫Ç≥Ç¢ÅB"
        Me.Label29.Top = 7.3125!
        ...
        Me.Label30.Text = "Å@Å@Å@ìûíÖå„ÅAï€èÿèCóùìKópêRç∏ÇÃà◊ÅAêªïiï€èÿèëÅiïtëÆïiópÅjÇÕ“∞∂∞Ç÷íÒèoÇ∆Ç»ÇË"
        ...
        Me.Label31.Text = "Å@Å@Å@êRç∏í âﬂå„ÅAèCóùÇ∆Ç»ÇËÇ‹Ç∑ÅB"
        Me.Label31.Top = 7.9375!
        ...
        Me.Label32.Text = "Å@Å@Å¶ íçà”ÅFêRç∏í âﬂèoóàÇ»Ç¢èÍçáÇ™Ç†ÇËÇ‹Ç∑"
        Me.Label32.Top = 8.25!
        ...
        Me.Label33.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; text-align: left; vertical-align: middle"
        Me.Label33.Text = "êªïiï€èÿèëÅiïtëÆïiópÅjóXëóó\íËì˙ÅF"
        Me.Label33.Top = 8.6875!
        ...
        Me.Label35.Text = " ÅúÅ@Ç±ÇÃópéÜÇÕÇ≤ãLì¸å„FAXÇÇ®äËÇ¢ívÇµÇ‹Ç∑Åiï€èÿèëÇ…Ç‡ìØç´â∫Ç≥Ç¢Åj"
        Me.Label35.Top = 9.6875!
        Me.Label35.Width = 6.75!
        '
        'Label37
        '
        Me.Label37.DataField = "inq_memo"
        Me.Label37.Height = 0.25!
        Me.Label37.HyperLink = Nothing
        Me.Label37.Left = 1.9375!
        Me.Label37.Name = "Label37"
        Me.Label37.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; text-align: left; vertical-align: middle"
        Me.Label37.Text = "ìØç´"
        Me.Label37.Top = 6.0625!
        Me.Label37.Width = 4.9375!
        '
        'Line4
        '
        Me.Line4.Height = 0!
        Me.Line4.Left = 1.9375!
        Me.Line4.LineWeight = 1.0!
        Me.Line4.Name = "Line4"
        Me.Line4.Top = 6.3125!
        Me.Line4.Width = 4.9375!
        Me.Line4.X1 = 1.9375!
        Me.Line4.X2 = 6.875!
        Me.Line4.Y1 = 6.3125!
        Me.Line4.Y2 = 6.3125!
        ...
        Me.Label36.Style = "background-color: window; font-family: ÇlÇr ÇoÉSÉVÉbÉN; font-size: 8.25pt; font-weight: " &
    "normal; text-align: center; vertical-align: middle; ddo-char-set: 128"
        Me.Label36.Text = "ÉÇÉfÉã"
        Me.Label36.Top = 3.125!
    ...
    "normal; text-align: center; vertical-align: middle; ddo-char-set: 128"
        Me.Label38.Text = "êªë¢î‘çÜ"
        Me.Label38.Top = 3.375!
        ...
        Me.Label40.Left = 0.125!
        Me.Label40.Name = "Label40"
        Me.Label40.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; vertical-align: middle"
        Me.Label40.Text = "Å@Å@Å@ÇÕêªïiìØç´ï®Ç≈ÇÕñ≥Ç¢à◊ÅAïtëÆïiçwì¸éûìØç´Ç≥ÇÍÇƒÇ¢Ç‹Ç∑êªïiï€èÿèëÅiïtëÆïiópÅjÇ™"
        Me.Label40.Top = 6.375!
        ...
        '
        'SectionReport_R_Inquiry_Doukonbutu_Inq
        '

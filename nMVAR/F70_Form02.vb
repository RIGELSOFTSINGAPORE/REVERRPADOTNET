...
#End Region
    ...
    Public Function Print_R_NEVA(ByVal rcpt_no)
            ...
            For i = 0 To P_DtView1.Count - 1
                ...
                Select Case P_DtView1(0)("dlvr_rprt_ptn") '印刷パターン
                    ...
                    Case Is = "10"  'ジョーシン埼玉
                        ...
                        dtRow("Expr01") = Nothing
                        dtRow("Expr02") = "      6395"
                        dtRow("Expr03") = "ジョーシンサービス㈱" & System.Environment.NewLine & "埼玉サービスセンター"
                        dtRow("Expr04") = P_DtView1(i)("client_code")
                        dtRow("Expr05") = Nothing
                    ...
                    Case Is = "14"  'ジョーシン新潟
                        dtRow("Expr01") = Nothing
                        dtRow("Expr02") = "      6384"
                        dtRow("Expr03") = "ジョーシンサービス㈱" & System.Environment.NewLine & "新潟サービスセンター"
                        dtRow("Expr04") = P_DtView1(i)("client_code")
                        dtRow("Expr05") = Nothing
        ...
        Select Case P_DtView1(0)("dlvr_rprt_ptn") '印刷パターン
            Case Is = "12"  'デオデオ
                Dim rpt As New SectionReport_R_NEVA_DEODEO
            ...
            Case Is = "13"  'コジマ
                If Ans = "6" Then
                    Dim rpt As New SectionReport_R_NEVA_New_kojima
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.PageSettings.Margins.Top = P_uppr_mrgn
                    rpt.PageSettings.Margins.Left = P_left_mrgn
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_NEVA_Kojima
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.PageSettings.Margins.Top = P_uppr_mrgn
                    rpt.PageSettings.Margins.Left = P_left_mrgn
        ...
        If P_DtView1.Count <> 0 Then
            ...
            Select Case P_DtView1(0)("dlvr_rprt_ptn") '印刷パターン
                Case Is = "01"  '全国生協 神戸事業連合
                    ...
                    End If
                    WK_str = WK_str.Replace("株式会社", "㈱")
                    ' WK_str = StrConv(WK_str, VbStrConv.Narrow) #ram 2020-12-10
                    WK_str = Trim(WK_str)
                ...
                Case Is = "04"  '京都事業連合
                    ...
                    For i = 1 To 12
                        If out_seq(i) = "1" Then
                            ...
                            Dim rpt As New SectionReport_R_CSTD_Tankyo_KyotoJiren
                            rpt.DataSource = P_DsPRT
                            rpt.DataMember = "Print02"
                            rpt.PageSettings.Margins.Top = P_uppr_mrgn
                            rpt.PageSettings.Margins.Left = P_left_mrgn
...
err:
    ...
    Public Function Print_R_Haiso(ByVal rcpt_no, ByVal prt_ptn)
        ...
        Select Case prt_ptn
            ...
            Case Is = "02"
                Dim rpt As New SectionReport_R_Haiso_Meitetu_Ren_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "03"
                Dim rpt As New SectionReport_R_Haiso_Meitetu_Ren_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "04"
                Dim rpt As New SectionReport_R_Haiso_Meitetu_Ren_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "05"
                Dim rpt As New SectionReport_R_Haiso_Sagawa_GwNote
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "06"
                Dim rpt As New SectionReport_R_Haiso_Seibu_Tan_EU_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "07"
                Dim rpt As New SectionReport_R_Haiso_Seibu_Tan_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "08"
                Dim rpt As New SectionReport_R_Haiso_Seibu_Tan_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
                ...
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    End If
                    Dim p As New GrapeCity.ActiveReports.Export.Pdf.Section.PdfExport
                    p.Export(rpt.Document, "\\tsclient\C\nmvarpdf\" & Format(Now, "yyyyMMddHHmmss")) 'PdfExport1.Export(rpt.Document, "\\tsclient\C\nmvarpdf\" & Format(Now, "yyyyMMddHHmmss") & printer & ".pdf")
            ...
            Case Is = "09"
                Dim rpt As New SectionReport_R_Haiso_Seibu_Tan_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "10"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Ren_EU_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "11"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Ren_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "12"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Ren_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "13"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Ren_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "14"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Tan_EU_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "15"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Tan_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "16"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Tan_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "17"
                Dim rpt As New SectionReport_R_Haiso_SuperPerikan_Tan_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "18"
                Dim rpt As New SectionReport_R_Haiso_ToToshiba_Seibu_Ren
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "19"
                Dim rpt As New SectionReport_R_Haiso_Yamato_Ren_EU_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "20"
                Dim rpt As New SectionReport_R_Haiso_Yamato_Ren_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "21"
                Dim rpt As New SectionReport_R_Haiso_Yamato_Ren_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "22"
                Dim rpt As New SectionReport_R_Haiso_Yamato_Ren_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "23"
                Dim rpt As New SectionReport_R_Haiso_Fukuyama_Ren_EU_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "24"
                Dim rpt As New SectionReport_R_Haiso_Fukuyama_Ren_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "25"
                Dim rpt As New SectionReport_R_Haiso_Fukuyama_Ren_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "26"
                Dim rpt As New SectionReport_R_Haiso_Fukuyama_Ren_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "27"
                Dim rpt As New SectionReport_R_Haiso_Nittsu_Ren_EU_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "28"
                Dim rpt As New SectionReport_R_Haiso_Nittsu_Ren_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "29"
                Dim rpt As New SectionReport_R_Haiso_Nittsu_Ren_Hansya_QG
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "30"
                Dim rpt As New SectionReport_R_Haiso_Nittsu_Ren_Hansya_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn
            ...
            Case Is = "31"
                Dim rpt As New SectionReport_R_Haiso_Yamato_DOS_EU_QGX
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.PageSettings.Margins.Top = P_uppr_mrgn
                rpt.PageSettings.Margins.Left = P_left_mrgn

Module Module_Dim
    ...
    Public P_EMPL, P_EMPL_NAME, P_EMPL_BRCH, P_EMPL_BRCH_name, P_full, P_rpar_comp_code, P_DBG, P_tokubetu As String   'LogIn User情報
    ...
    'Public P4_F00_Form07_2 As Integer  #2021-03-16 prabu
    Public P4_F00_Form07_2 As String                                                               'F00_Form07_2用パラメータ
    Public P1_F00_Form07_2, P2_F00_Form07_2, P3_F00_Form07_2 As String                              'F00_Form07_2用パラメータ
    ...
    Public P_rebate, P_idvd, P_chn_F As Integer      'リベート・自己負担金、チェーン伝票だけど通常金額

    Public P_rcpt_cls, P_grup As String
    Public P_exp_cnt, P_exp_amt As Integer      '消耗品
    Public P_Nexp_cnt, P_Nexp_amt As Integer    '消耗品以外

    Public P_zero As String

    Public P1_CONTACT, P2_CONTACT, P3_CONTACT As String

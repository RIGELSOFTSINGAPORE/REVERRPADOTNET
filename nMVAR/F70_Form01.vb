...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ClientSize = New System.Drawing.Size(231, 62)
        Me.ControlBox = False
...
err:
    ...
    Public Function Print_R_Mitsumori(ByVal rcpt_no, ByVal ptn)
        ...
        Select Case ptn
            Case Is = "01"  'ビックカメラ
                Dim rpt As New SectionReport_R_Mitsumori_BICCamera
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "02"  'ジョーシン
                If sel = "Apple" Then
                    Dim rpt As New SectionReport_R_Mitsumori_Apple
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_Joshin
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "03"  'ソフマップ
                Dim rpt As New SectionReport_R_Mitsumori_SOFMAP
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "04"  'ヨドバシカメラ
                Dim rpt As New SectionReport_R_Mitsumori_Yodobashi
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                ...
                Select Case P_DtView1(0)("rcpt_cls")
                    Case Is = "02"  'QG-Care
                        If P_DtView1(0)("menseki_amnt") = 0 And P_DtView1(0)("wrn_limt_amnt") >= P_DtView1(0)("etmt_shop_ttl") + P_DtView1(0)("etmt_shop_tax") Then
                            Dim rpt As New SectionReport_R_Mitsumori_Seikyo_QGCARE
                            rpt.DataSource = P_DsPRT
                            rpt.DataMember = "Print01"
                            rpt.Run(False)
                            If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                            ...
                            End If
                        Else
                            Dim rpt As New SectionReport_R_Mitsumori_Seikyo_Menseki5k
                            rpt.DataSource = P_DsPRT
                            rpt.DataMember = "Print01"
                            rpt.Run(False)
                            If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    Case Is = "03", "10" '延長保証(QG-Care)'生協Fujitsu保険
                        If P_DtView1(0)("menseki_amnt") <> 0 Or P_DtView1(0)("wrn_limt_amnt") < P_DtView1(0)("etmt_shop_ttl") + P_DtView1(0)("etmt_shop_tax") Then    '免責あり or 富士通保険 or 限度超
                            ...
                            End If
                        Else
                            Dim rpt As New SectionReport_R_Mitsumori_Seikyo_Normal
                            rpt.DataSource = P_DsPRT
                            rpt.DataMember = "Print01"
                            rpt.Run(False)
                            If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "06"  'ソフマップOLC
                Dim rpt As New SectionReport_R_Mitsumori_SOFMAP_OLC
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "07"  '京都事業連合
                Dim rpt As New SectionReport_R_Mitsumori_kyotorengo
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "08"  '通常（販社）
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_Normal_Hansya
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "09"  '通常（定額）
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_Normal_Teigaku
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "10"  'エイデン
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_Eiden
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "11"  'ビックカメラ（TSS）
                Dim rpt As New SectionReport_R_Mitsumori_BICMK
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                ...
                Dim rpt2 As New SectionReport_R_Mitsumori_BicEU
            ...
            Case Is = "12"  'ビックカメラ（西梅田）
                Dim rpt As New SectionReport_R_Mitsumori_Bic_EU_NU
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "13"  'コジマ
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_kojima
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "14"  'ソフトバンク
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_softbank
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Else       '通常
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Mitsumori_Normal
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
...
err:
    ...
    Public Function Print_R_NEC_Parts_Inq(ByVal rcpt_no)
        ...
        For i = 1 To page
            P_page = i
            Dim rpt As New SectionReport_R_NEC_Parts_Inq
            rpt.DataSource = P_DsPRT
            rpt.DataMember = "Print01"
            rpt.Run(False)
            If P_mojibake = "True" And P_PC_NAME2 <> "" Then
...
err:
    ...
    Public Function Print_R_Fujitsu_Parts_Inq(ByVal rcpt_no)
        ...
        For i = 1 To page
            P_page = i
            Dim rpt As New SectionReport_R_Fujitsu_Parts_Inq
            rpt.DataSource = P_DsPRT
            rpt.DataMember = "Print01"
            rpt.Run(False)
            If P_mojibake = "True" And P_PC_NAME2 <> "" Then
...
err:
    ...
    Public Function Print_R_Sagyou_Report(ByVal rcpt_no, ByVal ptn)
        ...
        Select Case ptn
            Case Is = "01"  'ビックカメラ EU
                If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                    ...
                    P_DtView1(0)("comp_eu_tax") = 0
                End If
                Dim rpt As New SectionReport_R_Sagyou_Report_Bic_EU
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                ...
                Dim rpt2 As New SectionReport_R_Sagyou_Report_BicGSS
                rpt2.DataSource = P_DsPRT
                rpt2.DataMember = "Print01"
                rpt2.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "02"  'Ks
                ...
                End If
                If sel = "Apple" Then
                    Dim rpt2 As New SectionReport_R_Sagyou_Report_Apple
                    rpt2.DataSource = P_DsPRT
                    rpt2.DataMember = "Print01"
                    rpt2.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_KS_EU
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "03"  '大学生協
                ...
                End If
                If sel = "Apple" Then
                    Dim rpt As New SectionReport_R_Sagyou_Report_Apple
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_Seikyo_EU
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "04"  'ソフマップ
                If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                    ...
                    P_DtView1(0)("comp_eu_tax") = 0
                End If
                Dim rpt As New SectionReport_R_Sagyou_Report_SofmapStore
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "05"  'ヨドバシカメラ
                If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                    ...
                    P_DtView1(0)("comp_eu_tax") = 0
                End If
                Dim rpt As New SectionReport_R_Sagyou_Report_Yodobashi_EU
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "06"  'ソフマップOLC
                If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                    ...
                    P_DtView1(0)("comp_eu_tax") = 0
                End If
                Dim rpt As New SectionReport_R_Sagyou_Report_SofmapOLC
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "07"  '京都事業連合
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_kyotoseikyo
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "08"  '通常（定額）
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_Normal_Teigaku
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "09"  'ビックカメラ EU(TSS)
                If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                    ...
                    P_DtView1(0)("comp_eu_tax") = 0
                End If
                Dim rpt As New SectionReport_R_Sagyou_Report_BIC_EU_NMK
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                ...
                Dim rpt2 As New SectionReport_R_Sagyou_Report_BIC_NMK
                rpt2.DataSource = P_DsPRT
                rpt2.DataMember = "Print01"
                rpt2.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "10"  '通常（定額）
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_EU_syanasi
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "11"  'ビックカメラ EU(西梅田)
                If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                    ...
                    P_DtView1(0)("comp_eu_tax") = 0
                End If
                Dim rpt As New SectionReport_R_Sagyou_Report_BIC_EU_NU
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "12"  'コジマ
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_Kojima
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    Dim rpt2 As New SectionReport_R_Sagyou_Report_Kojima_0
                    rpt2.DataSource = P_DsPRT
                    rpt2.DataMember = "Print01"
                    rpt2.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "13"  'ドスパラ
                ...
                Else
                    P_zero = "0"
                    Dim rpt As New SectionReport_R_Sagyou_Report_DosPara
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    P_zero = "1"
                    Dim rpt2 As New SectionReport_R_Sagyou_Report_DosPara
                    rpt2.DataSource = P_DsPRT
                    rpt2.DataMember = "Print01"
                    rpt2.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "14"  'ジョーシン
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_jyoshin_apple_EU
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "15"  'ソフトバンク
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_softbank
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "16"  'QAC
                ...
                If sel = "Apple" Then
                    ...
                    End If
                Else
                    Dim rpt As New SectionReport_R_Sagyou_Report_QAC
                    rpt.DataSource = P_DsPRT
                    rpt.DataMember = "Print01"
                    rpt.Run(False)
                    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                    ...
                    'Dim rpt2 As  New SectionReport_R_Sagyou_Report_Normal
                    'rpt2.DataSource = P_DsPRT
                    'rpt2.DataMember = "Print01"
                    'rpt2.Run(False)
                    'If P_mojibake = "True" And P_PC_NAME2 <> "" Then
                ...
                Else
                    ...
                    Else
                        If P_DtView1(0)("rpar_cls") <> "01" Then   '有償以外
                            ...
                            P_DtView1(0)("comp_eu_tax") = 0
                        End If
                        Dim rpt As New SectionReport_R_Sagyou_Report_Normal
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "Print01"
                        rpt.Run(False)
                        If P_mojibake = "True" And P_PC_NAME2 <> "" Then
        ...
        '    Dim rpt As  New SectionReport_R_Sagyou_Report_Normal  '通常
        '    rpt.DataSource = P_DsPRT
        '    rpt.DataMember = "Print01"
        '    rpt.Run(False)
        '    If P_mojibake = "True" And P_PC_NAME2 <> "" Then
...
err:
    ...
    Public Function Print_R_Inquiry(ByVal Key_no, ByVal ptn)
        ...
        Select Case ptn
            Case Is = "01"  '標準
                Dim rpt As New SectionReport_R_Inquiry_Free_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "02"  'パスワード確認
                Dim rpt As New SectionReport_R_Inquiry_Password
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "03"  'データ消去確認
                Dim rpt As New SectionReport_R_Inquiry_Data
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "04"  '症状再現しない
                Dim rpt As New SectionReport_R_Inquiry_NTF
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "05"  '保証書記載漏れ
                Dim rpt As New SectionReport_R_Inquiry_Hosyomore_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "06"  '展示機
                Dim rpt As New SectionReport_R_Inquiry_Tenjiki_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "07"  'シリアル番号相違
                Dim rpt As New SectionReport_R_Inquiry_Siriaru_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "08"  '同梱物相違
                Dim rpt As New SectionReport_R_Inquiry_Doukonbutu_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "09"  '終了機種
                Dim rpt As New SectionReport_R_Inquiry_EOS_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "10"  'Apple定額修理
                Dim rpt As New SectionReport_R_Inquiry_Apple_teigaku_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "11"  '添付書
                Dim rpt As New SectionReport_R_Inquiry_Tenpusyo_Inq
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
            ...
            Case Is = "12"  'データリカバリー
                Dim rpt As New SectionReport_R_Inquiry_DataRcvy1
                rpt.DataSource = P_DsPRT
                rpt.DataMember = "Print01"
                rpt.Run(False)
                If P_mojibake = "True" And P_PC_NAME2 <> "" Then
...
err:
    ...
    Public Function Print_R_QGCare(ByVal qg_care_no, ByVal rcpt_no)
        ...
        '  Dim rpt As  New SectionReport_R_QGCare
        Dim rpt As New SectionReport_R_QGCare
        rpt.DataSource = P_DsPRT
        rpt.DataMember = "Print01"
        rpt.Run(False)
        ...
        Else
            ...
            rpt.Document.Print(False, False, False)
            'p.Export(rpt.Document, Application.StartupPath & Format(Now, "yyyyMMddHHmmss") & printer & ".pdf")
        End If

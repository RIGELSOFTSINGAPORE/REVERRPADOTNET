...
Public Class SectionReport_R_Mitsumori_SOFMAP_OLC
    ...
    Private Sub Detail_Format(sender As Object, e As EventArgs) Handles Detail.Format
        ...
        Label21.Text = "★ 修理キャンセル時は診断/見積料    \" & Format(RoundDOWN(CInt(TextBox50.Text) * (1 + CInt(TextBox24.Text) / 100), 0), "##,##0") & "  をご請求申し上げます ★"

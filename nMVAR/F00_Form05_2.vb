...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label3.Location = New System.Drawing.Point(788, 56)
        ...
        Me.Label1.Location = New System.Drawing.Point(788, 8)
        ...
        Me.Label2.Location = New System.Drawing.Point(788, 32)
        ...
        Me.Label4.Location = New System.Drawing.Point(788, 80)
        ...
        Me.Label5.Location = New System.Drawing.Point(788, 104)
        ...
        Me.Edit004.Size = New System.Drawing.Size(180, 24)
        Me.Edit004.TabIndex = 1324
...
#End Region
    ...
    Sub inz()
        ...
        strSQL += ", M01_insurance_co_decision.wrn_prod, M02_uni.uni_name"
        strSQL += " FROM T01_wrn_date INNER JOIN"
        strSQL += " M01_insurance_co_decision ON T01_wrn_date.Securities_no = M01_insurance_co_decision.Securities_no INNER JOIN"
        strSQL += " M02_uni ON T01_wrn_date.uni_code = M02_uni.uni_code"
        strSQL += " WHERE (T01_wrn_date.wrn_id = '0')"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        strSQL += " M01_insurance_co_decision ON T01_wrn_date.Securities_no = M01_insurance_co_decision.Securities_no INNER JOIN"
        strSQL += " M02_uni ON T01_wrn_date.uni_code = M02_uni.uni_code"
        strSQL += " WHERE (T01_wrn_date.wrn_id IS NOT NULL)"
        If Edit001.Text <> Nothing Then
            strSQL += " AND (T01_wrn_date.name LIKE N'%" & Label1.Text & "%'"
            strSQL += " OR T01_wrn_date.name LIKE N'%" & Label2.Text & "%'"
            strSQL += " OR T01_wrn_date.name LIKE N'%" & Label3.Text & "%'"
            strSQL += " OR T01_wrn_date.name LIKE N'%" & Label4.Text & "%'"
            strSQL += " OR T01_wrn_date.name LIKE N'%" & Label5.Text & "%')"
        End If
        If Combo001.Text <> Nothing Then
            strSQL += " AND (T01_wrn_date.uni_code = " & CL001.Text & ")"
        End If
        If Edit003.Text <> Nothing Then
            strSQL += " AND (T01_wrn_date.model_name LIKE '%" & Edit003.Text & "%')"
        End If
        If Edit004.Text <> Nothing Then
            strSQL += " AND (T01_wrn_date.s_n = '" & Edit004.Text & "')"
        End If
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN("Fujitsu")

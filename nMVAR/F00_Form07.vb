Public Class F00_Form07
    ...
    Private cmbBo(3, 1) As GrapeCity.Win.Input.Interop.Combo
...
#End Region
    ...
    Private Sub F00_Form07_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '送り状
        en = 1
        cmbBo(Line_No, en) = New GrapeCity.Win.Input.Interop.Combo
        ...
        'cmbBo(Line_No, en).HighlightText = GrapeCity.Win.Input.Interop.HighlightText.Field
        cmbBo(Line_No, en).Spin = New GrapeCity.Win.Input.Interop.Spin(0, 1, True, False, GrapeCity.Win.Input.Interop.ButtonPosition.Inside, True, GrapeCity.Win.Input.Interop.Visibility.NotShown, System.Windows.Forms.FlatStyle.System)

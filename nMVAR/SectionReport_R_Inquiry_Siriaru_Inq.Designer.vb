...
Partial Public Class SectionReport_R_Inquiry_Siriaru_Inq
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SectionReport_R_Inquiry_Siriaru_Inq))
    ...
    "; text-align: center; vertical-align: middle; ddo-char-set: 128"
        ...
        Me.Label25.Text = "ÉVÉäÉAÉãî‘çÜëäà·"
        Me.Label25.Top = 0.5!
        ...
        Me.Shape5.Top = 9.140625!
        Me.Shape5.Width = 0.1875!
        '
        'Label2
        '
        ...
        Me.Label2.Text = "ÅúÅ@Ç®óaÇ©ÇËèCóùïiìØç´ï®Ç…Ç¬Ç¢Çƒ"
        Me.Label2.Top = 6.0!
        ...
        Me.Label26.Text = " Å@å‰óaÇ©ÇËÇ¢ÇΩÇµÇ‹ÇµÇΩèCóùã@S/N"
        ...
        Me.Label28.Text = "Å@Åiç´ïÔî†ÅAêªïiï€èÿèëÅAœ∆≠±ŸÅAOSCDìôÅjÇÃêªïiÇ™à·Ç¢Ç‹Ç∑ÅB"
        ...
        Me.Label29.Text = "Å@ åªèÛéÛÇØì¸ÇÍèàóùÇ™èoóàÇ‹ÇπÇÒÇÃÇ≈éäã}Ç≤ämîFÇÇ®äËÇ¢ívÇµÇ‹Ç∑ÅB"
        Me.Label29.Top = 6.8125!
        ...
        Me.Label30.Text = "ÅúÅ@èCóùÇ…ä÷ÇµÇƒ"
        Me.Label30.Top = 7.25!
        ...
        Me.Label31.Text = "      åüèÿÇÃà◊ÅA ∞ƒﬁ√ﬁ®Ω∏ÇÃèâä˙âªÇ™ïKóvÇ∆Ç»ÇËÇ‹Ç∑ÇÃÇ≈èâä˙âªÇÃÇ≤ämîFÇ‡Ç®äËÇ¢ívÇµÇ‹Ç∑ÅB"
        Me.Label31.Top = 7.5!
        ...
        Me.Label32.Text = "Å@Å@Å@éËèáÇ…Ç»ÇËÇ‹Ç∑ÅB"
        Me.Label32.Top = 7.75!
        ...
        Me.Label33.Text = "¡™Ø∏Ç∆ºÿ±ŸNoÇãLç⁄â∫Ç≥Ç¢"
        Me.Label33.Top = 8.375!
        Me.Label33.Width = 2.125!
        '
        'Label34
        '
        Me.Label34.Height = 0.25!
        Me.Label34.HyperLink = Nothing
        Me.Label34.Left = 0.625!
        Me.Label34.Name = "Label34"
        Me.Label34.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; vertical-align: middle; ddo-char-set: 1"
        Me.Label34.Text = "S/NÅ@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@Å@èâä˙âªóπè≥Ç≈åüèÿàÀóäÇ∑ÇÈ"
        Me.Label34.Top = 8.75!
        Me.Label34.Width = 6.25!
        '
        'Label35
        '
        Me.Label35.Height = 0.25!
        Me.Label35.HyperLink = Nothing
        Me.Label35.Left = 0.625!
        Me.Label35.Name = "Label35"
        Me.Label35.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; vertical-align: middle; ddo-char-set: 1"
        Me.Label35.Text = "ºÿ±ŸNoà·Ç¢ÇÃà◊ÅAñîÇÕèâä˙âªïsâ¬ÇÃà◊ï‘ãpÇ∑ÇÈ"
        Me.Label35.Top = 9.109375!
        ...
        Me.Label36.Left = 0.375!
        Me.Label36.Name = "Label36"
        Me.Label36.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; text-align: center; vertical-align: middle;" &
    " ddo-char-set: 1"
        Me.Label36.Text = "ì˙ïtÅF"
        Me.Label36.Top = 9.8125!
        ...
        Me.Label37.Left = 3.5625!
        Me.Label37.Name = "Label37"
        Me.Label37.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; vertical-align: middle; ddo-char-set: 1"
        Me.Label37.Text = "Ç≤íSìñÅF"
        Me.Label37.Top = 9.8125!
        Me.Label37.Width = 0.6875!
        '
        'Label38
        '
        Me.Label38.DataField = "s_n"
        Me.Label38.Height = 0.25!
        Me.Label38.HyperLink = Nothing
        Me.Label38.Left = 3.25!
        Me.Label38.Name = "Label38"
        Me.Label38.Style = "background-color: #C0C0FF; font-family: ÇlÇr Çoñæí©; font-size: 12pt; text-align: cent" &
    "er; vertical-align: middle; ddo-char-set: 1"
        Me.Label38.Text = "ÉVÉäÉAÉã"
        Me.Label38.Top = 4.3125!
        Me.Label38.Visible = False
        Me.Label38.Width = 1.6875!
        '
        'Label40
        '
        Me.Label40.DataField = "inq_memo"
        Me.Label40.Height = 0.25!
        Me.Label40.HyperLink = Nothing
        Me.Label40.Left = 5.0!
        Me.Label40.Name = "Label40"
        Me.Label40.Style = "background-color: #C0C0FF; font-family: ÇlÇr Çoñæí©; font-size: 12pt; vertical-align: " &
    "middle; ddo-char-set: 1"
        Me.Label40.Text = "ÉVÉäÉAÉã2"
        Me.Label40.Top = 4.3125!
        Me.Label40.Visible = False
        Me.Label40.Width = 1.6875!
        '
        'Label41
        '
        ...
        Me.Label41.Style = "font-family: ÇlÇr Çoñæí©; font-size: 12pt; text-align: center; vertical-align: middle;" &
    " ddo-char-set: 1"
        Me.Label41.Text = "********************************************************************************"
        Me.Label41.Top = 8.0625!
        Me.Label41.Width = 6.75!
        '
        'Line4
        '
        Me.Line4.Height = 0!
        Me.Line4.Left = 0.9375!
        ...
        Me.Label39.Style = "background-color: window; font-family: ÇlÇr ÇoÉSÉVÉbÉN; font-size: 8.25pt; font-weight: " &
    "normal; text-align: center; vertical-align: middle; ddo-char-set: 128"
        Me.Label39.Text = "ÉÇÉfÉã"
        Me.Label39.Top = 3.125!
    ...
    "normal; text-align: center; vertical-align: middle; ddo-char-set: 128"
        ...
        '
        'SectionReport_R_Inquiry_Siriaru_Inq
        '

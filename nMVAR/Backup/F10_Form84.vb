...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Date001.DropDownCalendar.FocusDate = New GrapeCity.Win.Input.DateTimeEx(New Date(2019, 9, 24, 0, 0, 0, 0))
        Me.Date001.DropDownCalendar.SelectedDate = New GrapeCity.Win.Input.DateTimeEx(New Date(2019, 9, 24, 0, 0, 0, 0))

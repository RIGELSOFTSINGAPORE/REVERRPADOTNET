Public Class F00_Form03
    ...
    Private edit(99, 6) As GrapeCity.Win.Input.Edit
    Private nbrBox(99, 8) As GrapeCity.Win.Input.Number
...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Number001.DisplayFormat = New GrapeCity.Win.Input.NumberFormat("0.00000", "", "", "-", "", "", "")
        ...
        Me.Number001.Format = New GrapeCity.Win.Input.NumberFormat("0.00000", "", "", "-", "", "", "")
        ...
        Me.Number002.DisplayFormat = New GrapeCity.Win.Input.NumberFormat("0.00000", "", "", "-", "", "", "")
        ...
        Me.Number002.Format = New GrapeCity.Win.Input.NumberFormat("0.00000", "", "", "-", "", "", "")
...
#End Region
    ...
    Sub add_line(ByVal flg)
        ...
        '部品コード
        en = 1
        edit(Line_No1, en) = New GrapeCity.Win.Input.Edit
        edit(Line_No1, en).Location = New System.Drawing.Point(0, 25 * Line_No1 + label(0, 0).Location.Y)
        edit(Line_No1, en).Shortcuts = New GrapeCity.Win.Input.ShortcutCollection(New String() {"F2"}, New GrapeCity.Win.Input.KeyActions() {GrapeCity.Win.Input.KeyActions.Clear})
        ...
        edit(Line_No1, en).TextVAlign = GrapeCity.Win.Input.AlignVertical.Middle
        ...
        '単価
        en = 1
        nbrBox(Line_No1, en) = New GrapeCity.Win.Input.Number
        nbrBox(Line_No1, en).DisplayFormat = New GrapeCity.Win.Input.NumberFormat("###,##0", "", "", "-", "", "", "Null")
        nbrBox(Line_No1, en).DropDown = New GrapeCity.Win.Input.DropDown(GrapeCity.Win.Input.ButtonPosition.Inside, True, GrapeCity.Win.Input.Visibility.NotShown, System.Windows.Forms.FlatStyle.System)
        nbrBox(Line_No1, en).EditMode = GrapeCity.Win.Input.EditMode.Overwrite
        nbrBox(Line_No1, en).ImeMode = ImeMode.Off
        nbrBox(Line_No1, en).Format = New GrapeCity.Win.Input.NumberFormat("###,##0", "", "", "-", "", "", "")
        ...
        nbrBox(Line_No1, en).Shortcuts = New GrapeCity.Win.Input.ShortcutCollection(New String() {"F2"}, New GrapeCity.Win.Input.KeyActions() {GrapeCity.Win.Input.KeyActions.Clear})
        nbrBox(Line_No1, en).Spin = New GrapeCity.Win.Input.Spin(0, 1, True, True, GrapeCity.Win.Input.ButtonPosition.Inside, False, GrapeCity.Win.Input.Visibility.NotShown, System.Windows.Forms.FlatStyle.System)

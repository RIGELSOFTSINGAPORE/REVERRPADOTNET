...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridTextBoxColumn6, Me.DataGridTextBoxColumn11, Me.DataGridTextBoxColumn7, Me.DataGridTextBoxColumn8, Me.DataGridTextBoxColumn9, Me.DataGridTextBoxColumn10})
        ...
        Me.DataGridTextBoxColumn11.HeaderText = "シリアル番号"
        ...
        Me.Label2.Location = New System.Drawing.Point(796, 24)
        ...
        Me.Label3.Location = New System.Drawing.Point(796, 48)
        ...
        Me.Label4.Location = New System.Drawing.Point(796, 72)
        Me.Label4.Name = "Label4"
        Me.Label4.Size = New System.Drawing.Size(188, 24)
        Me.Label4.TabIndex = 1306
        ...
        Me.Label5.Location = New System.Drawing.Point(796, 96)
        Me.Label5.Name = "Label5"
        Me.Label5.Size = New System.Drawing.Size(188, 24)
        Me.Label5.TabIndex = 1307
        ...
        Me.Label6.Location = New System.Drawing.Point(364, 48)
        Me.Label6.Name = "Label6"
        Me.Label6.Size = New System.Drawing.Size(112, 24)
        Me.Label6.TabIndex = 1309
        ...
        Me.Edit004.Location = New System.Drawing.Point(476, 48)
...
#End Region
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        If Edit004.Text <> Nothing Then
            strSQL += " AND (T01_member.s_no = '" & Edit004.Text & "')"

            strSQL += " UNION"
            strSQL += " SELECT T01_member.code, T01_member.user_name, T01_member.use_name_kana, T01_member.tel"
            strSQL += ", T01_member.makr_code, M05_VNDR.name AS maker_name, T01_member.modl_name, T06_sno.s_no"
            strSQL += ", T01_member.prch_amnt, T01_member.wrn_tem, V_M02_HSK.cls_code_name AS wrn_tem_name"
            strSQL += ", T01_member.makr_wrn_stat, T01_member.wrn_range, V_M02_HSY.cls_code_name AS wrn_range_name"
            strSQL += ", M01_univ.univ_name"
            ...
            If Edit003.Text <> Nothing Then
                strSQL += " AND (T01_member.tel LIKE '" & Edit003.Text & "%')"
            End If
            strSQL += " AND (T06_sno.s_no = '" & Edit004.Text & "')"
        End If
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN("QGCare")

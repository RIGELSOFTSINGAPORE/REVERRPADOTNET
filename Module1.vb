Module Module1
    ...
    Public source(6) As String
    Public catalog(6) As String
    ...
    Sub DB_INIT_sub(ByVal seq)
        ...
        Select Case seq
            ...
            Case Is = 6
                sr = New System.IO.StreamReader("best_wrn_new.ini")
        End Select
        ...
        Select Case file
            ...
            Case Is = "best_intl"
                cnsqlclient.ConnectionString = "integrated security=SSPI;data source=" & source(3) & ";" &
                                               "persist security info=False;Connection Timeout=1000000;initial catalog=" & catalog(3)
            Case Is = "best_wrn_temp"
                cnsqlclient.ConnectionString = "integrated security=SSPI;data source=" & source(4) & ";" &
                                               "persist security info=False;Connection Timeout=1000000;initial catalog=" & catalog(4)
            Case Is = "bicdb"
                cnsqlclient.ConnectionString = "integrated security=SSPI;data source=" & source(5) & ";" &
                                               "persist security info=False;Connection Timeout=1000000;initial catalog=" & catalog(5)
            Case Is = "best_wrn_new"
                cnsqlclient.ConnectionString = "integrated security=SSPI;data source=" & source(6) & ";" &
                                               "persist security info=False;Connection Timeout=1000000;initial catalog=" & catalog(6)
        End Select

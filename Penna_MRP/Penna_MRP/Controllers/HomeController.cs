...
namespace Penna_MRP.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Menu()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(Language))
                {
                    ...
                    result = Penna_businesslayer.UpdateLanguageType(Language);
                ...
                Menu = Penna_businesslayer.ShowMenus(UserId);//10012
        ...
        public ActionResult Change(string LanguageAbbrevation)
        {
            ...
            try
            {
                result = Penna_businesslayer.UpdateLanguageType(LanguageAbbrevation);
        ...
        public ActionResult MenuManagement()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.MenuManagement, "Menu Management");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult MenuManagement(AddDynamicMenu dynamicmenu)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    obj = Penna_businesslayer.CreateDynamicMenu(dynamicmenu, Convert.ToInt32(Session["RoleId"]), Convert.ToBoolean(Session["IsActive"]), Convert.ToString(Session["UserName"]));
                    if (obj.ErrorCode == "1")
                    {
        ...
        {
            TempData["showClientMenu"] = null;
            EditMenuDetails result = Penna_businesslayer.GetMenuById(obj);
        ...
        public JsonResult SaveMenuListData(int MenuId, string MenuName, string updatedby)
        {
            ...
            result = Penna_businesslayer.SaveMenuListData(MenuId, MenuName, updatedby);
        ...
        public JsonResult DeleteMenuById(EditMenuDetails obj)
        {
            ...
            try
            {
                result = Penna_businesslayer.DeleteMenu(obj.MenuId);
        ...
        public ActionResult LoadMenuListData(jQueryDataTableParamModel<Menu> param)
        {
            ...
            try
            {
                ...
                var result = Penna_businesslayer.ShowGridMenus();
        ...
        public JsonResult DeletePageById(string PageId,string PageMenuId)
        {
            ...
            try
            {
                result = Penna_businesslayer.DeletePage(Convert.ToInt32(PageId), Convert.ToInt32(PageMenuId));
        ...
        {
            TempData["showClientMenu"] = null;
            bool result= Penna_businesslayer.PageMenuIdExists(MID,PageMenuName);
            if(result==true)
            {
                ViewBag.MyPageName = PageMenuName;
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), MID, PageMenuName);

                ViewBag.UsersName = new SelectList(Penna_businesslayer.PageUsers(), "UserId", "UserName");
        ...
        public JsonResult AddPageInformation(SavePageContent savepagecontent)
        {
            ...
            try
            {
                result = Penna_businesslayer.SavePageInformation(obj);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult LoadPageListData(jQueryDataTableParamModel<ShowPageGrid> param, string PageName)
        {
            try
            {
                ...
                int recordsTotal = 0;
                // Getting all Customer data    
                var result = Penna_businesslayer.ShowPageDetails(PageName);
                recordsTotal = result.Count();
                var data = result.ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        public JsonResult GetPageListDataById(string PageId)
        {
            ...
            {
                TempData["showClientMenu"] = null;
                ShowEditablePage obj = Penna_businesslayer.GetPageListDataById(PageId);
        ...
        public ActionResult Widgets()
        {
            ...
            try
            {
                //Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.UserManagement, "User Management");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult SocialMedia()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.SocialMedia, "SocialMedia");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult UserHome()
        {
            ...
            //Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), "UserHome");
        ...
        [HttpGet]
        [Authorize]
        public ActionResult UserPenna()
        {
            TempData["showClientMenu"] = true;
            //Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.UserManagement, "UserPenna");
            return View();
        }
        ...
        {
            TempData["showClientMenu"] = true;
            //Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), "UserClient");
            List<ClintUser> Clintimg = new List<ClintUser>();
            try
            {
                TempData["showClientMenu"] = true;
                Clintimg = Penna_businesslayer.SelectClint();
        ...
        {
            TempData["showClientMenu"] = true;
            // Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), "UserContactUs");
            UserContactUsViewModel obj = new UserContactUsViewModel();

            obj.ClientDetails = Penna_businesslayer.Selectadd();
            try
            {
                TempData["showClientMenu"] = true;
            }
        ...
        public ActionResult UserContactUsSubmit(UserContactUsViewModel obj)
        {
            ...
            try
            {
                Penna_businesslayer.insertEnquiry(obj.EnquiryFormDetails);
            }
            catch (Exception ex)
            {
                LogInfo.LogMsg = string.Format(" ", "", ex.Message);
        ...
        public ActionResult UserPages()
        {
            ...
            obj = Penna_businesslayer.UserManagementForClients();
        ...
        public ActionResult UserClientPage(string PageFileName)
        {
            ...
            lstpages = Penna_businesslayer.ShowClientPage(PageFileName, Convert.ToInt32(Session["RoleId"]), Convert.ToString(Session["UserId"]));
        ...
        public ActionResult DashBoard()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.DashBoard, "DashBoard");
                //obj = Penna_businesslayer.GetHitCounter();
                //Penna_businesslayer.ShowPPTChart();
        ...
        public ActionResult CreateBar()
        {
            ...
            //obj= Penna_businesslayer.ShowPPTChart();

            List<ActivityReportChart> obj = new List<ActivityReportChart>();
            obj = Penna_businesslayer.ShowActivityReportChart();
        ...
        public ActionResult CreatePie()
        {
            ...
            obj = Penna_businesslayer.ShowClientVisitedVideos();
        ...
        public ActionResult SaveCreateSocialMediaData()
        {
            ...
            result = Penna_businesslayer.SaveCreateSocialMeida(Title, ImageUrl, path);

            var social = Penna_businesslayer.GetSocialMediaId();
            ...
            try
            {
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    result = Penna_businesslayer.SaveCreateSocialFileList(file.FileName, SocialMediaId);
                }
            }
            catch (Exception  ex)
            {
        ...
        public ActionResult LoadSocialMediaListData(jQueryDataTableParamModel<SocialMediaGrid> param)
        {
            ...
            try
            {
                ...
                // Getting all Customer data    
                var result = Penna_businesslayer.ShowGridSocialMedia();
        ...
        public JsonResult SaveSocialMediaListData()
        {
            ...
            //result = Penna_businesslayer.SaveSocialMediaListData(SocialMediaID, Title, URL, Filename);
            try
            {
                for (int i = 0; i < files.Count; i++)
                {
                    HttpPostedFileBase file = files[i];
                    file.SaveAs(path + file.FileName);
                    result = Penna_businesslayer.SaveSocialMediaListData(SocialMediaID, Title, URL, file.FileName);
                }
            }
            catch (Exception ex)
            {
        ...
        {
            TempData["showClientMenu"] = null;
            SocialMediaGrid result = Penna_businesslayer.GetSocialById(obj);
        ...
        public ActionResult ViewSocialListDataById(SocialMediaGrid obj)
        {
            ...
            List<SocialMediaGrid> SelectVideonew = Penna_businesslayer.GetSocialListById(obj);
        ...
        public JsonResult DeleteSocialMediaById(SocialMediaGrid obj)
        {
            ...
            result = Penna_businesslayer.DeleteSocialMediaId(obj.SocialMediaID);
        ...
        {
            TempData["showClientMenu"] = null;
            SocialMediaGrid result = Penna_businesslayer.GetSocialLiById(obj);
            List<SocialMediaGrid> SelectVideonew = Penna_businesslayer.GetSocialListById(obj);
            var list = new SelectList(SelectVideonew, "Filename", "Filename");
        ...
        public ActionResult UserSocialMedia()
        {
            ...
            {
                TempData["showClientMenu"] = true;
                socialimag = Penna_businesslayer.Selectsocial();
        ...
        public ActionResult UserPresentation()
        {
            ...
            getpresen = Penna_businesslayer.GetPresentationgetvalues();
        ...
        public ActionResult DownLoadPPT(int pptid, string pptfilename)
        {
            ...
            //obj = Penna_businesslayer.Presentationgetvalues(1);
            ...
            //    result = Penna_businesslayer.UserPresentation(pptfilename);
            //}
        ...
        public JsonResult GetLastUserId()
        {
            ...
            try
            {
                LastUserId = Penna_businesslayer.GetLastUserId();
        ...
        public JsonResult AddUserInformation(UserManagements obj)
        {
            ...
            {
                obj.CreatedBy = Convert.ToString(Session["UserName"]);
                result = Penna_businesslayer.AddUserInformation(obj);
                return Json(new { errorcode = result.ErrorCode, errormessage = result.ErrorMessage }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult LoadUserListData(jQueryDataTableParamModel<ShowPageGrid> param)
        {
            try
            {
                ...
                int recordsTotal = 0;
                // Getting all Customer data    
                var result = Penna_businesslayer.GetUserDetails();
                recordsTotal = result.Count();
                var data = result.ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        {
            TempData["showClientMenu"] = null;
            EditUserDetails result = Penna_businesslayer.GetUserListDataById(obj);
        ...
        public JsonResult SaveUserListData(int UserMasterId, string UserName, string Password, bool Active,string Email,int CustomerTYpe, bool Client)
        {
            ...
            result = Penna_businesslayer.SaveUserListData(UserMasterId, UserName, Password, Active, Convert.ToString(Session["UserName"]), Email, CustomerTYpe, Client);
        ...
        public JsonResult DeleteUserById(int UserMasterId)
        {
            ...
            try
            {
                result = Penna_businesslayer.DeleteUserById(UserMasterId);
        ...
        public ActionResult CRM()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.CRM, "CRM");
        ...
        public JsonResult CRM(CRMEmail crmail)
        {
            ...
            try
            {
                ...
                //List<CRMBulkEmail> obj = Penna_businesslayer.CRMMails(Convert.ToInt32(collection["CustomerSelection"]));
        ...
        public JsonResult GetCRMMail(int id)
        {
            TempData["showClientMenu"] = null;
            string email = "";
            List<CRMBulkEmail> lstBulkEmail = Penna_businesslayer.CRMMails(Convert.ToInt32(id));
        ...
        public ActionResult Reports()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.Reports, "Reports");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Export()
        {
            ...
            if (reporttype == "1")
            {
                if (option == "1")
                {
                    var result = Penna_businesslayer.GetVideoRepId(startdate, enddate);
                ...
                {
                    var result = Penna_businesslayer.GetPPTRepId(startdate, enddate);
        ...
        public ActionResult UserVideo()
        {
            ...
            //obj = Penna_businesslayer.Mediagetvalues(1, Convert.ToString(Session["UserName"]));
            //return View(obj);
            Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.ManageComments, "ManageComments");
            var lstVideoComments = Penna_businesslayer.LoadVideoCommentsListData();


            List<VideoComments> SelectVideo = Penna_businesslayer.GetVideosForComments();
        ...
        public JsonResult SaveVideoComments()
        {
            ...
            if (files.Count > 0)
            {
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    file.SaveAs(path + file.FileName);
                    result = Penna_businesslayer.SaveVideoComments(Convert.ToInt32(VideoId), VideoName, VideoComments, path, false, Convert.ToString(Session["UserId"]),
        ...
        {
            //OutPut result = new OutPut();
            int result = Penna_businesslayer.UpdateVideoViewCount(VideoId, VideoFileName);
        ...
        public JsonResult SaveVideoApprove(string Sno, bool IsApproved)
        {
            ...
            {
                IsApproved = true;
                result = Penna_businesslayer.SaveVideoApprove(Convert.ToInt32(Sno), IsApproved);
                if (result == null)
                {
        ...
        public JsonResult RejectVideoApprove(string Sno, bool IsDeleted)
        {
            ...
            {
                IsDeleted = true;
                result = Penna_businesslayer.RejectVideoApprove(Convert.ToInt32(Sno), IsDeleted);
                if (result == null)
                {
                    return Json(new { errorcode = 0, errormessage = "Success" }, JsonRequestBehavior.AllowGet);
                }
        ...
        public ActionResult LoadVideoCommentsListData(jQueryDataTableParamModel<ShowPageGrid> param)
        {
            try
            {
                ...
                int recordsTotal = 0;
                // Getting all Customer data    
                var result = Penna_businesslayer.LoadVideoCommentsListData();
                recordsTotal = result.Count();
                var data = result.ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        public ActionResult VideoManagement(string PageMenuName = "", int MID = 0)
        {
            TempData["showClientMenu"] = null;
            ViewBag.MyPageName = PageMenuName;
            Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.ManageVideos, "ManageVideos");
            return View();
        }
        public ActionResult LoadVideoListData(jQueryDataTableParamModel<video> param)
        {
            ...
            try
            {
                ...
                // Getting all Customer data    
                var result = Penna_businesslayer.ShowGridVideos();
        ...
        public JsonResult DeleteVideoById(video obj)
        {
            TempData["showClientMenu"] = null;
            OutPut result = new OutPut();
            video medfile = Penna_businesslayer.GetVideoById(obj);
            ...
            result = Penna_businesslayer.DeleteVideo(obj.MediaID);
        ...
        public ActionResult SaveCreateVideoListData(video obj)
        {
            ...
            result = Penna_businesslayer.SaveCreateVideoListData(VideoTitle, VideoDesc, path, name,ext, UserType, Session["UserName"].ToString(), Session["IPAddress"].ToString());

            try
            {
                //var mediaid = Penna_businesslayer.GetVideoId();
                ...
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    //result = Penna_businesslayer.SaveCreateVideoFileList(file.FileName, fileid,false,true);
                }
            }
            catch (Exception ex)
            {
        ...
        public JsonResult SaveVideoListData()
        {
            ...
            result = Penna_businesslayer.SaveVideoListData(VideoId, VideoTitle, VideoDesc, isNewVideo, path, name, ext, ExistingVideoName, UserType, Session["UserName"].ToString(), Session["IPAddress"].ToString());
            //if (files.Count > 0)
            //{
            //   result = Penna_businesslayer.SaveVideoListData(VideoId, VideoTitle, VideoDesc, true);
            //    for (int i = 0; i < files.Count; i++)
            //    {
            //        HttpPostedFileBase file = files[i];
            //        file.SaveAs(path + file.FileName);
            ...
            //                IsResetCount = true;
            //            }
            //            result = Penna_businesslayer.SaveCreateVideoFileList(file.FileName, VideoId, IsResetCount,true);
            //        }
            //        catch (Exception ex)
            //        {
            ...
            //else
            //{
            //    result = Penna_businesslayer.SaveVideoListData(VideoId, VideoTitle, VideoDesc, false);
            //    result = Penna_businesslayer.SaveCreateVideoFileList(ExistingVideoName, VideoId, IsResetCount,false);
            //}
        ...
        {
            TempData["showClientMenu"] = null;
            video result = Penna_businesslayer.GetVideoById(obj);
        ...
        public ActionResult ViewVideoListDataById(video obj)
        {
            ...
            //var dplist = result.Filename.ToList();
            //SelectList list = new SelectList(dplist, "filename", "filename");
            //List<video> SelectVideonew = Penna_businesslayer.GetVideoListById(obj);
        ...
        public ActionResult PPTManagement()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.PPTManagement, "PPT Management");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult LoadPPTListData(jQueryDataTableParamModel<PPT> param)
        {
            ...
            try
            {
                ...
                // Getting all Customer data    
                var result = Penna_businesslayer.ShowGridPpts();
        ...
        public JsonResult DeletePPTById(PPT obj)
        {
            ...
            result = Penna_businesslayer.DeletePPT(obj.MediaID);
        ...
        public ActionResult SaveCreatePPTListData()
        {
            try
            {
                ...
                result = Penna_businesslayer.SaveCreatePPTListData(VideoTitle, VideoDesc, path);

                var mediaid = Penna_businesslayer.GetPPTId();
                var fileid = mediaid.MediaID;
                ...
                for (int i = 0; i < files.Count; i++)
                {
                    ...
                    result = Penna_businesslayer.SaveCreatePPTFileList(filename, fileid);
        ...
        public JsonResult SavePPTListData()
        {
            ...
            result = Penna_businesslayer.SavePPTListData(VideoId, VideoTitle, VideoDesc);

            for (int i = 0; i < files.Count; i++)
            {
                HttpPostedFileBase file = files[i];
                file.SaveAs(path + file.FileName);
                result = Penna_businesslayer.SaveCreatePPTFileList(file.FileName, VideoId);
            }
        ...
        {
            TempData["showClientMenu"] = null;
            PPT result = Penna_businesslayer.GetPPTById(obj);
        ...
        public ActionResult ViewPPTListDataById(PPT obj)
        {
            ...
            //var dplist = result.Filename.ToList();
            //SelectList list = new SelectList(dplist, "filename", "filename");
            List<PPT> SelectVideonew = Penna_businesslayer.GetPPTListById(obj);
            var list = new SelectList(SelectVideonew, "Filename", "Filename");
            //List<System.Web.Mvc.SelectListItem> SelectVideo = new List<System.Web.Mvc.SelectListItem>()
            //{
            //    //new SelectListItem 
        ...
        [HttpGet]
        [Authorize]
        public ActionResult PennaSampleReports(string PageMenuName = "", int MID = 0)
        {
            TempData["showClientMenu"] = null;
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.TaskManagement, "TaskManagement");
            }
            catch (Exception ex)
            {
        ...
        {
            TempData["showClientMenu"] = null;
            Tasks result = Penna_businesslayer.GetTaskById(obj);

            List<UserManagements> SelectVideonew = Penna_businesslayer.GetUserList();
        ...
        public JsonResult SaveTaskListData()
        {
            ...
            result = Penna_businesslayer.SaveTaskListData(TaskTitle, TaskDesc, UserID, Taskid);
        ...
        public JsonResult SaveCreateTaskListData(string TaskName, string TaskDescription, int userid)
        {
            ...
            result = Penna_businesslayer.SaveCreateTaskListData(TaskName, TaskDescription, userid);
        ...
        public JsonResult DeleteTaskById(Tasks obj)
        {
            ...
            result = Penna_businesslayer.DeleteTask(obj.TaskMasterId);
        ...
        public ActionResult LoadTaskListData(jQueryDataTableParamModel<Tasks> param)
        {
            ...
            try
            {
                ...
                var result = Penna_businesslayer.ShowGridTasks();
        ...
        public JsonResult ViewLogHistory(jQueryDataTableParamModel<ViewLogHistory> param)
        {
            ...
            try
            {
                ...
                int recordsTotal = 0;
                // Getting all Customer data    
                var result = Penna_businesslayer.ShowActivityCount();
                recordsTotal = result.Count();
                var data = result.ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        public JsonResult GetViewLogHistoryById(jQueryDataTableParamModel<ShowAllActivity> param, int MenuId)
        {
            ...
            try
            {
                ...
                int recordsTotal = 0;
                // Getting all Customer data    
                var result = Penna_businesslayer.GetViewLogHistoryById(MenuId);
                recordsTotal = result.Count();
                var data = result.ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        public JsonResult SearchMenus(string SearchMenu)
        {
            ...
            try
            {
                if (Convert.ToBoolean( TempData["showClientMenu"])==false || TempData["showClientMenu"]==null )
                {
                    ...
                    lstsearch = Penna_businesslayer.MenuSearch(SearchMenu);
                ...
                else
                {
                    ...
                    lstsearchclient = Penna_businesslayer.MenuSearchForClient(SearchMenu);
        ...
        public ActionResult CRMContact()
        {
            ...
            try
            {
                Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.CRMContact, "CRM Contact");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult DocManagement()
        {
            ...
            try
            {
                 Penna_businesslayer.SaveActivity(Convert.ToString(Session["UserId"]), Convert.ToString(Session["UserName"]), (int)MenusActivity.DocManagement, "Document Management");
            }
            catch (Exception ex)
            {
        ...
        public ActionResult LoadDocListData(jQueryDataTableParamModel<Document> param)
        {
            ...
            try
            {
                ...
                // Getting all Customer data    
                var result = Penna_businesslayer.ShowGridDocs();
        ...
        public JsonResult DeleteDocById(PPT obj)
        {
            ...
            result = Penna_businesslayer.DeleteDoc(obj.MediaID);
        ...
        public ActionResult SaveCreateDocListData()
        {
            ...
            result = Penna_businesslayer.SaveCreateDocListData(VideoTitle, VideoDesc, path);

            var mediaid = Penna_businesslayer.GetDocId();
            var fileid = mediaid.MediaID;
            ...
            for (int i = 0; i < files.Count; i++)
            {
                HttpPostedFileBase file = files[i];
                file.SaveAs(path + file.FileName);
                result = Penna_businesslayer.SaveCreateDocFileList(file.FileName, fileid);
            }
        ...
        public JsonResult SaveDocListData()
        {
            ...
            result = Penna_businesslayer.SaveDocListData(VideoId, VideoTitle, VideoDesc);

            for (int i = 0; i < files.Count; i++)
            {
                HttpPostedFileBase file = files[i];
                file.SaveAs(path + file.FileName);
                result = Penna_businesslayer.SaveCreateDocFileList(file.FileName, VideoId);
            }
        ...
        {
            TempData["showClientMenu"] = null;
            Document result = Penna_businesslayer.GetDocById(obj);
            return View("ViewPPT", result);
        }
        public ActionResult ViewDocListDataById(Document obj)
        {
            ...
            //var dplist = result.Filename.ToList();
            //SelectList list = new SelectList(dplist, "filename", "filename");
            List<Document> SelectVideonew = Penna_businesslayer.GetDocListById(obj);
            var list = new SelectList(SelectVideonew, "Filename", "Filename");
            //List<System.Web.Mvc.SelectListItem> SelectVideo = new List<System.Web.Mvc.SelectListItem>()
            //{
            //    //new SelectListItem 
        ...
        public JsonResult AddCRMContentInformation(CRMContent obj)
        {
            ...
            {
                obj.CreatedBy = Convert.ToString(Session["UserName"]);
                result = Penna_businesslayer.AddCRMContentInformation(obj);
                return Json(new { errorcode = result.ErrorCode, errormessage = result.ErrorMessage }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetCRMLastUserId()
        {
            ...
            try
            {
                LastUserId = Penna_businesslayer.GetCRMLastUserId();
                return Json(LastUserId, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult LoadCRMListData(jQueryDataTableParamModel<ShowPageGrid> param)
        {
            try
            {
                ...
                int recordsTotal = 0;
                // Getting all Customer data    
                var result = Penna_businesslayer.GetCRMUserDetails();
                recordsTotal = result.Count();
                var data = result.ToList();
                return Json(new { draw = draw, recordsFiltered = recordsTotal, recordsTotal = recordsTotal, data = data });
            }
        ...
        {
            TempData["showClientMenu"] = null;
            EditCRMDetails result = Penna_businesslayer.GetCRMListDataById(obj);
        ...
        public JsonResult DeleteCRMById(int UserCustomId)
        {
            ...
            try
            {
                result = Penna_businesslayer.DeleteCRMById(UserCustomId);
        ...
        public ActionResult importbullkcontact(System.Data.DataTable dt)
        {
            ...
            for (int i = 0; i < files.Count; i++)
            {
                HttpPostedFileBase file = files[i];
                file.SaveAs(path + file.FileName);
                //  result = Penna_businesslayer.SaveCreatePPTFileList(file.FileName, fileid);
                ...
                var res = Penna_businesslayer.GetCRMBulkImport(dt);
        ...
        public JsonResult SaveCRMListData(int UserCustomId, string ContactName, string CompanyName, string Email)
        {
            ...
            result = Penna_businesslayer.SaveCRMListData(UserCustomId, ContactName, CompanyName, Email);
        ...
        public ActionResult LoadTaskListDatas(jQueryDataTableParamModel<Tasks> param)
        {
            ...
            try
            {
                ...
                var result = Penna_businesslayer.ShowGridRepTasks(Convert.ToString(Session["UserName"]));
        ...
        public void UpdateVideoCount(int mediaID)
        {
            try
            {
                var result = Penna_businesslayer.UpdateVideoCount(mediaID);
            }
            catch (Exception)
            {
                throw;

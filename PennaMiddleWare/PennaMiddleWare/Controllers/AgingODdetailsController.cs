...
{
    public class AgingODdetailsController : Controller
    {
            ...
            try
            {
                ...
                if (InputID == "I")
                {
                    ...
                    foreach (Schdates scdat in schdt)
                    {
                        ...
                        url = "https://netwaver-prd.pennacement.com/sap/opu/odata/sap/ZFI_AGEING_OD_SRV/OD_DETAILSSet?$format=json&$filter=(Budat eq  '" + scdat.startdate.Trim() + "')";
        ...
        public ActionResult DownloadLogRealization()
        {
            ...
            {
                return RedirectToAction("Index", "AgingODdetails");
            }
        }

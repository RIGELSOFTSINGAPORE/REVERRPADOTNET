...
--
-- Table structure for table `zsd_mw_sales_dis_srv`
--

DROP TABLE IF EXISTS `zsd_mw_sales_dis_srv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `zsd_mw_sales_dis_srv` (
  `zsd_mw_sales_dis_srv_pkid` bigint NOT NULL AUTO_INCREMENT,
  ...
  `ProRata` varchar(10) NOT NULL,
  `PrRrata` varchar(10) NOT NULL,
  `PrRerata` varchar(10) NOT NULL,
  `PltrOndate` varchar(10) NOT NULL,
  `PltrMondate` varchar(10) NOT NULL,
  PRIMARY KEY (`zsd_mw_sales_dis_srv_pkid`)

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DataGridTextBoxColumn6.HeaderText = "メーカーコード"
        ...
        Me.DataGridTextBoxColumn1.HeaderText = "税込合計額"
...
#End Region
    ...
    Sub sql()
        ...
        '請求済み分
        strSQL = "SELECT T20_INVC_MTR.iｎvc_no, T20_INVC_MTR.invc_date, T20_INVC_MTR.rcpt_brch_code"
...
err:
    ...
    Private Sub DataGridEx1_MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGridEx1.MouseUp
        ...
        If hitinfo.Row >= 0 Then
            ...
            End If
            P_F60_3 = DataGridEx1(DataGridEx1.CurrentRowIndex, 0)   'メーカーコード

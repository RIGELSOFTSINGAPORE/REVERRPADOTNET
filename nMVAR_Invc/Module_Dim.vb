Module Module_Dim
    ...
    Public P_F60_0, P_F60_1, P_F60_2, P_F60_3, P_F60_9, P_F60_10 As String
    Public P_F60_4, P_F60_5 As DateTime
    Public P_F60_6, P_F60_7, P_F60_8 As Integer
    Public P_idvd_flg As String


    Public P_PView As String
    ...
    Public P_close_DATE As DateTime     '締め日

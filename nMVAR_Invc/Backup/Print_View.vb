    ...
    Private Sub Print_View_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case P_PView
            ...
            Case Is = "ivc" '請求書
                Select Case P_F60_9
                    Case Is = "02"  'ラオックス
                        Dim rpt As New R_Invc_LAOX
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    Case Is = "03"  'パナソニック
                        Dim rpt As New R_Invc_Pana
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    Case Is = "04"  'ケーズデンキ
                        Dim rpt As New R_Invc_Ks
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    Case Is = "05"  'コジマ
                        Dim rpt As New R_Invc_Kojima
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    Case Else   '通常
                        Dim rpt As New R_Invc_Normal
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
            ...
            Case Is = "DTL" '請求明細
                Select Case P_F60_10
                    Case Is = "02"  '汎用2
                        Dim rpt As New R_Invc_Dtl_Normal2
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Is = "03"  'ジョーシンサービス
                        Dim rpt As New R_Invc_Dtl_Joshin
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Is = "05"  'デオデオ
                        Dim rpt As New R_Invc_Dtl_Deodeo
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Is = "06"  'ベスト電器
                        Dim rpt As New R_Invc_Dtl_Best
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Is = "07"  'ヨドバシカメラ
                        Dim rpt As New R_Invc_Dtl_Yodo
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Is = "08"  'コジマ
                        Dim rpt As New R_Invc_Dtl_Kojima
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Is = "09"  '汎用3
                        Dim rpt As New R_Invc_Dtl_Normal3
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)
                    ...
                    Case Else       '汎用
                        Dim rpt As New R_Invc_Dtl_Normal
                        rpt.DataSource = P_DsPRT
                        rpt.DataMember = "prt"
                        Viewer1.Document = rpt.Document
                        rpt.Run(False)

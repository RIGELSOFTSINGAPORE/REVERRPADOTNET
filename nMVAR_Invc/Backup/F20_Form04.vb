...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F20_Form04))
        ...
        Me.CL002.Location = New System.Drawing.Point(603, 0)
        Me.CL002.Name = "CL002"
        Me.CL002.Size = New System.Drawing.Size(52, 16)
        Me.CL002.TabIndex = 1856
        Me.CL002.Text = "CL002"
        ...
        Me.Combo002.Location = New System.Drawing.Point(447, 14)
        ...
        Me.kengen.Location = New System.Drawing.Point(15, 550)
        Me.kengen.Name = "kengen"
        Me.kengen.Size = New System.Drawing.Size(52, 16)
        Me.kengen.TabIndex = 1854
        ...
        Me.CL001.Location = New System.Drawing.Point(271, 0)
        Me.CL001.Name = "CL001"
        Me.CL001.Size = New System.Drawing.Size(52, 16)
        Me.CL001.TabIndex = 1853
        Me.CL001.Text = "CL001"
        ...
        Me.Combo001.Location = New System.Drawing.Point(115, 14)
        ...
        Me.Label1.TabIndex = 1852
        Me.Label1.Text = "拠点"
        Me.Label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter
        '
        'CheckBox2
        '
        Me.CheckBox2.Location = New System.Drawing.Point(816, 0)
        Me.CheckBox2.Name = "CheckBox2"
        Me.CheckBox2.Size = New System.Drawing.Size(24, 16)
        Me.CheckBox2.TabIndex = 1851
        ...
        Me.CheckBox1.Location = New System.Drawing.Point(844, 0)
        Me.CheckBox1.Name = "CheckBox1"
        Me.CheckBox1.Size = New System.Drawing.Size(24, 16)
        Me.CheckBox1.TabIndex = 1850
        ...
        Me.DataGridEx1.Location = New System.Drawing.Point(15, 46)
        Me.DataGridEx1.Name = "DataGridEx1"
        Me.DataGridEx1.ReadOnly = True
        Me.DataGridEx1.Size = New System.Drawing.Size(869, 500)
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridBoolColumn3, Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridTextBoxColumn6})
        ...
        Me.DataGridTextBoxColumn1.HeaderText = "拠点"
        Me.DataGridTextBoxColumn1.MappingName = "rcpt_brch_name"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "販社"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "請求日"
        Me.DataGridTextBoxColumn3.MappingName = "invc_date"
        ...
        Me.DataGridTextBoxColumn4.MappingName = "iｎvc_no"
        ...
        Me.DataGridTextBoxColumn5.HeaderText = "請求件数"
        Me.DataGridTextBoxColumn5.MappingName = "cnt"
        ...
        Me.DataGridTextBoxColumn6.HeaderText = "請求金額"
        Me.DataGridTextBoxColumn6.MappingName = "ttl_amnt"
        ...
        Me.Button98.Location = New System.Drawing.Point(808, 568)
        ...
        Me.Button2.Location = New System.Drawing.Point(11, 570)
        ...
        Me.msg.Location = New System.Drawing.Point(87, 574)
        Me.msg.Name = "msg"
        Me.msg.Size = New System.Drawing.Size(585, 16)
        ...
        Me.Date001.Location = New System.Drawing.Point(764, 16)
        ...
        Me.Label007.Location = New System.Drawing.Point(684, 16)
        Me.Label007.Name = "Label007"
        Me.Label007.Size = New System.Drawing.Size(80, 20)
        Me.Label007.TabIndex = 1858
        ...
        Me.Button8.Location = New System.Drawing.Point(700, 568)
        ...
        Me.ClientSize = New System.Drawing.Size(898, 604)
...
#End Region
    ...
    '**  起動時
    '********************************************************************
    Private Sub 請求取消_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inz()       '**  初期処理
        ACES()      '**  権限チェック
        CmbSet()
        DspSet()    '**  画面セット
    ...
    Sub CmbSet()
        ...
        '販社グループ
        strSQL = "SELECT M08_STORE.grup_code, M08_STORE.grup_code + ':' + V_cls_006.cls_code_name AS grup_name"
        strSQL = strSQL & " FROM T20_INVC_MTR INNER JOIN"
        strSQL = strSQL & " M08_STORE ON T20_INVC_MTR.invc_code = M08_STORE.store_code INNER JOIN"
        strSQL = strSQL & " V_cls_006 ON M08_STORE.grup_code = V_cls_006.cls_code LEFT OUTER JOIN"
        strSQL = strSQL & " T30_CLCT ON T20_INVC_MTR.iｎvc_no = T30_CLCT.iｎvc_no"
        strSQL = strSQL & " WHERE (T20_INVC_MTR.cls = '1') AND (T30_CLCT.iｎvc_no IS NULL)"
        strSQL = strSQL & " GROUP BY M08_STORE.grup_code, M08_STORE.grup_code + ':' + V_cls_006.cls_code_name"
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN("nMVAR")
    ...
    Sub sql()
        If inz_F = "1" Then
            ...
            strSQL = strSQL & ", T20_INVC_MTR.tax, T20_INVC_MTR.ttl_amnt, T20_INVC_MTR.invc_code, M08_STORE.name AS invc_name"
            strSQL = strSQL & " FROM T20_INVC_MTR INNER JOIN"
            strSQL = strSQL & " M03_BRCH ON T20_INVC_MTR.rcpt_brch_code = M03_BRCH.brch_code INNER JOIN"
            strSQL = strSQL & " M08_STORE ON T20_INVC_MTR.invc_code = M08_STORE.store_code LEFT OUTER JOIN"
            ...
            If Date001.Number <> 0 Then
                ...
                strSQL = strSQL & " AND (T20_INVC_MTR.invc_date >= CONVERT(DATETIME, '" & WK_date & "', 102))"
            End If
            strSQL = strSQL & " ORDER BY T20_INVC_MTR.rcpt_brch_code, T20_INVC_MTR.invc_code, T20_INVC_MTR.invc_date"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN("nMVAR")
    ...
    Private Sub DataGrid1_CmdKeyEvent(ByVal keyData As System.Windows.Forms.Keys, ByRef Cancel As Boolean) Handles DataGridEx1.CmdKeyEvent
        If DataGridEx1.CurrentRowIndex <= DtView1.Count - 1 Then
            Select Case keyData
                Case Is = Keys.Return
                Case Is = Keys.Space
                    WK_DtView1 = New DataView(DsList1.Tables("scan"), "iｎvc_no =" & DataGridEx1(DataGridEx1.CurrentRowIndex, 4), "", DataViewRowState.CurrentRows)
                    If DataGridEx1(DataGridEx1.CurrentRowIndex, 0) = "False" Then
                        For i = 0 To WK_DtView1.Count - 1
                            WK_DtView1(i)("ck") = "True"
                        Next
                    Else
                        For i = 0 To WK_DtView1.Count - 1
                            WK_DtView1(i)("ck") = "False"
                        Next
                    End If
                Case Is = Keys.Delete
                Case Is = Keys.Right
        ...
        Else
            ...
            For i = 0 To WK_DtView1.Count - 1
                ...
                For j = 0 To WK_DtView2.Count - 1
                    strSQL = "UPDATE T10_SALS SET invc_flg = 0, invc_cls_date = NULL WHERE (rcpt_no = '" & WK_DtView2(j)("rcpt_no") & "') AND (cls = '1')"
                    SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                    SqlCmd1.ExecuteNonQuery()
                Next

                '検収確定戻し
                strSQL = "DELETE FROM L06_kensyu"
                strSQL = strSQL & " WHERE (invc_date = CONVERT(DATETIME, '" & WK_DtView1(i)("invc_date") & "', 102))"
                ...
                strSQL = strSQL & ", " & WK_DtView1(i)("cnt") & ")"
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.ExecuteNonQuery()
    ...
    Private Sub DataGridEx1_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridEx1.LostFocus
        fcs = "0"
    End Sub
End Class

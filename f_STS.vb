Public Class f_STS
    ...
    Dim i, j, en, line_no, r As Integer
...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(f_STS))
        ...
        Me.Button2.Location = New System.Drawing.Point(264, 440)
        ...
        Me.Panel1.Size = New System.Drawing.Size(352, 328)
        ...
        Me.Date1.Location = New System.Drawing.Point(208, 8)
        Me.Date1.Name = "Date1"
        ...
        Me.Button1.Location = New System.Drawing.Point(24, 440)
        ...
        'Combo1
        '
        Me.Combo1.Location = New System.Drawing.Point(80, 8)
        ...
        Me.Combo1.Size = New System.Drawing.Size(112, 24)
        ...
        Me.Combo1.TextHAlign = GrapeCity.Win.Input.Interop.AlignHorizontal.Center
...
#End Region
    ...
    Sub cmb_set()
        '変更日
        DsCMB.Clear()
        strSQL = "SELECT CONVERT(CHAR(10), UPD_DATE, 111) AS UPD_DATE"
        strSQL += " FROM STTS_F_UPD"
        strSQL += " WHERE (UPD_F IS NULL)"
        strSQL += " GROUP BY CONVERT(CHAR(10), UPD_DATE, 111)"
        strSQL += " ORDER BY CONVERT(CHAR(10), UPD_DATE, 111)"
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN()
        r = DaList1.Fill(DsCMB, "STTS_F_UPD")
        DB_CLOSE()

        Combo1.DataSource = DsCMB.Tables("STTS_F_UPD")
        Combo1.DisplayMember = "UPD_DATE"
        Combo1.ValueMember = "UPD_DATE"
        If r = 0 Then Combo1.Text = Nothing
    ...
    Sub pnl_Set()
        ...
        strSQL += " FROM STTS_F_UPD"
        strSQL += " WHERE (UPD_DATE >= CONVERT(DATETIME, '" & Combo1.Text & "', 102)"
        strSQL += " AND UPD_DATE < CONVERT(DATETIME, '" & DateAdd(DateInterval.Day, 1, CDate(Combo1.Text)) & "', 102))"
        strSQL += " AND (UPD_F IS NULL)"
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN()
        ...
        If DtView1.Count <> 0 Then
            For i = 0 To DtView1.Count - 1
                ...
                label(i, en).Text = Mid(DtView1(i)("WRN_NO"), 1, 4) & " " & Mid(DtView1(i)("WRN_NO"), 5, 3) & " " & Mid(DtView1(i)("WRN_NO"), 8, 3) & " " & Mid(DtView1(i)("WRN_NO"), 11, 3) & " " & Mid(DtView1(i)("WRN_NO"), 14, 4)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For j = 0 To i - 1
            ...
            If UPD_F <> "" Then
                ...
                strSQL += " SET UPD_DATE1 = CONVERT(DATETIME, '" & Now & "', 102)"
                strSQL += ", UPD_F = '" & UPD_F & "'"
                strSQL += " WHERE (WRN_NO = '" & label(j, 1).Text & "')"
                strSQL += " AND (UPD_DATE = CONVERT(DATETIME, '" & label(j, 2).Text & "', 102))"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)

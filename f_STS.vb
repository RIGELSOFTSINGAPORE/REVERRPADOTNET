...
#End Region
    ...
    Sub cmb_set()
        ...
        strSQL = strSQL & " GROUP BY CONVERT(CHAR(10), UPD_DATE, 111)"
        strSQL = strSQL & " ORDER BY CONVERT(CHAR(10), UPD_DATE, 111)"
        strSQL = strSQL & ""
        strSQL = strSQL & ""
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN()
        DaList1.Fill(DsCMB, "STTS_F_UPD")
        DB_CLOSE()
    ...
    Sub pnl_Set()
        ...
        strSQL = strSQL & " WHERE (UPD_DATE >= CONVERT(DATETIME, '" & Combo1.Text & "', 102)"
        strSQL = strSQL & " AND UPD_DATE < CONVERT(DATETIME, '" & DateAdd(DateInterval.Day, 1, CDate(Combo1.Text)) & "', 102))"

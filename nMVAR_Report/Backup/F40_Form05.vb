...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F40_Form05))
        ...
        Me.Button98.Location = New System.Drawing.Point(288, 92)
        ...
        Me.msg.Location = New System.Drawing.Point(28, 64)
        Me.msg.Name = "msg"
        ...
        Me.ClientSize = New System.Drawing.Size(378, 132)
...
#End Region
    ...
    '**  起動時
    '********************************************************************
    Private Sub F40_Form05_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inz()       '**  初期処理
    End Sub
    ...
    Sub F_Check()
        ...
        'DataTable作成()
        DsList1.Clear()
        SqlCmd1 = New SqlClient.SqlCommand("sp_F40_05", cnsqlclient)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            ...
            sfd.FileName = "受付明細" & Format(CDate(Date1.Text), "yyyyMMdd") & "_" & Format(CDate(Date2.Text), "yyyyMMdd") & ".CSV" 'はじめのファイル名を指定する
                            ...
                            Select Case j
                                ...
                                Case Is = 7
                                    ...
                                    Else
                                        ...
                                        WK_AMT3 = WK_AMT3 + WK_DtView1(j)("cost_chrg") * WK_DtView1(j)("use_qty")

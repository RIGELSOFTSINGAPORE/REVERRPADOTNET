Module Module_Dim
    ...
    'Public P_EMPL_BRCH_moto, P_EMPL_BRCH_name_moto As String    'LogIn User情報

    Public P_PC_NAME As String  'ローカルＰＣ名
    Public P_PC_NAME2 As String
    Public P_comp_code, P_area_code As String
    Public P_ACES_brch_code, P_ACES_brch_name, P_ACES_post_code As String    '権限
    ...
    Public P_keika As Integer           '経過日数用
    Public P_rpar_cls As String

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F05_Form07))
        ...
        Me.DataGridTextBoxColumn1.HeaderText = "クラスコード"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "クラス名"
        ...
        Me.DataGrid1.Location = New System.Drawing.Point(8, 68)
        Me.DataGrid1.Name = "DataGrid1"
        Me.DataGrid1.ReadOnly = True
        Me.DataGrid1.RowHeaderWidth = 10
        Me.DataGrid1.Size = New System.Drawing.Size(636, 520)
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridBoolColumn1, Me.DataGridTextBoxColumn3})
        Me.DataGridTableStyle1.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridTableStyle1.MappingName = "cls_mtr"
        '
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "料金区分"
        Me.DataGridTextBoxColumn3.MappingName = "fee_kbn"
        ...
        Me.ClientSize = New System.Drawing.Size(654, 633)
...
#End Region
    ...
    '** 起動時
    '******************************************************************
    Private Sub F05_Form07_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call inz()      '** 初期処理
    ...
    Private Sub DataGrid1_MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGrid1.MouseUp
        ...
        Try
            ...
            If hitinfo.Row >= 0 Then
                ...
                P_PRAM4 = ComboBox1.Text
                P_PRAM5 = ComboBox2.Text

                Dim F05_Form07_2 As New F05_Form07_2
                F05_Form07_2.ShowDialog()
                ...
                If P_RTN = "1" Then '**  画面セット
                    ...
                    DaList1.SelectCommand = SqlCmd1
                    DB_OPEN()
                    DaList1.Fill(WK_DsList1, "cls_mtr")
                    DB_CLOSE()
                    WK_DtView1 = New DataView(WK_DsList1.Tables("cls_mtr"), "cls_code = '" & P_PRAM3 & "'", "", DataViewRowState.CurrentRows)
                    DtView1 = New DataView(DsList1.Tables("cls_mtr"), "cls_code = '" & P_PRAM3 & "'", "", DataViewRowState.CurrentRows)

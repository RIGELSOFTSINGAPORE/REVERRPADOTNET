...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F05_Form05_2))
        ...
        'Label001
        '
        Me.Label001.Location = New System.Drawing.Point(496, 4)
        ...
        Me.Label51.Location = New System.Drawing.Point(408, 4)
        ...
        Me.CheckBox001.Location = New System.Drawing.Point(136, 76)
        Me.CheckBox001.Name = "CheckBox001"
        Me.CheckBox001.Size = New System.Drawing.Size(48, 24)
        Me.CheckBox001.TabIndex = 1217
        '
        'Label52
        '
        ...
        Me.Label52.Location = New System.Drawing.Point(12, 76)
        ...
        Me.msg.Location = New System.Drawing.Point(4, 108)
        Me.msg.Name = "msg"
        ...
        Me.Button98.Location = New System.Drawing.Point(524, 144)
        Me.Button98.Name = "Button98"
        Me.Button98.Size = New System.Drawing.Size(76, 28)
        Me.Button98.TabIndex = 1219
        Me.Button98.Text = "戻る"
        '
        'Edit03
        '
...
#End Region
    ...
    '** 起動時
    '******************************************************************
    Private Sub F05_Form05_2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call inz()      '** 初期処理
        Call dsp_set()  '** 画面セット
    End Sub
    ...
    Sub dsp_set()
        ...
        Else                        '修正
            ...
            strSQL = "SELECT * FROM section_mtr WHERE (section_code = '" & P_PRAM1 & "')"
            ...
            DtView1 = New DataView(DsList1.Tables("section_mtr"), "", "", DataViewRowState.CurrentRows)
            Edit02.Text = DtView1(0)("section_code")
            Edit03.Text = DtView1(0)("section_name")
    ...
    Sub CHK_Edit02()        '部門コード
        msg.Text = Nothing

        Edit02.Text = Trim(Edit02.Text)
        If Edit02.Text = Nothing Then
            Edit02.BackColor = System.Drawing.Color.Red
            msg.Text = "部門コードが入力されていません。"
            Exit Sub
        Else
            WK_DsList1.Clear()
            strSQL = "SELECT * FROM section_mtr WHERE (section_code = '" & Edit02.Text & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            ...
            If P_PRAM1 = Nothing Then   '新規
                ...
                strSQL = "INSERT INTO section_mtr"
                strSQL = strSQL & " (section_code, section_name, reg_date, delt_flg)"
            ...
            Else                        '修正
                ...
                strSQL = "UPDATE section_mtr"
                strSQL = strSQL & " SET section_name = '" & Edit03.Text & "'"

Module Module_Sub
    ...
    '**  税込金額から税抜金額を算出
    '********************************************************************
    Public Function GetNoTaxPrchPrice(ByVal prchPrice As Decimal, ByVal targetDate As String) As Decimal

        Dim taxRate As Decimal
        Dim newTaxStartDate As String = "2019/10/01"
        ...
        Return RoundDOWN(prchPrice / (1 + taxRate), 0)

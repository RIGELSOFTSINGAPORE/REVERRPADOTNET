...
#End Region
    ...
    Private Sub Form3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        DsList1.Clear()
        strSQL = "SELECT * FROM Memo WHERE (wrn_no = '" & P_PRAM1 & "')"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If DtView1.Count <> 0 Then
            If Trim(Edit1.Text) = Nothing Then
                strSQL = "DELETE FROM Memo WHERE (wrn_no = '" & P_PRAM1 & "')"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.CommandTimeout = 600
            ...
            Else
                ...
                strSQL = strSQL & " WHERE (wrn_no = '" & P_PRAM1 & "')"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.CommandTimeout = 600
                SqlCmd1.ExecuteNonQuery()
        ...
        Else
            If Trim(Edit1.Text) = Nothing Then
                p_rtn = "0"
            Else
                strSQL = "INSERT INTO Memo (wrn_no, memo)"
                strSQL = strSQL & " VALUES ('" & P_PRAM1 & "', '" & Trim(Edit1.Text) & "')"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.CommandTimeout = 600
                SqlCmd1.ExecuteNonQuery()

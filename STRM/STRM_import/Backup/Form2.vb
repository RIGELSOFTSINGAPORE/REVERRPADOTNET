...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Date1.MaxDate = New GrapeCity.Win.Input.DateTimeEx(New Date(2020, 12, 31, 23, 59, 59, 0))
        ...
        Me.Date1.Value = New GrapeCity.Win.Input.DateTimeEx(New Date(2012, 10, 15, 11, 8, 44, 0))
        '
        'Label2
        '

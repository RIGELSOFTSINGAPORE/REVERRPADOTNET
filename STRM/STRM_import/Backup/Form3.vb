        ...
        If DtView1.Count <> 0 Then
            ...
            If WK_comp = "4" Then   'Laox
                For i = 0 To DtView1.Count - 1
                    ...
                    strDat2(j, 3) = StrConv(DtView1(i)("model_name"), VbStrConv.Narrow)
...
ErrorHandler:
    ...
    Sub STRM_kakunin()
        ...
        strSQL += " AND (txt_data.prch_price_tax > '100000')"
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN()
        DaList1.Fill(WK_DsList1, "PC1")
        ...
        If DtView1.Count <> 0 Then
            ...
            For i = 0 To DtView1.Count - 1
                ...
                If DtView1(i)("CLS_CODE_NAME") = "PC" _
                    And DtView1(i)("prch_price_tax") <= 100000 Then
                    If WK_comp = "4" Then
            ...
            For i = 0 To DtView1.Count - 1
                ...
                If Not IsDBNull(DtView1(i)("CLS_CODE_NAME")) Then
                    Select Case DtView1(i)("CLS_CODE_NAME")
                        Case Is = "PC"
                            If DtView1(i)("prch_price_tax") <= 100000 Then
                                strDat2(j, 18) = "1"
                            Else
                                strDat2(j, 18) = "2"
                            End If

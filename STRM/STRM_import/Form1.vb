...
#End Region
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        For j = 0 To DtView1.Count - 1
            ...
            '2021/02/04 As per Otsuki San comment Below code 大槻さんのコメントによると以下のコード VJ
            '2015/08/13 電動工具保証追加対応 Start
            'Select Case wk_plan
            '    Case Is = "10" '家電保証
            ...
            '2021/02/04 As per Otsuki San New code Below 大槻さんによる新しいコード以下 VJ
            '2015/08/13 電動工具保証追加対応 Start
            Select Case wk_plan
                Case Is = "10" '家電保証
                    If CInt(DtView1(j)("prch_price_tax")) >= 11000 Then     '税別販売価格11,000円以上の家電製品
                        Select Case DtView1(j)("item_cat_code")
                            'PC
                            Case Is = "101020", "101030", "101035", "101040", "101050", "102020", "102030", "102040", "102050", "102070", "103010", "103020", "108010"
                                If CInt(DtView1(j)("prch_price_tax")) > 110000 Then                     'A1 税別販売価格100,000円超のPC
                                    sokatsu_kbn = "11" 'PC11万円超
                                    wrn_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.05, 0)          '販売保証料（税込）
                                    commission_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.015, 0)  '販売手数料（税込）
                                    admin_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.015, 0)       '事務委託料（税込）
                                Else                                                                    'A2 税別販売価格100,000以下のPC
                                    sokatsu_kbn = "12" 'PC11万円以下
                                    wrn_fee_wtax = 5500         '販売保証料（税込）
                                    commission_fee_wtax = 1650  '販売手数料（税込）
                                    admin_fee_wtax = 1650       '事務委託料（税込）
                                End If
                                'プリンタ
                            Case Is = "301015", "301020", "301030", "301035", "301040", "301045"        'A3 プリンター、ヘッドホン、ヘッドホンアンプ、レーダー探知機、ドライブレコーダー、ETC、ゲーム機
                                sokatsu_kbn = "13" 'プリンタ
                                wrn_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.05, 0)          '販売保証料（税込）
                                commission_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.015, 0)  '販売手数料（税込）
                                admin_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.015, 0)       '事務委託料（税込）
                            Case Else                                                                   'A4 上記以外の家電製品'A5 国産腕時計
                                sokatsu_kbn = "21" '5年保証
                                wrn_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.05, 0)          '販売保証料（税込）
                                commission_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.015, 0)  '販売手数料（税込）
                                admin_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.015, 0)       '事務委託料（税込）
                    ...
                    Else                                                    '税別販売価格11,000円未満の家電製品
                        Select Case DtView1(j)("item_cat_code")
                            'プリンタ
                            Case Is = "301015", "301020", "301030", "301035", "301040", "301045", "706800"  'A6 プリンター、ヘッドホン、ヘッドホンアンプ、レーダー探知機、ドライブレコーダー、ETC、ゲーム機
                                sokatsu_kbn = "13" 'プリンタ
                                wrn_fee_wtax = 550         '販売保証料（税込）
                                commission_fee_wtax = 165  '販売手数料（税込）
                                admin_fee_wtax = 165       '事務委託料（税込）
                                '国産腕時計
                            Case Else                                                                   'A7 上記以外の家電製品'A8 国産腕時計
                                sokatsu_kbn = "21" '5年保証
                                wrn_fee_wtax = 550         '販売保証料（税込）
                                commission_fee_wtax = 165  '販売手数料（税込）
                                admin_fee_wtax = 165       '事務委託料（税込）
                ...
                Case Is = "20" '工具保証
                    If CInt(DtView1(j)("prch_price_tax")) > 16500 Then                                  'B1 税別販売価格15,000円超の電動工具
                        sokatsu_kbn = "31" '工具16500円超
                        wrn_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.1, 0)           '販売保証料（税込）
                        commission_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.02, 0)   '販売手数料（税込）
                        admin_fee_wtax = RoundDOWN(CInt(DtView1(j)("prch_price_tax")) * 0.02, 0)        '事務委託料（税込）

                    Else                                                                                'B2 税別販売価格15,000円以下の電動工具
                        sokatsu_kbn = "32" '工具16500円以下
                        wrn_fee_wtax = 1650         '販売保証料（税込）
                        commission_fee_wtax = 330  '販売手数料（税込）
                        admin_fee_wtax = 330       '事務委託料（税込）
                    End If

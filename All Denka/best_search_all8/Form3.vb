...
#End Region
    ...
    Private Sub Form3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSQL = "SELECT * FROM All8_Memo WHERE (ordr_no = '" & p_ordr_no & "')"
        ...
        DtView1 = New DataView(DsList1.Tables("All8_Memo"), "", "", DataViewRowState.CurrentRows)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If DtView1.Count <> 0 Then
            If Trim(Edit1.Text) = Nothing Then
                strSQL = "DELETE FROM All8_Memo WHERE (ordr_no = '" & p_ordr_no & "')"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.CommandTimeout = 600
                ...
                p_rtn = "0"
            Else
                strSQL = "UPDATE All8_Memo"
                strSQL +=  " SET memo = '" & Trim(Edit1.Text) & "'"
                strSQL +=  " WHERE (ordr_no = '" & p_ordr_no & "')"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.CommandTimeout = 600
                SqlCmd1.ExecuteNonQuery()
        ...
        Else
            If Trim(Edit1.Text) = Nothing Then
                p_rtn = "0"
            Else
                strSQL = "INSERT INTO All8_Memo (ordr_no, memo)"
                strSQL +=  " VALUES ('" & p_ordr_no & "', '" & Trim(Edit1.Text) & "')"
                DB_OPEN()
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                SqlCmd1.CommandTimeout = 600
                SqlCmd1.ExecuteNonQuery()

	...
	*/
	...
	function renderNode(node){
		...
		if(node.isLeaf() && !TreeUtil.getProperty(node.getOptions(), "forceParent", false)){
			...
			//alert(icon);
			//alert(TreeConfig.leaf_icon);
			//alert(TreeConfig.leaf_icon.replace("Folders/Index/", ""));
			if(icon != ""){
			...
			//if (lan == "en") {
			//	span_desc.innerHTML = ret + node.toString() + '&nbsp;&nbsp;&nbsp;&nbsp;<a class ="test">Edit</a></span>';
			//}
			//else {
			//	span_desc.innerHTML = ret + node.toString() + '&nbsp;&nbsp;&nbsp;&nbsp;<a class ="test">編集</a></span>';
			//} 
			span_desc.innerHTML = '<a class ="test">' + ret + node.toString() + '</a></span>';
			...
			var icon = TreeUtil.getProperty(node.getOptions(), "icon", "");
			//alert(icon);
			//alert(TreeConfig.parent_icon);
			//alert(TreeConfig.parent_icon.replace("Folders/Index/", ""));
			if(icon != ""){
				ret += '<span class="tj_icon">' + icon + '</span>';
...
var urlorgin = window.location.href.replace(window.location.origin, "");
var urllocate = urlorgin.substr(0, urlorgin.indexOf('/Folders'));
var FiUrlclose = urllocate + "/img/folder-close1.png";
var FiUrlopen = urllocate + "/img/folder-open1.png";

const TreeUtil = {
	default_leaf_icon: "<span><img src=" + FiUrlclose + " ></span>",
	default_parent_icon: "<span><img src=" + FiUrlopen + " ></span>",
	//default_leaf_icon: "<span><img src='img/folder-close1.png' ></span>",
	//default_parent_icon: "<span><img src='img/folder-open1.png' ></span>",
	default_open_icon: "",
	default_close_icon: "",

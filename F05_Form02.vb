...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F05_Form02))
        ...
        Me.DataGridTextBoxColumn1.HeaderText = "メーカーコード"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "メーカー名（漢字）"
        ...
        Me.DataGridTextBoxColumn3.HeaderText = "メーカー名（カナ）"
        Me.DataGridTextBoxColumn3.MappingName = "vdr_name_kana"
        Me.DataGridTextBoxColumn3.Width = 370
        '
        'DataGridBoolColumn1
        '
...
#End Region
    ...
    '** 起動時
    '******************************************************************
    Private Sub F05_Form02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call inz()      '** 初期処理

        DsList1.Clear()
        SqlCmd1 = New SqlClient.SqlCommand("sp_vdr_mtr", cnsqlclient)
    ...
    Private Sub DataGrid1_MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles DataGrid1.MouseUp
        ...
        Try
            ...
            If hitinfo.Row >= 0 Then
                ...
                Dim F05_Form02_2 As New F05_Form02_2
                F05_Form02_2.ShowDialog()
                ...
                If P_RTN = "1" Then '**  画面セット
                    ...
                    DaList1.SelectCommand = SqlCmd1
                    DB_OPEN()
                    DaList1.Fill(WK_DsList1, "vdr_mtr")
                    DB_CLOSE()
                    WK_DtView1 = New DataView(WK_DsList1.Tables("vdr_mtr"), "vdr_code = '" & P_PRAM1 & "'", "", DataViewRowState.CurrentRows)
                    DtView1 = New DataView(DsList1.Tables("vdr_mtr"), "vdr_code = '" & P_PRAM1 & "'", "", DataViewRowState.CurrentRows)

                    DtView1(0)("vdr_name") = WK_DtView1(0)("vdr_name")
                    DtView1(0)("vdr_name_kana") = WK_DtView1(0)("vdr_name_kana")

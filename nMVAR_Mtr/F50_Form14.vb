Public Class F50_Form14
    ...
    Private dateBox(99, 2) As GrapeCity.Win.Input.Interop.Date
...
#End Region
    ...
    Sub add_line(ByVal flg)
        ...
        en = 1
        dateBox(Line_No, en) = New GrapeCity.Win.Input.Interop.Date
        dateBox(Line_No, en).DisplayFormat = New GrapeCity.Win.Input.Interop.DateDisplayFormat("yyyy/MM/dd", "", "")
        dateBox(Line_No, en).DropDown = New GrapeCity.Win.Input.Interop.DropDown(GrapeCity.Win.Input.Interop.ButtonPosition.Inside, True, GrapeCity.Win.Input.Interop.Visibility.NotShown, System.Windows.Forms.FlatStyle.System)
        dateBox(Line_No, en).Format = New GrapeCity.Win.Input.Interop.DateFormat("yyyy/MM/dd", "", "")
        dateBox(Line_No, en).Location = New System.Drawing.Point(1, 25 * Line_No + label(0, 0).Location.Y)
        dateBox(Line_No, en).MaxDate = New GrapeCity.Win.Input.Interop.DateTimeEx(New Date(2020, 12, 31, 23, 59, 59, 0))
        dateBox(Line_No, en).MinDate = New GrapeCity.Win.Input.Interop.DateTimeEx(New Date(2000, 1, 1, 0, 0, 0, 0))
        dateBox(Line_No, en).HighlightText = GrapeCity.Win.Input.Interop.HighlightText.All
        dateBox(Line_No, en).Size = New System.Drawing.Size(100, 25)
        dateBox(Line_No, en).Spin = New GrapeCity.Win.Input.Interop.Spin(0, 1, True, True, GrapeCity.Win.Input.Interop.ButtonPosition.Inside, False, GrapeCity.Win.Input.Interop.Visibility.NotShown, System.Windows.Forms.FlatStyle.System)
        dateBox(Line_No, en).TextHAlign = GrapeCity.Win.Input.Interop.AlignHorizontal.Center
    ...
    Private Sub dateBox1_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim Lin As GrapeCity.Win.Input.Interop.Date
        Lin = DirectCast(sender, GrapeCity.Win.Input.Interop.Date)

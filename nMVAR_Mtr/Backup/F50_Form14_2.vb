...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Date1.Value = New GrapeCity.Win.Input.DateTimeEx(New Date(2008, 7, 28, 16, 47, 50, 0))
        '
        'Date2
        '
        ...
        Me.Date2.Value = New GrapeCity.Win.Input.DateTimeEx(New Date(2008, 7, 28, 16, 47, 50, 0))
        '
        'Label4
        '

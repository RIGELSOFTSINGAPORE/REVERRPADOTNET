...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F50_Form15))
        ...
        Me.Button98.Location = New System.Drawing.Point(564, 648)
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridBoolColumn1})
        Me.DataGridTableStyle1.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridTableStyle1.MappingName = "M43_AP_M_NO"
        ...
        Me.DataGrid1.Size = New System.Drawing.Size(620, 636)
        ...
        Me.DataGridTextBoxColumn1.HeaderText = "モデル"
        Me.DataGridTextBoxColumn1.MappingName = "model_2"
        ...
        Me.DataGridTextBoxColumn2.HeaderText = "機種"
        Me.DataGridTextBoxColumn2.MappingName = "model_1"
        ...
        Me.ClientSize = New System.Drawing.Size(658, 688)
...
#End Region
    ...
    Sub DspSet()
        ...
        'ｱｯﾌﾟﾙ製造番号表
        SqlCmd1 = New SqlClient.SqlCommand("sp_M43_AP_M_NO", cnsqlclient)
        SqlCmd1.CommandType = CommandType.StoredProcedure
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN("nMVAR")
        SqlCmd1.CommandTimeout = 600
        ...
        tbl = DsList1.Tables("M43_AP_M_NO")
        ...
        If DataGrid1.CurrentRowIndex <= DtView1.Count - 1 Then
            Select Case keyData
                Case Is = Keys.Return
                    ...
                    Dim F50_Form15_2 As New F50_Form15_2
                    F50_Form15_2.ShowDialog()
                    If P_RTN = "1" Then '**  画面セット
                        ...
                        DtView1 = New DataView(WK_DsList1.Tables("M43_AP_M_NO"), "ID = " & P_PRAM1, "", DataViewRowState.CurrentRows)
                        DtView1(0)("model_2") = WK_DtView1(0)("model_2")
                        DtView1(0)("model_1") = WK_DtView1(0)("model_1")
        ...
        Try
            ...
            If hitinfo.Row >= 0 Then
                ...
                If P_RTN = "1" Then '**  画面セット
                    ...
                    DtView1 = New DataView(DsList1.Tables("M43_AP_M_NO"), "ID = " & P_PRAM1, "", DataViewRowState.CurrentRows)
                    DtView1(0)("model_2") = WK_DtView1(0)("model_2")
                    DtView1(0)("model_1") = WK_DtView1(0)("model_1")
                    DtView1(0)("delt_flg") = WK_DtView1(0)("delt_flg")
                End If

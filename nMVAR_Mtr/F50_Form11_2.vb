...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Edit002.Location = New System.Drawing.Point(112, 176)
        Me.Edit002.MaxLength = 50
        Me.Edit002.Multiline = True
        Me.Edit002.Name = "Edit002"
        Me.Edit002.ScrollBarMode = GrapeCity.Win.Input.Interop.ScrollBarMode.Automatic
        Me.Edit002.ScrollBars = System.Windows.Forms.ScrollBars.Both
        ...
        Me.Edit002.Size = New System.Drawing.Size(720, 48)
        Me.Edit002.TabIndex = 2
        Me.Edit002.Text = "aaaaaaaaaa"
        Me.Edit002.TextVAlign = GrapeCity.Win.Input.Interop.AlignVertical.Top
        '
        'Edit001
        '
        ...
        Me.Number001.Location = New System.Drawing.Point(112, 232)
        ...
        Me.CheckBox001.Location = New System.Drawing.Point(112, 264)
        ...
        Me.Label52.Location = New System.Drawing.Point(16, 264)
        Me.Label52.Name = "Label52"
        Me.Label52.Size = New System.Drawing.Size(96, 24)
        Me.Label52.TabIndex = 1143
        ...
        Me.Label50.Location = New System.Drawing.Point(16, 232)
        Me.Label50.Name = "Label50"
        Me.Label50.Size = New System.Drawing.Size(96, 24)
        Me.Label50.TabIndex = 1141
        Me.Label50.Text = "表示順"
        ...
        Me.msg.Location = New System.Drawing.Point(16, 296)
        Me.msg.Name = "msg"
        ...
        Me.Button80.Location = New System.Drawing.Point(664, 328)
        ...
        Me.Button98.Location = New System.Drawing.Point(744, 328)
...
#End Region
    ...
    '**  起動時
    '********************************************************************
    Private Sub F50_Form11_2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inz()       '**  初期処理
        ACES()      '**  権限チェック
        DspSet()    '**  画面セット
    End Sub
    ...
    Sub DspSet()
        ...
        strSQL += ", cls_code_len, cls_name_len, cls_abbr_len, cls_code_nmc, cls_name_nmc, cls_abbr_nmc, cls_abbr_null"
        strSQL += " FROM M20_CLS"
        strSQL += " WHERE (cls_no = '" & P_PRAM1 & "')"
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN("nMVAR")
        DaList1.Fill(DsList1, "M20_CLS")
        DB_CLOSE()

        cls_DtView1 = New DataView(DsList1.Tables("M20_CLS"), "", "", DataViewRowState.CurrentRows)
        If cls_DtView1.Count <> 0 Then
            Label1.Text = Trim(cls_DtView1(0)("cls_name"))
            Edit1.MaxLength = cls_DtView1(0)("cls_code_len")
            Edit001.LengthAsByte = True
            Edit001.MaxLength = cls_DtView1(0)("cls_name_len")
            Edit002.LengthAsByte = True
            Edit002.MaxLength = cls_DtView1(0)("cls_abbr_len")
            If cls_DtView1(0)("cls_code_nmc") = "1" Then
                Edit1.Format = "9#"
            Else
                Edit1.Format = "9a"
            End If
            If cls_DtView1(0)("cls_name_nmc") = "1" Then
                Edit001.Format = "9#"
                Edit001.ImeMode = ImeMode.Off
            End If
            If cls_DtView1(0)("cls_abbr_nmc") = "1" Then
                Edit002.Format = "9#"
                Edit002.ImeMode = ImeMode.Off
            End If
        End If
        ...
        Else                        '修正
            ...
            DtView1 = New DataView(DsList1.Tables("M21_CLS_CODE"), "", "", DataViewRowState.CurrentRows)
            If DtView1.Count <> 0 Then
                Edit1.Text = P_PRAM2
                Edit001.Text = DtView1(0)("cls_code_name")
                If Not IsDBNull(DtView1(0)("cls_code_name_abbr")) Then Edit002.Text = DtView1(0)("cls_code_name_abbr") Else Edit002.Text = Nothing
    ...
    Sub CHK_Edit1()   'CLSｺｰﾄﾞ
        ...
        If Edit1.Text = Nothing Then
            ...
            Exit Sub
        Else
            If Len(Trim(Edit1.Text)) <> cls_DtView1(0)("cls_code_len") Then
                Edit1.BackColor = System.Drawing.Color.Red
                msg.Text = "CLSコードは" & cls_DtView1(0)("cls_code_len") & "桁で入力してください。"
                Exit Sub
            End If
            ...
            DB_CLOSE()
            WK_DtView1 = New DataView(WK_DsList1.Tables("M21_CLS_CODE"), "", "", DataViewRowState.CurrentRows)
    ...
    Sub CHG_HSTY()
        ...
        If Edit001.Text <> DtView1(0)("cls_code_name") Then
            chg_itm = chg_itm + 1 : add_MTR_hsty(M_CLS, P_PRAM1 & Edit1.Text, "区分名", DtView1(0)("cls_code_name"), Edit001.Text)
        End If

        If Not IsDBNull(DtView1(0)("cls_code_name_abbr")) Then WK_str = DtView1(0)("cls_code_name_abbr") Else WK_str = Nothing
        If Edit002.Text <> WK_str Then
            chg_itm = chg_itm + 1 : add_MTR_hsty(M_CLS, P_PRAM1 & Edit1.Text, "略称", WK_str, Edit002.Text)
        End If

        If Number001.Value <> DtView1(0)("dsp_seq") Then
            chg_itm = chg_itm + 1 : add_MTR_hsty(M_CLS, P_PRAM1 & Edit1.Text, "表示順", DtView1(0)("dsp_seq"), Number001.Value)
        End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            If P_PRAM2 = Nothing Then   '新規
                ...
                strSQL = "INSERT INTO M21_CLS_CODE"
                strSQL += " (cls_no, cls_code, cls_code_name, cls_code_name_abbr, dsp_seq, reg_date, delt_flg)"
                strSQL += " VALUES ('" & P_PRAM1 & "'"
                strSQL += ", '" & Edit1.Text & "'"
                strSQL += ", '" & Trim(Edit001.Text) & "'"
                strSQL += ", '" & Trim(Edit002.Text) & "'"
            ...
            Else                        '修正
                ...
                CHG_HSTY()  '**  変更履歴
                If chg_itm <> 0 Then
                    strSQL = "UPDATE M21_CLS_CODE"
                    strSQL += " SET cls_code_name = '" & Trim(Edit001.Text) & "'"
                    strSQL += ", cls_code_name_abbr = '" & Trim(Edit002.Text) & "'"

...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F50_Form02))
        ...
        Me.DataGridTextBoxColumn1.HeaderText = "部署ｺｰﾄﾞ"
        Me.DataGridTextBoxColumn1.MappingName = "brch_code"
        ...
        Me.DataGridTextBoxColumn2.Width = 298
        '
        'DataGridTextBoxColumn3
        '
        Me.DataGridTextBoxColumn3.Format = ""
        Me.DataGridTextBoxColumn3.FormatInfo = Nothing
        Me.DataGridTextBoxColumn3.HeaderText = "会社名"
        Me.DataGridTextBoxColumn3.MappingName = "comp_name"
        ...
        Me.DataGridTextBoxColumn4.HeaderText = "エリア"
        Me.DataGridTextBoxColumn4.MappingName = "area_name"
        ...
        Me.DataGridTableStyle2.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn5, Me.DataGridBoolColumn2, Me.DataGridTextBoxColumn6, Me.DataGridBoolColumn1})
        Me.DataGridTableStyle2.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.DataGridTableStyle2.MappingName = "M03_BRCH"
        ...
        Me.DataGridTextBoxColumn5.HeaderText = "UCA"
        Me.DataGridTextBoxColumn5.MappingName = "uca_code"
        ...
        Me.DataGridBoolColumn2.HeaderText = "ﾌﾙｺﾝﾄﾛｰﾙ"
        Me.DataGridBoolColumn2.MappingName = "full_cntl"
        ...
        Me.DataGridTextBoxColumn6.HeaderText = "表示順"
        Me.DataGridTextBoxColumn6.MappingName = "dsp_seq"
...
#End Region
    ...
    '**  起動時
    '********************************************************************
    Private Sub F50_Form02_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inz()       '**  初期処理
        ACES()      '**  権限チェック
        DspSet()    '**  画面セット
    End Sub
    ...
    Sub DspSet()
        ...
        '社員マスタ
        SqlCmd1 = New SqlClient.SqlCommand("sp_M03_BRCH", cnsqlclient)
        SqlCmd1.CommandType = CommandType.StoredProcedure
        DaList1.SelectCommand = SqlCmd1
        DB_OPEN("nMVAR")
        SqlCmd1.CommandTimeout = 600
        ...
        If DataGrid1.CurrentRowIndex <= DtView1.Count - 1 Then
            Select Case keyData
                Case Is = Keys.Return
                    ...
                    Dim F50_Form02_2 As New F50_Form02_2
                    F50_Form02_2.ShowDialog()
                    If P_RTN = "1" Then '**  画面セット
                        ...
                        DtView1 = New DataView(DsList1.Tables("M03_BRCH"), "brch_code = '" & P_PRAM1 & "'", "", DataViewRowState.CurrentRows)
                        DtView1(0)("name") = WK_DtView1(0)("name")
                        DtView1(0)("comp_name") = WK_DtView1(0)("comp_name")
                        DtView1(0)("area_name") = WK_DtView1(0)("area_name")
                        DtView1(0)("full_cntl") = WK_DtView1(0)("full_cntl")

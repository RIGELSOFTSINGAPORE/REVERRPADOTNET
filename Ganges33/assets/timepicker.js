...
(function($){
  ...
  function _createTimepicker($input){
    ...
    button_div.className = "row";
      hour_header.className = "text-center serverlbl col-6";
      min_header.className = "text-center severlbl col-6";
    ok_button.className = "col-6 btn btn-outline-primary ok-button";
    cancel_button.className = "col-5 btn btn-outline-secondary cancel-button";

    if (settings.use12HourClock){
      // if using 12-hour clock, widen the picker to 18rem
      // and create am/pm button
      $(picker).css("width", "19.2rem");
      hour_header.className = "text-center serverlbl col-4";
        min_header.className = "text-center serverlbl col-4";
        hour_select.className = "form-control serverlbl col-4 hour-select";
        min_select.className = "form-control serverlbl col-4 min-select";

Module Module2
    ...
    Public Function Count_Get_001() As String
        ...
        If DtView1.Count = 0 Then
            ...
            strSQL += " (CNT_NO, CNT, CNT_RMRKS, H_LTR)"
            strSQL += " VALUES ('001', 1, N'問合番号', 'A')"
            DB_OPEN()
        ...
        Else
            ...
            Else
                ...
                If DtView1(0)("CNT") = 9999 And Asc(DtView1(0)("H_LTR")) < 90 Then
                    strSQL += " SET CNT  = 1, H_LTR = '" & Chr(Asc(DtView1(0)("H_LTR")) + 1) & "'"
                Else
                    strSQL += " SET CNT  = CNT  + 1"
                End If
                strSQL += " WHERE (CNT_NO  = '001')"
                DB_OPEN()
                P_SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                P_SqlCmd1.ExecuteNonQuery()
                DB_CLOSE()
    ...
    Public Function Count_Get2(ByVal cls) As String
        ...
        If DtView1.Count = 0 Then
            ...
            If cls = "0" Then
                strSQL += " VALUES ('004', 1, N'修理受付番号（引取）')"
            Else
                strSQL += " VALUES ('005', 1, N'修理受付番号（出張）')"
            End If
            DB_OPEN()
            P_SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            P_SqlCmd1.ExecuteNonQuery()
        ...
        Else
            ...
            Else
                ...
                strSQL += " SET CNT = CNT + 1"
                If cls = "0" Then
                    strSQL += " WHERE (CNT_NO  = '004')"
                Else
                    strSQL += " WHERE (CNT_NO  = '005')"
                End If
                DB_OPEN()
                P_SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                P_SqlCmd1.ExecuteNonQuery()

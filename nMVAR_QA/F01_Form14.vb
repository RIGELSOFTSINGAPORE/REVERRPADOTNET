...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F01_Form14))
        ...
        Me.DataGridTableStyle1.GridColumnStyles.AddRange(New System.Windows.Forms.DataGridColumnStyle() {Me.DataGridTextBoxColumn1, Me.DataGridTextBoxColumn4, Me.DataGridTextBoxColumn2, Me.DataGridTextBoxColumn3, Me.DataGridTextBoxColumn7, Me.DataGridTextBoxColumn11, Me.DataGridTextBoxColumn5})
        ...
        Me.DataGridTextBoxColumn5.HeaderText = "ステータス"
        Me.DataGridTextBoxColumn5.MappingName = "stts_name"
...
#End Region
    ...
    '**  起動時
    '********************************************************************
    Private Sub F01_Form14_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inz()   '**  初期処理
    End Sub
        ...
        If DataGridEx1.CurrentRowIndex <= DtView1.Count - 1 Then
            Select Case keyData
                Case Is = Keys.Return
                    ...
                    Dim F01_Form14_2 As New F01_Form14_2
                    F01_Form14_2.ShowDialog()
    ...
    Sub sql()
        DsList1.Clear()
        strSQL = "SELECT QA02_data.id, QA02_data.stts, QA02_data.qac_no, QA02_data.gss_rcpt_no, QA02_data.user_name, QA02_data.maker_name, QA02_data.model_name, V_cls_052.cls_code_name AS stts_name"
        strSQL += " FROM QA02_data INNER JOIN"
        strSQL += " V_cls_052 ON QA02_data.stts = V_cls_052.cls_code"
        strSQL += " WHERE (QA02_data.stts = N'100') OR (QA02_data.stts = N'150') OR (QA02_data.stts = N'151')"

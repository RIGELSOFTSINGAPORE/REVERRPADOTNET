Imports GrapeCity.Win.Input.Interop.Interop
...
Public Class F10_Form01
    ...
    Dim strSQL, Err_F, Err_CX, ANS, WK_str1 As String
...
#Region " Windows フォーム デザイナで生成されたコード "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Edit010.Size = New System.Drawing.Size(420, 20)
        ...
        Me.brk02.Location = New System.Drawing.Point(784, 240)
        Me.brk02.Name = "brk02"
...
#End Region
    ...
    Sub DspSet()
        ...
        WK_DsList11.Clear()
        strSQL = "SELECT *"
        strSQL = strSQL & " FROM QA02_data"
        strSQL = strSQL & " WHERE (id = " & P_F01_PRAM1 & ")"
        SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
        DaList1.SelectCommand = SqlCmd1
        SqlCmd1.CommandTimeout = 600
        DB_OPEN("nMVAR")
        DaList1.Fill(WK_DsList11, "QA02_data")
        DB_CLOSE()
        WK_DtView11 = New DataView(WK_DsList11.Tables("QA02_data"), "", "", DataViewRowState.CurrentRows)
        If WK_DtView11.Count <> 0 Then
            If Not IsDBNull(WK_DtView11(0)("gss_rcpt_no")) Then
                Button1.Text = "更新"
                Edit000.Text = WK_DtView11(0)("gss_rcpt_no") '受付番号
            Else
                Button1.Text = "登録"
                Edit000.Text = Nothing '受付番号
            End If
            If Not IsDBNull(WK_DtView11(0)("qac_no")) Then Edit004.Text = WK_DtView11(0)("qac_no") Else Edit004.Text = Nothing 'QAC管理番号
            If Not IsDBNull(WK_DtView11(0)("user_name")) Then Edit005.Text = WK_DtView11(0)("user_name") Else Edit005.Text = Nothing 'お客様氏名
            If Not IsDBNull(WK_DtView11(0)("user_kana")) Then Edit006.Text = WK_DtView11(0)("user_kana") Else Edit006.Text = Nothing 'カナ
            If Not IsDBNull(WK_DtView11(0)("zip")) Then Mask1.Value = WK_DtView11(0)("zip") Else Mask1.Text = Nothing '郵便番号
            If Not IsDBNull(WK_DtView11(0)("adrs1")) Then Edit009.Text = WK_DtView11(0)("adrs1") Else Edit009.Text = Nothing '住所1
            If Not IsDBNull(WK_DtView11(0)("adrs2")) Then Edit009.Text += WK_DtView11(0)("adrs2") '住所2
            If Not IsDBNull(WK_DtView11(0)("adrs3")) Then Edit010.Text = WK_DtView11(0)("adrs3") Else Edit010.Text = Nothing '住所3
            If Not IsDBNull(WK_DtView11(0)("tel")) Then Edit007.Text = WK_DtView11(0)("tel") Else Edit007.Text = Nothing '電話番号
            If Not IsDBNull(WK_DtView11(0)("tel2")) Then Edit008.Text = WK_DtView11(0)("tel2") Else Edit008.Text = Nothing '携帯番号
            Date001.Text = Nothing '手配日
            If Not IsDBNull(WK_DtView11(0)("tehai_date")) Then
                WK_str1 = Mid(WK_DtView11(0)("tehai_date"), 1, 4) & "/" & Mid(WK_DtView11(0)("tehai_date"), 5, 2) & "/" & Mid(WK_DtView11(0)("tehai_date"), 7, 2)
                If IsDate(WK_str1) = True Then
                    Date001.Text = WK_str1 '手配日
                End If
            End If

            If Not IsDBNull(WK_DtView11(0)("kbn")) Then
                '販社コード変換
                strSQL = "SELECT cls_code_name_abbr"
                strSQL = strSQL & " FROM M21_CLS_CODE"
                strSQL = strSQL & " WHERE (cls_no = '051') AND (cls_code_name = '" & Trim(WK_DtView11(0)("kbn")) & "')"
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                DaList1.SelectCommand = SqlCmd1
                SqlCmd1.CommandTimeout = 600
                DB_OPEN("nMVAR")
                DaList1.Fill(WK_DsList11, "cls051")
                DB_CLOSE()
                WK_DtView12 = New DataView(WK_DsList11.Tables("cls051"), "", "", DataViewRowState.CurrentRows)
                If WK_DtView12.Count <> 0 Then
                    Edit001.Text = WK_DtView12(0)("cls_code_name_abbr")
                    CHK_Edit001()   '販社
                Else
                    Edit001.Text = Nothing : Edit002.Text = Nothing
                End If
            Else
                Edit001.Text = Nothing : Edit002.Text = Nothing
            End If

            If Not IsDBNull(WK_DtView11(0)("maker_name")) Then
                'メーカーコード変換
                strSQL = "SELECT cls_code_name_abbr"
                strSQL = strSQL & " FROM M21_CLS_CODE"
                strSQL = strSQL & " WHERE (cls_no = '050') AND (cls_code_name = '" & Trim(WK_DtView11(0)("maker_name")) & "')"
                SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
                DaList1.SelectCommand = SqlCmd1
                SqlCmd1.CommandTimeout = 600
                DB_OPEN("nMVAR")
                DaList1.Fill(WK_DsList11, "cls050")
                DB_CLOSE()
                WK_DtView12 = New DataView(WK_DsList11.Tables("cls050"), "", "", DataViewRowState.CurrentRows)
                If WK_DtView12.Count <> 0 Then
            ...
            If Not IsDBNull(WK_DtView11(0)("model_name")) Then Edit_U002.Text = WK_DtView11(0)("model_name") Else Edit_U002.Text = Nothing '機種

            If Not IsDBNull(WK_DtView11(0)("trouble_reason")) Then Edit_U004.Text = WK_DtView11(0)("trouble_reason") Else Edit_U004.Text = Nothing '故障事由
            If Edit_U004.Text = Nothing Then
                If Not IsDBNull(WK_DtView11(0)("trouble_symptom")) Then Edit_U004.Text = WK_DtView11(0)("trouble_symptom") Else Edit_U004.Text = Nothing '故障症状
            Else
                If Not IsDBNull(WK_DtView11(0)("trouble_symptom")) Then Edit_U004.Text += vbCrLf & WK_DtView11(0)("trouble_symptom") Else Edit_U004.Text = Nothing '故障症状
            End If
            If Not IsDBNull(WK_DtView11(0)("remark")) Then Edit_U005.Text = WK_DtView11(0)("remark") Else Edit_U005.Text = Nothing '備考
        End If

        CL001.Text = "01"
        WK_DtView11 = New DataView(DsCMB.Tables("CLS_CODE_007"), "cls_code = '" & CL001.Text & "'", "", DataViewRowState.CurrentRows)
        Combo001.Text = WK_DtView11(0)("cls_code_name") '受付種別：通常

        CL002.Text = "04"
        WK_DtView11 = New DataView(DsCMB.Tables("CLS_CODE_018"), "cls_code = '" & CL002.Text & "'", "", DataViewRowState.CurrentRows)
        Combo002.Text = WK_DtView11(0)("cls_code_name") '入荷区分：宅配（販社）
        CHK_Combo002()   '入荷区分
        ...
        prch_amnt.Text = "0"
        Edit_U001.Text = Nothing : Edit_U003.Text = Nothing : Edit_U006.Text = Nothing
        Date_U001.Text = Nothing : Date_U002.Text = Nothing : Date_U003.Text = Nothing : Date_U004.Text = Nothing
        Combo004.Text = Nothing : Combo005.Text = Nothing : Combo006.Text = Nothing
        'Combo003.Text = Nothing : CL003.Text = Nothing
        CL004.Text = Nothing : CL005.Text = Nothing : CL006.Text = Nothing
                ...
                Else
                    ...
                    If brk01.Text <> Edit011.Text Then
                        ...
                        If Not IsDBNull(WK_DtView1(0)("zip")) Then
                            'Dim WK_str As String = StrConv(WK_DtView1(0)("zip"), VbStrConv.Narrow) prabu 2020-12-04
...
tab:
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            ...
            If Edit000.Text = Nothing Then Edit000.Text = Count_Get(T2.Text)
            DB_OPEN("nMVAR")

            '受付
            strSQL = "DELETE FROM T01_REP_MTR WHERE (rcpt_no = '" & Edit000.Text & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            SqlCmd1.CommandTimeout = 600
            ...
            '付属品
            strSQL = "DELETE FROM T02_ATCH_ITEM WHERE (rcpt_no = '" & Edit000.Text & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            SqlCmd1.CommandTimeout = 600
            SqlCmd1.ExecuteNonQuery()
            ...
            'コメント
            strSQL = "DELETE FROM T03_REP_CMNT WHERE (rcpt_no = '" & Edit000.Text & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            SqlCmd1.CommandTimeout = 600
            SqlCmd1.ExecuteNonQuery()
            ...
            strSQL = "SELECT cls_code_name AS stts_name FROM V_cls_052 WHERE (cls_code = '40')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            ...
            strSQL = strSQL & " SET gss_rcpt_no = N'" & Edit000.Text & "'"
            strSQL = strSQL & ", stts = N'40'"
            If CK_own_flg.Checked = True Then
                strSQL = strSQL & ", repr_post = 1" '自社修理
                strSQL = strSQL & ", repr_maker_name = N''"
            Else
                strSQL = strSQL & ", repr_post = 2" '他社修理
            ...
            add_hsty(Edit000.Text, "QACステータス", bfr_tsst_name, afr_tsst_name)
...
skp:
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        PRT_PRAM1 = "Print_R_Azukari_Sheet" 'ケア情報印刷
    ...
    Private Sub Button97_ClientSizeChanged(sender As Object, e As EventArgs) Handles Button97.ClientSizeChanged

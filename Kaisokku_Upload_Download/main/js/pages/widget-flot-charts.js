...
$(function () {
    ...
    var interactive_plot = $.plot('#interactive', [getRandomData()], {
	  ...
	  tooltip: true,
      lines : {
        fill : '#7c3196', //Converts the line chart to area chart
        color: '#7c3196'
      },
	  tooltipOpts: {
            content: "Visit: %y"
    ...
    var donutData = [
      { label: 'Jan-Apr', data: 45, color: '#7c3196' },
      { label: 'May-Aug', data: 32, color: '#da291c' },
      { label: 'Sep-Dec', data: 23, color: '#310d3d' }
    ]

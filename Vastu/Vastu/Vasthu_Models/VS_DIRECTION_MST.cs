...
{
    public class VS_DIRECTION_MST
    {
        [Key]
        [Display(Name = "Direction ID")]
        public int DIRECTION_ID { get; set; }

        [Required(ErrorMessageResourceType = typeof(Vastu.Resources.Resource), ErrorMessageResourceName = nameof(Vastu.Resources.Resource.Direction))]

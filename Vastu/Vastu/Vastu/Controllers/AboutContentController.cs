...
namespace Vastu.Controllers
{
    ...
    {
        private AboutContentBusinessLayer _AboutContentBusinessLayer;

        public AboutContentController()
        {

            _AboutContentBusinessLayer = new AboutContentBusinessLayer();
        }
        ...
        public ActionResult Index()
        {
            ...
            try
            {
                obj = _AboutContentBusinessLayer.GetHomeContent();
        ...
        public JsonResult LoadSelectedAboutContent(string ContentID)
        {
            ...
            try
            {
                obj = _AboutContentBusinessLayer.LoadDescription(Convert.ToInt32(ContentID));
        ...
        public JsonResult SavePageInformation(Models.SaveAboutContent savecontent)
        {
            ...
            try
            {
                ...
                result = _AboutContentBusinessLayer.SaveContentInformation(cont);
        ...
        public JsonResult DeleteContentById(string ContentID)
        {
            ...
            try
            {
                result = _AboutContentBusinessLayer.DeleteContentById(Convert.ToInt32(ContentID));
                return Json(new { errorcode = result, errormessage = "Successfully Saved" }, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {

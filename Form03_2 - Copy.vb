...
#End Region
    ...
    Sub DspSet()
        ...
        strSQL = strSQL & " WHERE (cls_no = '" & P_PRAM1 & "')"
        ...
        Else                        '修正
            ...
            strSQL = strSQL & " WHERE (cls_no = '" & P_PRAM1 & "')"
            strSQL = strSQL & " AND (cls_code = '" & P_PRAM2 & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN()
    ...
    Sub CHK_Edit1()   'CLSｺｰﾄﾞ
        ...
        Else
            ...
            strSQL = "SELECT * FROM CLS_CODE"
            strSQL = strSQL & " WHERE (cls_no = '" & P_PRAM1 & "')"
            strSQL = strSQL & " AND (cls_code = '" & Trim(Edit1.Text) & "')"
            SqlCmd1 = New SqlClient.SqlCommand(strSQL, cnsqlclient)
            DaList1.SelectCommand = SqlCmd1
            DB_OPEN()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If Err_F = "0" Then
            If P_PRAM2 = Nothing Then   '新規
                ...
                strSQL = strSQL & " (cls_no, cls_code, cls_code_name, dsp_seq, reg_date, delt_flg)"
                strSQL = strSQL & " VALUES ('" & P_PRAM1 & "'"
                strSQL = strSQL & ", '" & Edit1.Text & "'"
                strSQL = strSQL & ", '" & Trim(Edit001.Text) & "'"
            ...
            Else                        '修正
                ...
                strSQL = strSQL & " SET cls_code_name = '" & Trim(Edit001.Text) & "'"
                strSQL = strSQL & ", dsp_seq = " & Number001.Value & ""

        ...
        If Err_F = "0" Then
            ...
            If DtView1.Count <> 0 Then
                ...
                For i = 0 To DtView1.Count - 1
                    ...
                    End If
                    oSheet.Range("C" & j).Value = DtView1(i)("line_no")
                    oSheet.Range("D" & j).Value = DtView1(i)("user_name_KANA")
                    oSheet.Range("E" & j).Value = DtView1(i)("user_name")
                    oSheet.Range("F" & j).Value = DtView1(i)("user_tel_no")
                    oSheet.Range("G" & j).Value = DtView1(i)("appl_name_KANA")
                    oSheet.Range("H" & j).Value = DtView1(i)("appl_name")
                    oSheet.Range("I" & j).Value = DtView1(i)("appl_tel_no")
                    oSheet.Range("J" & j).Value = DtView1(i)("zip")
                    oSheet.Range("K" & j).Value = DtView1(i)("adrs1")
                    oSheet.Range("L" & j).Value = DtView1(i)("adrs2")
                    oSheet.Range("M" & j).Value = DtView1(i)("adrs3")
                    oSheet.Range("N" & j).Value = DtView1(i)("floor")
                    oSheet.Range("O" & j).Value = DtView1(i)("room_name")
                    oSheet.Range("P" & j).Value = DtView1(i)("livi_togr")
                    oSheet.Range("Q" & j).Value = DtView1(i)("section_code")
                    oSheet.Range("R" & j).Value = DtView1(i)("line_code")
                    oSheet.Range("S" & j).Value = DtView1(i)("cls_code")
                    oSheet.Range("T" & j).Value = DtView1(i)("sub_cls_code")
                    oSheet.Range("U" & j).Value = DtView1(i)("item_code")
                    oSheet.Range("V" & j).Value = DtView1(i)("vdr_code")
                    oSheet.Range("W" & j).Value = DtView1(i)("item_name")
                    oSheet.Range("X" & j).Value = DtView1(i)("standard_name")
                    oSheet.Range("Y" & j).Value = DtView1(i)("prch_price")
                    oSheet.Range("Z" & j).Value = DtView1(i)("wrn_date")
                    oSheet.Range("AA" & j).Value = DtView1(i)("wrn_prod")
                    oSheet.Range("AB" & j).Value = DtView1(i)("wrn_fee")
                    oSheet.Range("AC" & j).Value = DtView1(i)("shop_code")
                    oSheet.Range("AD" & j).Value = DtView1(i)("rcpt_empl_code")
                    oSheet.Range("AE" & j).Value = DtView1(i)("rcpt_empl_name")
                    oSheet.Range("AF" & j).Value = DtView1(i)("input_date")
                    ...
                    Select Case DtView1(i)("fee_kbn")
                        Case Is = "A", "B"
                            ...
                            Select Case noTaxPrchPrice
                                Case Is <= -15000
                                    oSheet.Range("AG" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.013, 0)
                                    oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                                    oSheet.Range("AI" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.012, 0)
                                    oSheet.Range("AJ" & j).Value = "B"
                                Case Is < 0
                                    oSheet.Range("AG" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.006, 0)
                                    oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                                    oSheet.Range("AI" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.012, 0)
                                    oSheet.Range("AJ" & j).Value = DtView1(i)("fee_kbn")
                                    '                                Case Is >= 15750
                                Case Is >= 15000
                                    oSheet.Range("AG" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.013, 0)
                                    oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                        ...
                        Case Is = "C"
                            oSheet.Range("AG" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.003, 0)
                            oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                            oSheet.Range("AI" & j).Value = RoundDOWN(DtView1(i)("prch_price") * 0.012, 0)
                            oSheet.Range("AJ" & j).Value = DtView1(i)("fee_kbn")
                        ...
                        Case Is = "E"
                            '                            oSheet.Range("AG" & j).Value = 2300
                            WK_amt1 = 2000 * 1.1
                            WK_amt2 = 800 * 1.1

                            oSheet.Range("AG" & j).Value = WK_amt1
                            oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                            '                            oSheet.Range("AI" & j).Value = 0
                            oSheet.Range("AI" & j).Value = WK_amt2
                            oSheet.Range("AJ" & j).Value = DtView1(i)("fee_kbn")

                        Case Is = "F"
                            '                            oSheet.Range("AG" & j).Value = 2800
                            WK_amt1 = 2500 * 1.1
                            WK_amt2 = 800 * 1.1
                        ...
                        Case Is = "G"
                            '                            oSheet.Range("AG" & j).Value = 1000
                            WK_amt1 = 1000 * 1.1
                            WK_amt2 = 1310

                            oSheet.Range("AG" & j).Value = WK_amt1
                            oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                            '                            oSheet.Range("AI" & j).Value = 1250
                            oSheet.Range("AI" & j).Value = WK_amt2
                            oSheet.Range("AJ" & j).Value = DtView1(i)("fee_kbn")

                        Case Is = "H"
                            '                            oSheet.Range("AG" & j).Value = 4300
                            WK_amt1 = 4500 * 1.1
                            WK_amt2 = 1964

                            oSheet.Range("AG" & j).Value = WK_amt1
                            oSheet.Range("AH" & j).Value = oSheet.Range("AB" & j).Value - oSheet.Range("AG" & j).Value
                            '                            oSheet.Range("AI" & j).Value = 1875
                            oSheet.Range("AI" & j).Value = WK_amt2
                            oSheet.Range("AJ" & j).Value = DtView1(i)("fee_kbn")

                        Case Is = "I"
                            '                            oSheet.Range("AG" & j).Value = 1800
                            WK_amt1 = 1000 * 1.1
                            WK_amt2 = 1964
            ...
            If DtView1.Count <> 0 Then
                ...
                For i = 0 To DtView1.Count - 1
                    ...
                    End If
                    oSheet.Range("D" & j).Value = strDATA(2)
                    oSheet.Range("E" & j).Value = strDATA(3)
                    oSheet.Range("F" & j).Value = strDATA(4)
                    oSheet.Range("G" & j).Value = strDATA(5)
                    oSheet.Range("H" & j).Value = strDATA(6)
                    oSheet.Range("I" & j).Value = strDATA(7)
                    oSheet.Range("J" & j).Value = strDATA(8)
                    oSheet.Range("K" & j).Value = strDATA(9)
                    oSheet.Range("L" & j).Value = strDATA(10)
                    oSheet.Range("M" & j).Value = strDATA(11)
                    oSheet.Range("N" & j).Value = strDATA(12)
                    oSheet.Range("O" & j).Value = strDATA(13)
                    oSheet.Range("P" & j).Value = strDATA(14)
                    oSheet.Range("Q" & j).Value = strDATA(15)
                    oSheet.Range("R" & j).Value = strDATA(16)
                    oSheet.Range("S" & j).Value = strDATA(17)
                    oSheet.Range("T" & j).Value = strDATA(18)
                    oSheet.Range("U" & j).Value = strDATA(19)
                    oSheet.Range("V" & j).Value = strDATA(20)
                    oSheet.Range("W" & j).Value = strDATA(21)
                    oSheet.Range("X" & j).Value = strDATA(22)
                    oSheet.Range("Y" & j).Value = strDATA(23)
                    oSheet.Range("Z" & j).Value = strDATA(24)
                    oSheet.Range("AA" & j).Value = strDATA(25)
                    oSheet.Range("AB" & j).Value = strDATA(26)
                    oSheet.Range("AC" & j).Value = strDATA(27)
                    oSheet.Range("AD" & j).Value = strDATA(28)
                    oSheet.Range("AE" & j).Value = strDATA(29)
                    oSheet.Range("AF" & j).Value = strDATA(30)
                    oSheet.Range("AG" & j).Value = strDATA(31)
                Next
            End If
            DB_CLOSE()
